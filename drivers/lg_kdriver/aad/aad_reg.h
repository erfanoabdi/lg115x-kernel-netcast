 ...
 *  version    1.0 => 2.0 => 3.0 (L8-A0/A1 => B0 => H13 A0)
 *  date       2010.05.28 => 2010.12.07 => 2012.07.02
 */
...
typedef struct {
	...
	UINT32                          	                 __rsvd_05[   5];	// 0x0270 ~ 0x0280
	ID_PLL_PARAM1                   	id_pll_param1                   ;	// 0x0284 : ''
	ID_PLL_PARAM2                   	id_pll_param2                   ;	// 0x0288 : ''
	ID_PLL_PARAM3                   	id_pll_param3                   ;	// 0x028c : ''
	ID_PLL_PARAM4                   	id_pll_param4                   ;	// 0x0290 : ''
	ID_PLL_PARAM5                   	id_pll_param5                   ;	// 0x0294 : ''
	ID_PLL_PARAM6                   	id_pll_param6                   ;	// 0x0298 : ''
	ID_PLL_PARAM7                   	id_pll_param7                   ;	// 0x029c : ''
	UINT32                          	                 __rsvd_06[   2];	// 0x02a0 ~ 0x02a4
	SIF_DROP_INTERPOL_CTRL          	sif_drop_interpol_ctrl          ;	// 0x02a8 : ''
	UINT32                          	                 __rsvd_07[  54];	// 0x02ac ~ 0x0380
	ID_PLL_PARAM1_LOCKED            	id_pll_param1_locked            ;	// 0x0384 : ''
	ID_PLL_PARAM2_LOCKED            	id_pll_param2_locked            ;	// 0x0388 : ''
	ID_PLL_PARAM3_LOCKED            	id_pll_param3_locked            ;	// 0x038c : ''
	ID_PLL_PARAM4_LOCKED            	id_pll_param4_locked            ;	// 0x0390 : ''
	ID_PLL_PARAM5_LOCKED            	id_pll_param5_locked            ;	// 0x0394 : ''
	ID_PLL_PARAM6_LOCKED            	id_pll_param6_locked            ;	// 0x0398 : ''
	ID_PLL_PARAM7_LOCKED            	id_pll_param7_locked            ;	// 0x039c : ''
} AAD_REG_T;
/* 113 regs, 113 types */
...
/* from 'LG1152-AAD-MAN-ver0.91.csv' 20120702 05:41:15   KOR by getregs v2.7 */
