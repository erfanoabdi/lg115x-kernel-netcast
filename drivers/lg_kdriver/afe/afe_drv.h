...
#define	AFE_TRACE(format, args...)			DBG_PRINT( g_afe_debug_fd, 3, format, ##args)
#define	AFE_ERROR(format, args...)			DBG_PRINT( g_afe_debug_fd, 4, format, ##args)
#define	CVD_CSD_DEBUG(format, args...)		DBG_PRINT( g_afe_debug_fd, 5, format, ##args)
#define	CVD_WA_DEBUG(format, args...)		DBG_PRINT( g_afe_debug_fd, 6, format, ##args)
#define	ADC_CALIB_DEBUG(format, args...)	DBG_PRINT( g_afe_debug_fd, 7, format, ##args)
#define	ADC_APA_DEBUG(format, args...)		DBG_PRINT( g_afe_debug_fd, 8, format, ##args)
#define	ADC_IFM_DEBUG(format, args...)		DBG_PRINT( g_afe_debug_fd, 9, format, ##args)
#define	CVD_THREAD_DEBUG(format, args...)		DBG_PRINT( g_afe_debug_fd, 10, format, ##args)
#define	ADC_THREAD_DEBUG(format, args...)		DBG_PRINT( g_afe_debug_fd, 11, format, ##args)
