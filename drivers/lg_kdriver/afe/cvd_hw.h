...
typedef enum {
	...
	CVD_STATE_PAL60 =8,
	CVD_STATE_SECAM =9,
	CVD_STATE_NTSC_FORCED =10,
	CVD_STATE_PALi_FORCED =11,
...
extern void (*CVD_Set_Picture_Enhancement)(BOOLEAN ycrdc_lcr_on, BOOLEAN cyrdc_lcr_on);
extern void (*CVD_Program_Color_System_CHB_NTSC)(void);
extern void (*CVD_SW_Reset)(LX_AFE_CVD_SELECT_T select_main_sub);
extern void (*CVD_Power_Down)(LX_AFE_CVD_SELECT_T select_main_sub, BOOLEAN PowerOnOFF);
extern UINT8 (*CVD_Get_FC_Flag)(LX_AFE_CVD_SELECT_T select_main_sub);
//extern void (*CVD_Program_Color_System_Main)(CVD_SET_SYSTEM_MAIN_T set_system_t);
//extern void (*CVD_Program_Color_System_CHB)(CVD_SET_SYSTEM_CHB_T set_system_t);
//extern void (*MainCVD_KThread)(void);
//extern void (*CHBCVD_KThread)(void);
extern int (*CVD_Set_Source_Type)(UINT32 arg);
extern int (*CVD_Clamp_Current_Control)(UINT8 value);
extern int (*CVD_Force_Color_Kill)(UINT8 color_kill_enable);

extern int (*CVD_Set_Scart_Overlay)(BOOLEAN arg);
extern void (*CVD_Reg_Init)(LX_AFE_CVD_SELECT_T select_main_sub);
extern int (*CVD_Get_Scart_AR)(UINT32 arg);
extern void (*CVD_Print_Vport_Version)(void);
extern int (*CVD_Vport_Output)(UINT32 arg);
extern int (*CVD_Vport_Reg_Read)(UINT32 arg);
extern int (*CVD_Vport_Reg_Write)(UINT32 arg);
extern int (*CVD_Get_FB_Status)(UINT32 arg);

extern int (*CVD_Channel_Power_Control)(UINT32 on_off) ;

extern int (*CVD_Bypass_Control)(LX_AFE_CVD_BYPASS_CONTROL_T *cvd_bypass_control_t);

extern int (*CVD_Set_Hstate_Max)(UINT32	hstate_max_value);
extern int (*CVD_OnOff_Chromalock_Ckill)(BOOLEAN bonoff);
extern int (*CVD_Set_for_Tunning)(BOOLEAN bEnable);
extern int (*CVD_Set_PQ_Mode)(LX_AFE_CVD_PQ_MODE_T cvd_pq_mode);
extern int (*CVD_Get_Crunky_Status)(LX_AFE_CVD_CK_T *pCK_Detection_t);
extern int (*CVD_Set_Scart_FB_En)(int fb_en_ctrl);
extern int (*CVD_OnOff_VDAC)(BOOLEAN bonoff);

extern int (*CVD_Get_HLock_Flag)(void);
extern int (*CVD_Get_VLock_Flag)(void);
extern int	(*CVD_Get_Noise_Status)(void);
//	Ax prototype
...
//void CVD_L8Ax_Program_Color_System_Main(CVD_SET_SYSTEM_MAIN_T set_system_t);
//void CVD_L8Ax_Program_Color_System_CHB(CVD_SET_SYSTEM_CHB_T set_system_t);
//void CVD_L8Ax_MainCVD_KThread(void);
//void CVD_L8Ax_CHBCVD_KThread(void);
...
//void CVD_L8Bx_Program_Color_System_Main(CVD_SET_SYSTEM_MAIN_T set_system_t);
...
// won.hur : L9B0 function declariation <- added @2011.08.23
...
int CVD_L9Bx_Set_AGC_Peak_Nominal(UINT8	value);
...
int CVD_L9Bx_Set_for_Burst_Gate_End_On_Noisy(UINT8 original_value, UINT32 Enable); 	// Added for S/W W/A for brasil color instable issue
UINT32 CVD_L9Bx_Differential_Status_Cdto_Inc_Value(void);  // Added for S/W W/A for brasil color instable issue
