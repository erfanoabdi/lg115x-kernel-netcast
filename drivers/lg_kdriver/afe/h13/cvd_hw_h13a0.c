...
// So I will disable the code...
  ...
  Annotated by won.hur@2011.08.22
	...
	CVD_H13Ax_RdFL(iris_155);
	CVD_H13Ax_Wr06(iris_155, cvd_2dcomb_byp, 0x0, cvd_2dcomb_cband_sel, 0x0, cvd_2dcomb_ccombo_sel, 0x0 , cvd_2dcomb_ycrdc_cvsel, 0x1, cvd_2dcomb_ycrdc_chsel, 0x0, cvd_2dcomb_ycrdc_lrsel, 0x1);
	CVD_H13Ax_WrFL(iris_155);
	CVD_H13Ax_RdFL(iris_156);
	CVD_H13Ax_Wr03(iris_156, cvd_2dcomb_divider_th, 0x2, cvd_2dcomb_ycrdc_yhsymth, 0x20, cvd_2dcomb_ycrdc_yhdiffth, 0x10);
	CVD_H13Ax_WrFL(iris_156);
	CVD_H13Ax_RdFL(iris_157);
	CVD_H13Ax_Wr01(iris_157, cvd_2dcomb_ycrdc_cvdiffth, 0x40);
	CVD_H13Ax_WrFL(iris_157);
	CVD_H13Ax_RdFL(iris_160);
	CVD_H13Ax_Wr05(iris_160, cvd_2dcomb_ycrdc_yvsel, 0x2, cvd_2dcomb_ycrdc_yhsel, 0xE, cvd_2dcomb_ycrdc_hth_on, 0x1, cvd_2dcomb_ycrdc_hth_sel, 0x2, cvd_2dcomb_ycrdc_hth, 0x40);
	CVD_H13Ax_WrFL(iris_160);
	CVD_H13Ax_RdFL(iris_158);
	CVD_H13Ax_Wr03(iris_158, cvd_2dcomb_ycrdc_lrtype, 0x0, cvd_2dcomb_ycrdc_dsel, 0x0, cvd_2dcomb_ycrdc_method, 0x0);
	CVD_H13Ax_WrFL(iris_158);
	if(ycrdc_lcr_on)
	{
		CVD_H13Ax_RdFL(iris_158);
		CVD_H13Ax_Wr01(iris_158, cvd_2dcomb_ycrdc_lcr_on, 0x7);
		CVD_H13Ax_WrFL(iris_158);
	}
	else
	{
		CVD_H13Ax_RdFL(iris_158);
		CVD_H13Ax_Wr01(iris_158, cvd_2dcomb_ycrdc_lcr_on, 0x0);
		CVD_H13Ax_WrFL(iris_158);
	}
#else	// won.hur
	return;
...
int CVD_H13Ax_Set_Source_Type(UINT32 arg)
{
...
int CVD_H13Ax_Get_FB_Status(UINT32 arg)
{
...
int CVD_H13Ax_Get_Scart_AR(UINT32 arg)
{
