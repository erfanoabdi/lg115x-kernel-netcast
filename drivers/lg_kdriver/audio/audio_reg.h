...
typedef struct {
	UINT32
		...
		fs20resetout					: 1,	//	   4
		fs21resetout					: 1,	//	   5
		h13_fs23resetout				: 1,	//	  6
		h13_fs24_l9_fs23resetout		: 1,	//	   7
		h13_fs25_l9_fs24resetout		: 1,	//	   8
		asrcrstout						: 1,	//	   9
		...
		aadresetout 					: 1,	//	  14
		aadapbresetout					: 1,	//	  15
		h13_uartresetout				: 1,	//	 16
										: 4,	// 17:20 reserved
		l9_fs25resetout 				: 1;	//	  21
} AUD_SWRESET;
...
typedef struct {
	...
	AUD_BUF_IEC0_WO                  	aud_buf_iec_wo                  ;	// 0x0480 : ''
	AUD_BUF_IEC0_RO                  	aud_buf_iec_ro                  ;	// 0x0484 : ''
	AUD_BUF_IEC0_WI                  	aud_buf_iec_wi                  ;	// 0x0488 : ''
	AUD_BUF_IEC0_RI                  	aud_buf_iec_ri                  ;	// 0x048c : ''
	...
	UINT32                          	                 __rsvd_04[ 105];	// 0x04f0 ~ 0x0690
	...
	UINT32                          	aud_presented_pts               ;	// 0x06b4 : ''
	...
	UINT32                          	                 __rsvd_05[   5];	// 0x06d8 ~ 0x06e8
...
#define AUD_RdREG(REG)			( *((volatile UINT32*)(REG)))
#define AUD_WrREG(REG,VAL)		( *((volatile UINT32*)(REG)) =(VAL))

#define AUD_RdFL(_r)			((g_pTempRegAud->_r)=(g_pRealRegAud->_r))
#define AUD_WrFL(_r)			((g_pRealRegAud->_r)=(g_pTempRegAud->_r))

#define AUD_Rd(_r)			*((UINT32*)(&(g_pTempRegAud->_r)))
...
/* from 'D:/JOB_DTV/20120503_H13/register_build/LG1154-AUD-MAN-ver1.1.14/LG1154-AUD-MAN-ver1.1.14_ARM.csv'
   20130124 17:18:29   대한민국 표준시 by getregs v2.7 */
