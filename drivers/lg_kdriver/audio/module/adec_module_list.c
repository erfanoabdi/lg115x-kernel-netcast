...
static const char* gModuleTypeName[ADEC_MOD_TYPE_MAX] = 
{
	__ADEC_FILED_INIT([ADEC_MOD_TYPE_NOT_DEF],	""),
	...
	__ADEC_FILED_INIT([ADEC_MOD_TYPE_ENCODOER], "ENC"),
	__ADEC_FILED_INIT([ADEC_MOD_TYPE_SRC],		"SRC"),
