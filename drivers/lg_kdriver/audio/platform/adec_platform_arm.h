...
#define __ADEC_DBG_ERR(__INDEX,__FMT,...)		AUD_KDRV_ERROR("[%s : %d] "__FMT, __FILE__,__LINE__,##__VA_ARGS__)
#define __ADEC_DBG_LOW(__INDEX,__FMT,...)		AUD_KDRV_DEBUG("[%s : %d] "__FMT, __FILE__,__LINE__,##__VA_ARGS__)
#define __ADEC_DBG_WARN(__INDEX,__FMT,...)		AUD_KDRV_ERROR("[%s : %d] "__FMT, __FILE__,__LINE__,##__VA_ARGS__)

#define __ADEC_ASSERT(__COND, __ACTION)					if((__COND)==0){AUD_KDRV_ERROR("[%s : %d] ASSERT!!!\n",__FILE__,__LINE__);__ACTION;}
#define __ADEC_ASSERT_STR(__COND, __ACTION, __STR,...)	if((__COND)==0){AUD_KDRV_ERROR("[%s : %d] ASSERT: " __STR,__FILE__,__LINE__,##__VA_ARGS__);__ACTION;}
