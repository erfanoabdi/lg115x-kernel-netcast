...
#undef INCLUDE_KDRV_VDEC // for compule
...
#ifdef INCLUDE_KDRV_ADEC
	{ ADEC_PreInit,		ADEC_Init,		ADEC_Cleanup },
#endif
#ifdef INCLUDE_KDRV_AUDIO
...
#endif
#ifdef INCLUDE_KDRV_FMT3D
	{ FMT3D_PreInit,	FMT3D_Init,		FMT3D_Cleanup },
#endif
#ifdef INCLUDE_KDRV_DENC
	{ DENC_PreInit,		DENC_Init,		DENC_Cleanup },
#endif
#ifdef INCLUDE_KDRV_DIMM
	{ DIMM_PreInit,		DIMM_Init,		DIMM_Cleanup },
#endif
#ifdef INCLUDE_KDRV_PE
...
#endif
#ifdef INCLUDE_KDRV_FRC
	{ FRC_PreInit,		FRC_Init,		FRC_Cleanup },
#endif
#ifdef INCLUDE_KDRV_SDEC
...
#endif
#ifdef INCLUDE_KDRV_VDEC
	{ VDEC_PreInit,		VDEC_Init,		VDEC_Cleanup },
#endif
#ifdef INCLUDE_KDRV_CI
...
void		BASE_DEV_PreInit	( void )
{
	...
	{
		if ( g_device_init_table[i].PreInitModule) g_device_init_table[i].PreInitModule();
	}
}
