...
#define DBG_CLOSE(module_name)								OS_DEBUG_CloseModule(module_fd)
...
#define OS_DEBUG_SetModuleMask(int module_fdmask )
#define OS_DEBUG_GetModuleMask(int module_fd)		(0xf)
