...
static LX_MEMCFG_ENTRY_T	g_mem_desc_table[] =
{
...
#ifdef INCLUDE_KDRV_PNG
	LX_MEMCFG_ENTRY(gMemCfgPng[2]),				/* PNG */
#endif
#ifdef INCLUDE_KDRV_VENC
 ...
 //	LX_MEMCFG_ENTRY(gMemCfgDvr[1]),
	...
	LX_MEMCFG_ENTRY(sMemCfgHdr[2]), 			 /* DDR2(GFX) START */
...
void        BASE_PLT_Init   ( void )
{
	...
	g_memory_desc_table[2].base = 0xA0000000;
	g_memory_desc_table[2].size = 512<<20; /* 512MB(GFX) */ 
