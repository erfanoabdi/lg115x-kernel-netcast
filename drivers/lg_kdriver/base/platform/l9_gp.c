...
#ifdef INCLUDE_KDRV_VDEC
	//LX_MEMCFG_ENTRY(gMemCfgVdec[0]),			/* VDEC for DDR1 */
#endif
#ifdef INCLUDE_KDRV_ADEC
...
========================================================================================*/
void	L9_GP_InitPlatform	( void )
{
	int	i;
	int	ret = RET_ERROR;

    printk("[L9_GP] platform init...\n");

	/* determine memory layout */
	g_memory_desc_table[0].base = 0x20000000;
	g_memory_desc_table[0].size = 256<<20;
