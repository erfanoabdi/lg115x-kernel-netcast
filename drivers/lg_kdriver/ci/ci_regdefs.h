...
#define MAX_MOD_NUM			1
	...
	#define IRQ_CI 				1
#else
	#define L8_CI_REG_BASE 		( L8_DVBCI_BASE + 0x10000 )
	#define L8_CI_CAM_BASE 		( L8_DVBCI_BASE )

	#define L9_CI_REG_BASE		( L9_DVBCI_BASE + 0x10000 )
	#define L9_CI_CAM_BASE		( L9_DVBCI_BASE )

	#define H13_CI_REG_BASE		( H13_DVBCI_BASE + 0x10000 )
	#define H13_CI_CAM_BASE		( H13_DVBCI_BASE )
#endif /* USE_QEMU_SYSTEM */

#define L8_CI_REG_WRITE( _ADDR32_, _DATA16_ ) 		\
										do	{ 	\
										*( UINT16* )( L8_CI_CAM_BASE + _ADDR32_ ) = ( UINT16 )_DATA16_; \
										} while ( 0 ) \


#define L9_CI_REG_WRITE( _ADDR32_, _DATA16_ ) 		\
										do	{	\
										*( UINT16* )( L9_CI_CAM_BASE + _ADDR32_ ) = ( UINT16 )_DATA16_; \
										} while ( 0 ) \
...
typedef struct
{
	...
	UINT16 					unReserved[13];		//0x100c - 0x1024
