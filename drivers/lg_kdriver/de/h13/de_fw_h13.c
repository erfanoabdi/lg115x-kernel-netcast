...
#include "h13/de_fw_pak_h13b0f.h"
#endif
#ifdef USE_KDRV_CODES_FOR_H13A0
#include "h13/de_fw_pak_h13a0f.h"
#endif
#elif defined(USE_DE_FIRMWARE_RUN_IN_ROM_H13)
#ifdef USE_KDRV_CODES_FOR_H13B0
#include "h13/de_fw_rom_h13b0f.h"
#endif
#ifdef USE_KDRV_CODES_FOR_H13A0
#include "h13/de_fw_rom_h13a0f.h"
#endif
#elif defined(USE_DE_FIRMWARE_RUN_IN_DDR_H13)
#ifdef USE_KDRV_CODES_FOR_H13B0
#include "h13/de_fw_ddr_h13b0f.h"
#endif
#ifdef USE_KDRV_CODES_FOR_H13A0
#include "h13/de_fw_ddr_h13a0f.h"
#endif
#else
#ifdef USE_KDRV_CODES_FOR_H13B0
#include "h13/de_fw_ram_h13b0f.h"
#endif
#ifdef USE_KDRV_CODES_FOR_H13A0
#include "h13/de_fw_ram_h13a0f.h"
#endif
#endif
#endif
#else
...
#if defined(USE_DE_FIRMWARE_RUN_IN_PAK_H13)
#ifdef USE_KDRV_CODES_FOR_H13B0
#include "h13/de_fw_pak_h13b0.h"
#endif
#ifdef USE_KDRV_CODES_FOR_H13A0
#include "h13/de_fw_pak_h13a0.h"
#endif
#elif defined(USE_DE_FIRMWARE_RUN_IN_ROM_H13)
#ifdef USE_KDRV_CODES_FOR_H13B0
#include "h13/de_fw_rom_h13b0.h"
#endif
#ifdef USE_KDRV_CODES_FOR_H13A0
#include "h13/de_fw_rom_h13a0.h"
#endif
#elif defined(USE_DE_FIRMWARE_RUN_IN_DDR_H13)
#ifdef USE_KDRV_CODES_FOR_H13B0
#include "h13/de_fw_ddr_h13b0.h"
#endif
#ifdef USE_KDRV_CODES_FOR_H13A0
#include "h13/de_fw_ddr_h13a0.h"
#endif
#else
#ifdef USE_KDRV_CODES_FOR_H13B0
#include "h13/de_fw_ram_h13b0.h"
#endif
#ifdef USE_KDRV_CODES_FOR_H13A0
#include "h13/de_fw_ram_h13a0.h"
#endif
#endif
#endif
#endif
...
LX_DE_FW_DWLD_T sDeFirmwareFromHeader_H13A0[] = {
#if defined(USE_KDRV_CODES_FOR_H13A0)
#if defined(USE_VIDEO_FOR_FPGA)
#if defined(USE_DE_FIRMWARE_RUN_IN_PAK_H13)
	{ 3, sizeof(gDeFirmwareInDDR_PAK_H13A0F),    (char *)gDeFirmwareInDDR_PAK_H13A0F  },
#elif defined(USE_DE_FIRMWARE_RUN_IN_ROM_H13)
    { 1, sizeof(gDeFirmwareInIRM_ROM_H13A0F),    (char *)gDeFirmwareInIRM_ROM_H13A0F  },
    { 2, sizeof(gDeFirmwareInDRM_ROM_H13A0F),    (char *)gDeFirmwareInDRM_ROM_H13A0F  },
    { 3, sizeof(gDeFirmwareInDDR_ROM_H13A0F),    (char *)gDeFirmwareInDDR_ROM_H13A0F  },
#elif defined(USE_DE_FIRMWARE_RUN_IN_DDR_H13)
    { 1, sizeof(gDeFirmwareInIRM_DDR_H13A0F),    (char *)gDeFirmwareInIRM_DDR_H13A0F  },
    { 2, sizeof(gDeFirmwareInDRM_DDR_H13A0F),    (char *)gDeFirmwareInDRM_DDR_H13A0F  },
    { 3, sizeof(gDeFirmwareInDDR_DDR_H13A0F),    (char *)gDeFirmwareInDDR_DDR_H13A0F  },
#else
    { 1, sizeof(gDeFirmwareInIRM_RAM_H13A0F),    (char *)gDeFirmwareInIRM_RAM_H13A0F  },
    { 2, sizeof(gDeFirmwareInDRM_RAM_H13A0F),    (char *)gDeFirmwareInDRM_RAM_H13A0F  },
#endif
#else
#if defined(USE_DE_FIRMWARE_RUN_IN_PAK_H13)
    { 3, sizeof(gDeFirmwareInDDR_PAK_H13A0),     (char *)gDeFirmwareInDDR_PAK_H13A0  },
#elif defined(USE_DE_FIRMWARE_RUN_IN_ROM_H13)
    { 1, sizeof(gDeFirmwareInIRM_ROM_H13A0),     (char *)gDeFirmwareInIRM_ROM_H13A0  },
    { 2, sizeof(gDeFirmwareInDRM_ROM_H13A0),     (char *)gDeFirmwareInDRM_ROM_H13A0  },
    { 3, sizeof(gDeFirmwareInDDR_ROM_H13A0),     (char *)gDeFirmwareInDDR_ROM_H13A0  },
#elif defined(USE_DE_FIRMWARE_RUN_IN_DDR_H13)
    { 1, sizeof(gDeFirmwareInIRM_DDR_H13A0),     (char *)gDeFirmwareInIRM_DDR_H13A0  },
    { 2, sizeof(gDeFirmwareInDRM_DDR_H13A0),     (char *)gDeFirmwareInDRM_DDR_H13A0  },
    { 3, sizeof(gDeFirmwareInDDR_DDR_H13A0),     (char *)gDeFirmwareInDDR_DDR_H13A0  },
#else
    { 1, sizeof(gDeFirmwareInIRM_RAM_H13A0),     (char *)gDeFirmwareInIRM_RAM_H13A0  },
    { 2, sizeof(gDeFirmwareInDRM_RAM_H13A0),     (char *)gDeFirmwareInDRM_RAM_H13A0  },
#endif
#endif
#endif
};
...
int DE_FW_H13_DownloadFromHead(void)
{
	...
	if (lx_chip_rev() >= LX_CHIP_REV(H13, B0)) {
        ...
        lpDeFirmwareFromHeader = sDeFirmwareFromHeader_H13A0;
		headerSize = ARRAY_SIZE(sDeFirmwareFromHeader_H13A0);
	}
