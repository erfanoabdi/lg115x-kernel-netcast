 ...
 */
int DE_IPC_H13_Init(UINT32 *pVideoBuffToMCU, UINT32 *pVideoBuffFrMCU)
{
...
#else
   *pVideoBuffToMCU = (UINT32)ioremap(DTVSOC_IPC_FROM_CPU_H13_BASE, DTVSOC_IPC_FROM_CPU_SIZE);
   *pVideoBuffFrMCU = (UINT32)ioremap(DTVSOC_IPC_FROM_MCU_H13_BASE, DTVSOC_IPC_FROM_MCU_SIZE);
#endif
