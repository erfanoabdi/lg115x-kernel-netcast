...
} L9B0_CTR55_RGG_SDEC_DCO_FCW_CTRL_T;
...
} L9B0_CTR58_MAIN_0_1_USB_CTRL_T;
...
} L9B0_CTR60_MAIN_0_1_USB_CTRL_T;
...
} L9B0_CTR61_MAIN_0_1_USB_CTRL_T;
...
} L9B0_CTR66_MAIN2_SYSPLL_CTRL_T;
...
} L9B0_CTR67_MAIN2_SYSPLL_CTRL_T;
...
} L9B0_CTR68_MAIN2_SYSPLL_CTRL_T;
...
} L9B0_CTR69_MAIN2_SYSPLL_CTRL_T;
...
} L9B0_CTR75_HSLVDS_RX_CTRL_T;

typedef struct {
	L9B0_CTR00_CLK_DIV_SEL_T            ctr00_clk_div_sel;                   // 0xfd300010
	L9B0_CTR01_CLK_DIV_SEL_T            ctr01_clk_div_sel;                   // 0xfd300014
	L9B0_CTR02_CLK_DIV_SEL_T            ctr02_clk_div_sel;                   // 0xfd300018
	L9B0_CTR03_CLK_DIV_SEL_T            ctr03_clk_div_sel;                   // 0xfd30001c
	L9B0_CTR04_CLK_DIV_SEL_T            ctr04_clk_div_sel;                   // 0xfd300020
	L9B0_CTR05_SWRS_OF_DE_T             ctr05_swrs_of_de;                    // 0xfd300024
	L9B0_CTR06_SWRST_T                  ctr06_swrst;                         // 0xfd300028
	L9B0_CTR07_SWRST_T                  ctr07_swrst;                         // 0xfd30002c
	L9B0_CTR08_CLK_DIV_SEL_T            ctr08_clk_div_sel;                   // 0xfd300030
	L9B0_CTR09_SWRST_T                  ctr09_swrst;                         // 0xfd300034
	L9B0_CTR10_AHBCLK_DIV_SEL_T         ctr10_ahbclk_div_sel;                // 0xfd300038
	L9B0_CTR11_AHBCLK_DIV_SEL_T         ctr11_ahbclk_div_sel;                // 0xfd30003c
	L9B0_CTR12_RMIICLK_OFF_T            ctr12_rmiiclk_off;                   // 0xfd300040
	L9B0_CTR13_AHBCLK_DIV_SEL_T         ctr13_ahbclk_div_sel;                // 0xfd300044
	L9B0_CTR14_AHB_SWRST_T              ctr14_ahb_swrst;                     // 0xfd300048
	L9B0_CTR15_AHB_SWRST_T              ctr15_ahb_swrst;                     // 0xfd30004c
	L9B0_CTR16_BUSCLK_DIV_SEL_T         ctr16_busclk_div_sel;                // 0xfd300050
	L9B0_CTR17_BUSCLK_DIV_SEL_T         ctr17_busclk_div_sel;                // 0xfd300054
	L9B0_CTR18_REB_CPUBUS_SWRST_T       ctr18_reb_cpubus_swrst;              // 0xfd300058
	L9B0_CTR19_APBCLK_DIV_SEL_T         ctr19_apbclk_div_sel;                // 0xfd30005c
	L9B0_CTR20_APBCLK_DIV_SEL_T         ctr20_apbclk_div_sel;                // 0xfd300060
	L9B0_CTR21_APBCLK_DIV_SEL_T         ctr21_apbclk_div_sel;                // 0xfd300064
	L9B0_CTR22_APBCLK_DIV_SEL_T         ctr22_apbclk_div_sel;                // 0xfd300068
	UINT32                              reserved0;                           // 0xfd30006c
	L9B0_CTR24_APB_SWRST_T              ctr24_apb_swrst;                     // 0xfd300070
	L9B0_CTR25_DE_SWRST_T               ctr25_de_swrst;                      // 0xfd300074
	L9B0_CTR26_EXTCLK_DIV_SEL_T         ctr26_extclk_div_sel;                // 0xfd300078
	L9B0_CTR27_EXTCLK_SWRST_T           ctr27_extclk_swrst;                  // 0xfd30007c
	L9B0_CTR28_CPU_SWRST_T              ctr28_cpu_swrst;                     // 0xfd300080
	L9B0_CTR29_SWRST_T                  ctr29_swrst;                         // 0xfd300084
	L9B0_CTR30_BLOCK_MONITER_T          ctr30_block_moniter;                 // 0xfd300088
	L9B0_CTR31_GPIO_PULLUP_CTRL_T       ctr31_gpio_pullup_ctrl;              // 0xfd30008c
	L9B0_CTR32_GPIO_MUX_ENABLE_T        ctr32_gpio_mux_enable;               // 0xfd300090
	UINT32                              reserved1;                           // 0xfd300094
	L9B0_CTR34_GPIO_MUX_ENABLE_T        ctr34_gpio_mux_enable;               // 0xfd300098
	L9B0_CTR35_GPIO_MUX_ENABLE_T        ctr35_gpio_mux_enable;               // 0xfd30009c
	L9B0_CTR36_UART_SEL_T               ctr36_uart_sel;                      // 0xfd3000a0
	L9B0_CTR37_GPIO_MUX_ENABLE_T        ctr37_gpio_mux_enable;               // 0xfd3000a4
	L9B0_CTR38_GPIO_MUX_ENABLE_T        ctr38_gpio_mux_enable;               // 0xfd3000a8
	L9B0_CTR39_GPIO_MUX_ENABLE_T        ctr39_gpio_mux_enable;               // 0xfd3000ac
	L9B0_CTR40_GPU_DFT_CTRL_T           ctr40_gpu_dft_ctrl;                  // 0xfd3000b0
	L9B0_CTR41_PULLUP_CTRL_T            ctr41_pullup_ctrl;                   // 0xfd3000b4
	L9B0_CTR42_PULLUP_CTRL_T            ctr42_pullup_ctrl;                   // 0xfd3000b8
	L9B0_CTR43_PULLUP_CTRL_T            ctr43_pullup_ctrl;                   // 0xfd3000bc
	L9B0_CTR44_PULLUP_CTRL_T            ctr44_pullup_ctrl;                   // 0xfd3000c0
	L9B0_CTR45_PULLUP_CTRL_T            ctr45_pullup_ctrl;                   // 0xfd3000c4
	L9B0_CTR46_PULLUP_CTRL_T            ctr46_pullup_ctrl;                   // 0xfd3000c8
	L9B0_CTR47_PULLUP_CTRL_T            ctr47_pullup_ctrl;                   // 0xfd3000cc
	L9B0_CTR48_PULLUP_CTRL_T            ctr48_pullup_ctrl;                   // 0xfd3000d0
	L9B0_CTR49_PULLUP_CTRL_T            ctr49_pullup_ctrl;                   // 0xfd3000d4
	L9B0_CTR50_TPIO_SEL_T               ctr50_tpio_sel;                      // 0xfd3000d8
	L9B0_CTR51_GPIO_MUX_ENABLE_T        ctr51_gpio_mux_enable;               // 0xfd3000dc
	L9B0_CTR52_GPIO_MUX_ENABLE_T        ctr52_gpio_mux_enable;               // 0xfd3000e0
	L9B0_CTR53_GPIO_MUX_ENABLE_T        ctr53_gpio_mux_enable;               // 0xfd3000e4
	L9B0_CTR54_BT_USB_CTRL_T            ctr54_bt_usb_ctrl;                   // 0xfd3000e8
	L9B0_CTR55_RGG_SDEC_DCO_FCW_CTRL_T  ctr55_rgg_sdec_dco_fcw_ctrl;         // 0xfd3000ec
	L9B0_CTR56_BT_USB_CTRL_T            ctr56_bt_usb_ctrl;                   // 0xfd3000f0
	L9B0_CTR57_BT_USB_CTRL_T            ctr57_bt_usb_ctrl;                   // 0xfd3000f4
	L9B0_CTR58_MAIN_0_1_USB_CTRL_T      ctr58_main_0_1_usb_ctrl;             // 0xfd3000f8
	L9B0_CTR59_BT_USB_CTRL_T            ctr59_bt_usb_ctrl;                   // 0xfd3000fc
	L9B0_CTR60_MAIN_0_1_USB_CTRL_T      ctr60_main_0_1_usb_ctrl;             // 0xfd300100
	L9B0_CTR61_MAIN_0_1_USB_CTRL_T      ctr61_main_0_1_usb_ctrl;             // 0xfd300104
	L9B0_CTR62_DISPLAY_PLL_CTRL_T       ctr62_display_pll_ctrl;              // 0xfd300108
	L9B0_CTR63_DISPLAY_PLL_CTRL_T       ctr63_display_pll_ctrl;              // 0xfd30010c
	UINT32                              reserved2[43];                       // 0xfd300110~0xfd3001b8
	L9B0_CTR64_DCO_CTRL_T               ctr64_dco_ctrl;                      // 0xfd3001bc
	UINT32                              reserved3;                           // 0xfd3001c0
	L9B0_CTR66_MAIN2_SYSPLL_CTRL_T      ctr66_main2_syspll_ctrl;             // 0xfd3001c4
	L9B0_CTR67_MAIN2_SYSPLL_CTRL_T      ctr67_main2_syspll_ctrl;             // 0xfd3001c8
	L9B0_CTR68_MAIN2_SYSPLL_CTRL_T      ctr68_main2_syspll_ctrl;             // 0xfd3001cc
	L9B0_CTR69_MAIN2_SYSPLL_CTRL_T      ctr69_main2_syspll_ctrl;             // 0xfd3001d0
	L9B0_CTR70_CPUPLL_CTRL_T            ctr70_cpupll_ctrl;                   // 0xfd3001d4
	L9B0_CTR71_CPUPLL_CTRL_T            ctr71_cpupll_ctrl;                   // 0xfd3001d8
	L9B0_CTR72_HSLVDS_TX_CTRL_T         ctr72_hslvds_tx_ctrl;                // 0xfd3001dc
	L9B0_CTR73_HSLVDS_TX_CTRL_T         ctr73_hslvds_tx_ctrl;                // 0xfd3001e0
	L9B0_CTR74_HSLVDS_TX_CTRL_T         ctr74_hslvds_tx_ctrl;                // 0xfd3001e4
	L9B0_CTR75_HSLVDS_RX_CTRL_T         ctr75_hslvds_rx_ctrl;                // 0xfd3001e8
