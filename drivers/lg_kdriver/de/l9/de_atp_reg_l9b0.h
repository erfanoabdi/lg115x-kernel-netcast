...
#ifndef _REG_ATP_L9B0_h
#define _REG_ATP_L9B0_h
...
typedef struct {
	L9B0_TTX_VER_CTRL0_T    ttx_ver_ctrl0;           // 0x5e00
	L9B0_TTX_VER_CTRL1_T    ttx_ver_ctrl1;           // 0x5e04
	L9B0_WSS_DATA_T         wss_data;                // 0x5e08
	L9B0_CGMS_DATA_T        cgms_data;               // 0x5e0c
	L9B0_CVE_CONFIG_T       cve_config;              // 0x5e10
	L9B0_PHASE_INCR_T       phase_incr;              // 0x5e14
	L9B0_DENC_VBI_CTRL_T    denc_vbi_ctrl;           // 0x5e18
	L9B0_CC_DATA_T          cc_data;                 // 0x5e1c
	L9B0_MV_N0_3_T          mv_n0_3;                 // 0x5e20
	L9B0_MV_N4_9_T          mv_n4_9;                 // 0x5e24
	L9B0_MV_N10_11_T        mv_n10_11;               // 0x5e28
	L9B0_MV_N12_14_T        mv_n12_14;               // 0x5e2c
	L9B0_MV_N15_20_T        mv_n15_20;               // 0x5e30
	L9B0_VPS_CTRL_T         vps_ctrl;                // 0x5e34
	L9B0_TTX_DATA_T         ttx_data;                // 0x5e38
	L9B0_TTX_LOAD_T         ttx_load;                // 0x5e3c
	UINT32                  reserved0[4];            // 0x5e40~0x5e4c
	L9B0_TTX_DDRU_T         ttx_ddru;                // 0x5e50
	UINT32                  reserved1[11];           // 0x5e54~0x5e7c
	L9B0_ADDR_DBG_T         addr_dbg;                // 0x5e80
	L9B0_A_TOP_STATUS_T     a_top_status;            // 0x5e84
} DE_ATP_REG_L9B0_T;
