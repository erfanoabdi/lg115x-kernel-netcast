...
const DBG_REG_FIELD_T dbg_VPS_CTRL[] = {
	...
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,12 ,12 ,"wss_odd_en"                  },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,13 ,13 ,"wss_even_en"                 },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,14 ,14 ,"v_pol"                       },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,15 ,15 ,"h_pol"                       },
...
const DBG_REG_FIELD_T dbg_TTX_LOAD[] = {
	...
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,16 ,16 ,"ttx_data_endian"             },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,17 ,17 ,"ttx_data_bit_order"          },
};

/*--------------------------------
	0x5e50 TTX_DDRU
--------------------------------*/
const DBG_REG_FIELD_T dbg_TTX_DDRU[] = {
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,10 ,0  ,"ttx_ddru_stride"             },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,23 ,16 ,"ttx_ddru_line_count"         },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,30 ,30 ,"ttx_ddru_endian_change"      },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,31 ,31 ,"ttx_ddru_update_enable"      },
};

/*--------------------------------
	0x5e80 ADDR_DBG
--------------------------------*/
const DBG_REG_FIELD_T dbg_ADDR_DBG[] = {
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,0  ,0  ,"interlaced_mode"             },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,1  ,1  ,"msb_sel"                     },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,4  ,4  ,"top_field"                   },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,19 ,16 ,"pic_init_field"              },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,23 ,20 ,"vfal_field"                  },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,27 ,24 ,"cvbs_field"                  },
};
...
DBG_REG_T gDbgRegATP[] = {
	{ 0x5e00 ,N_FLD(dbg_TTX_VER_CTRL0)       ,"TTX_VER_CTRL0"         ,dbg_TTX_VER_CTRL0       },
	{ 0x5e04 ,N_FLD(dbg_TTX_VER_CTRL1)       ,"TTX_VER_CTRL1"         ,dbg_TTX_VER_CTRL1       },
	{ 0x5e08 ,N_FLD(dbg_WSS_DATA)            ,"WSS_DATA"              ,dbg_WSS_DATA            },
	{ 0x5e0c ,N_FLD(dbg_CGMS_DATA)           ,"CGMS_DATA"             ,dbg_CGMS_DATA           },
	{ 0x5e10 ,N_FLD(dbg_CVE_CONFIG)          ,"CVE_CONFIG"            ,dbg_CVE_CONFIG          },
	{ 0x5e14 ,N_FLD(dbg_PHASE_INCR)          ,"PHASE_INCR"            ,dbg_PHASE_INCR          },
	{ 0x5e18 ,N_FLD(dbg_DENC_VBI_CTRL)       ,"DENC_VBI_CTRL"         ,dbg_DENC_VBI_CTRL       },
	{ 0x5e1c ,N_FLD(dbg_CC_DATA)             ,"CC_DATA"               ,dbg_CC_DATA             },
	{ 0x5e20 ,N_FLD(dbg_MV_N0_3)             ,"MV_N0_3"               ,dbg_MV_N0_3             },
	{ 0x5e24 ,N_FLD(dbg_MV_N4_9)             ,"MV_N4_9"               ,dbg_MV_N4_9             },
	{ 0x5e28 ,N_FLD(dbg_MV_N10_11)           ,"MV_N10_11"             ,dbg_MV_N10_11           },
	{ 0x5e2c ,N_FLD(dbg_MV_N12_14)           ,"MV_N12_14"             ,dbg_MV_N12_14           },
	{ 0x5e30 ,N_FLD(dbg_MV_N15_20)           ,"MV_N15_20"             ,dbg_MV_N15_20           },
	{ 0x5e34 ,N_FLD(dbg_VPS_CTRL)            ,"VPS_CTRL"              ,dbg_VPS_CTRL            },
	{ 0x5e38 ,N_FLD(dbg_TTX_DATA)            ,"TTX_DATA"              ,dbg_TTX_DATA            },
	{ 0x5e3c ,N_FLD(dbg_TTX_LOAD)            ,"TTX_LOAD"              ,dbg_TTX_LOAD            },
	{ 0x5e50 ,N_FLD(dbg_TTX_DDRU)            ,"TTX_DDRU"              ,dbg_TTX_DDRU            },
	{ 0x5e80 ,N_FLD(dbg_ADDR_DBG)            ,"ADDR_DBG"              ,dbg_ADDR_DBG            },
	{ 0x5e84 ,N_FLD(dbg_A_TOP_STATUS)        ,"A_TOP_STATUS"          ,dbg_A_TOP_STATUS        },
	{ 0 , } // end marker
};
