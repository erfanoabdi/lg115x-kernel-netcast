...
#ifndef _REG_CVI_L9B0_h
#define _REG_CVI_L9B0_h
...
typedef struct {
	UINT32 timer_count                     : 8;   //  0: 7
	UINT32 timer_enable                    : 1;   //     8
} L9B0_CVB_PREADY_TIMER_T;

typedef struct {
	L9B0_CVA_TOP_CTRL_T             cva_top_ctrl;                    // 0x0100
	L9B0_CVA_OFFSET_CTRL_T          cva_offset_ctrl;                 // 0x0104
	L9B0_CVA_SIZE_CTRL_T            cva_size_ctrl;                   // 0x0108
	L9B0_CVA_INT_SYNC_CTRL0_T       cva_int_sync_ctrl0;              // 0x010c
	L9B0_CVA_INT_SYNC_CTRL1_T       cva_int_sync_ctrl1;              // 0x0110
	L9B0_CVA_DIG_FILT_CTRL0_T       cva_dig_filt_ctrl0;              // 0x0114
	L9B0_CVA_DIG_FILT_CTRL1_T       cva_dig_filt_ctrl1;              // 0x0118
	L9B0_CVA_DIG_FILT_CTRL2_T       cva_dig_filt_ctrl2;              // 0x011c
	L9B0_CVA_DIG_FILT_CTRL3_T       cva_dig_filt_ctrl3;              // 0x0120
	L9B0_CVA_CSC_CTRL0_T            cva_csc_ctrl0;                   // 0x0124
	L9B0_CVA_CSC_CTRL1_T            cva_csc_ctrl1;                   // 0x0128
	L9B0_CVA_CSC_CTRL2_T            cva_csc_ctrl2;                   // 0x012c
	L9B0_CVA_CSC_CTRL3_T            cva_csc_ctrl3;                   // 0x0130
	L9B0_CVA_CSC_CTRL4_T            cva_csc_ctrl4;                   // 0x0134
	L9B0_CVA_CSC_CTRL5_T            cva_csc_ctrl5;                   // 0x0138
	L9B0_CVA_CSC_CTRL6_T            cva_csc_ctrl6;                   // 0x013c
	L9B0_CVA_CSC_CTRL7_T            cva_csc_ctrl7;                   // 0x0140
	L9B0_CVA_MISC_CTRL_T            cva_misc_ctrl;                   // 0x0144
	L9B0_CVA_OFFSET_READ_T          cva_offset_read;                 // 0x0148
	L9B0_CVA_PRE3D_CTRL0_T          cva_pre3d_ctrl0;                 // 0x014c
	L9B0_CVA_PRE3D_CTRL1_T          cva_pre3d_ctrl1;                 // 0x0150
	L9B0_CVA_PRE3D_CTRL2_T          cva_pre3d_ctrl2;                 // 0x0154
	L9B0_CVA_SIZE_STATUS1_T         cva_size_status1;                // 0x0158
	L9B0_CVA_SIZE_STATUS2_T         cva_size_status2;                // 0x015c
	L9B0_CVA_SIZE_STATUS3_T         cva_size_status3;                // 0x0160
	L9B0_CVA_SIZE_STATUS4_T         cva_size_status4;                // 0x0164
	L9B0_CVA_PIX_SUM_CTRL0_T        cva_pix_sum_ctrl0;               // 0x0168
	L9B0_CVA_PIX_SUM_CTRL1_T        cva_pix_sum_ctrl1;               // 0x016c
	L9B0_CVA_PIX_SUM_STATUS0_T      cva_pix_sum_status0;             // 0x0170
	L9B0_CVA_PIX_SUM_STATUS1_T      cva_pix_sum_status1;             // 0x0174
	L9B0_CVA_PIX_SUM_STATUS2_T      cva_pix_sum_status2;             // 0x0178
	L9B0_CVA_SYNC_FIL_CTRL_T        cva_sync_fil_ctrl;               // 0x017c
	L9B0_CVA_SYNC_FIL_STATUS_T      cva_sync_fil_status;             // 0x0180
	L9B0_CVA_CTI_CTRL_T             cva_cti_ctrl;                    // 0x0184
	UINT32                          reserved0[2];                    // 0x0188~0x018c
	L9B0_CVA_SYNC_REPEAT_CTRL_T     cva_sync_repeat_ctrl;            // 0x0190
	L9B0_CVA_SYNC_REPEAT_SIZE0_T    cva_sync_repeat_size0;           // 0x0194
	L9B0_CVA_SYNC_REPEAT_SIZE1_T    cva_sync_repeat_size1;           // 0x0198
	L9B0_CVA_SYNC_REPEAT_SIZE2_T    cva_sync_repeat_size2;           // 0x019c
	L9B0_CVA_SYNC_REPEAT_SIZE3_T    cva_sync_repeat_size3;           // 0x01a0
	L9B0_CVA_SYNC_REPEAT_SIZE4_T    cva_sync_repeat_size4;           // 0x01a4
	L9B0_CVA_SYNC_REPEAT_SIZE5_T    cva_sync_repeat_size5;           // 0x01a8
	L9B0_CVA_DIG_FILT_CTRL4_T       cva_dig_filt_ctrl4;              // 0x01ac
	L9B0_CVA_DIG_FILT_CTRL5_T       cva_dig_filt_ctrl5;              // 0x01b0
	L9B0_CVA_DIG_FILT_CTRL6_T       cva_dig_filt_ctrl6;              // 0x01b4
	UINT32                          reserved1[2];                    // 0x01b8~0x01bc
	L9B0_CVA_SIZE_DETECT_CTRL_T     cva_size_detect_ctrl;            // 0x01c0
	L9B0_CVA_SIZE_DETECT_READ_T     cva_size_detect_read;            // 0x01c4
	L9B0_CVA_SIZE_STATUS0_T         cva_size_status0;                // 0x01c8
	L9B0_CVA_SIZE_STATUS5_T         cva_size_status5;                // 0x01cc
	L9B0_CVA_SIZE_STATUS6_T         cva_size_status6;                // 0x01d0
	L9B0_CVA_SIZE_DETECT_CTRL1_T    cva_size_detect_ctrl1;           // 0x01d4
	L9B0_CVA_SIZE_DETECT_CTRL2_T    cva_size_detect_ctrl2;           // 0x01d8
	L9B0_CVA_PSEUDO_SYNC_CTRL0_T    cva_pseudo_sync_ctrl0;           // 0x01dc
	L9B0_CVA_PSEUDO_SYNC_CTRL1_T    cva_pseudo_sync_ctrl1;           // 0x01e0
	L9B0_CVA_PSEUDO_SYNC_CTRL2_T    cva_pseudo_sync_ctrl2;           // 0x01e4
	L9B0_CVA_PSEUDO_SYNC_CTRL3_T    cva_pseudo_sync_ctrl3;           // 0x01e8
	L9B0_CVA_PSEUDO_SYNC_CTRL4_T    cva_pseudo_sync_ctrl4;           // 0x01ec
	L9B0_CVA_PREADY_TIMER_T         cva_pready_timer;                // 0x01f0
} DE_CVA_REG_L9B0_T;

typedef struct {
	L9B0_CVB_TOP_CTRL_T             cvb_top_ctrl;                    // 0x0200
	L9B0_CVB_OFFSET_CTRL_T          cvb_offset_ctrl;                 // 0x0204
	L9B0_CVB_SIZE_CTRL_T            cvb_size_ctrl;                   // 0x0208
	L9B0_CVB_INT_SYNC_CTRL0_T       cvb_int_sync_ctrl0;              // 0x020c
	L9B0_CVB_INT_SYNC_CTRL1_T       cvb_int_sync_ctrl1;              // 0x0210
	L9B0_CVB_DIG_FILT_CTRL0_T       cvb_dig_filt_ctrl0;              // 0x0214
	L9B0_CVB_DIG_FILT_CTRL1_T       cvb_dig_filt_ctrl1;              // 0x0218
	L9B0_CVB_DIG_FILT_CTRL2_T       cvb_dig_filt_ctrl2;              // 0x021c
	L9B0_CVB_DIG_FILT_CTRL3_T       cvb_dig_filt_ctrl3;              // 0x0220
	L9B0_CVB_CSC_CTRL0_T            cvb_csc_ctrl0;                   // 0x0224
	L9B0_CVB_CSC_CTRL1_T            cvb_csc_ctrl1;                   // 0x0228
	L9B0_CVB_CSC_CTRL2_T            cvb_csc_ctrl2;                   // 0x022c
	L9B0_CVB_CSC_CTRL3_T            cvb_csc_ctrl3;                   // 0x0230
	L9B0_CVB_CSC_CTRL4_T            cvb_csc_ctrl4;                   // 0x0234
	L9B0_CVB_CSC_CTRL5_T            cvb_csc_ctrl5;                   // 0x0238
	L9B0_CVB_CSC_CTRL6_T            cvb_csc_ctrl6;                   // 0x023c
	L9B0_CVB_CSC_CTRL7_T            cvb_csc_ctrl7;                   // 0x0240
	L9B0_CVB_MISC_CTRL_T            cvb_misc_ctrl;                   // 0x0244
	L9B0_CVB_OFFSET_READ_T          cvb_offset_read;                 // 0x0248
	L9B0_CVB_PRE3D_CTRL0_T          cvb_pre3d_ctrl0;                 // 0x024c
	L9B0_CVB_PRE3D_CTRL1_T          cvb_pre3d_ctrl1;                 // 0x0250
	L9B0_CVB_PRE3D_CTRL2_T          cvb_pre3d_ctrl2;                 // 0x0254
	L9B0_CVB_SIZE_STATUS1_T         cvb_size_status1;                // 0x0258
	L9B0_CVB_SIZE_STATUS2_T         cvb_size_status2;                // 0x025c
	L9B0_CVB_SIZE_STATUS3_T         cvb_size_status3;                // 0x0260
	L9B0_CVB_SIZE_STATUS4_T         cvb_size_status4;                // 0x0264
	L9B0_CVB_PIX_SUM_CTRL0_T        cvb_pix_sum_ctrl0;               // 0x0268
	L9B0_CVB_PIX_SUM_CTRL1_T        cvb_pix_sum_ctrl1;               // 0x026c
	L9B0_CVB_PIX_SUM_STATUS0_T      cvb_pix_sum_status0;             // 0x0270
	L9B0_CVB_PIX_SUM_STATUS1_T      cvb_pix_sum_status1;             // 0x0274
	L9B0_CVB_PIX_SUM_STATUS2_T      cvb_pix_sum_status2;             // 0x0278
	L9B0_CVB_SYNC_FIL_CTRL_T        cvb_sync_fil_ctrl;               // 0x027c
	L9B0_CVB_SYNC_FIL_STATUS_T      cvb_sync_fil_status;             // 0x0280
	L9B0_CVB_CTI_CTRL_T             cvb_cti_ctrl;                    // 0x0284
	UINT32                          reserved2[2];                    // 0x0288~0x028c
	L9B0_CVB_SYNC_REPEAT_CTRL_T     cvb_sync_repeat_ctrl;            // 0x0290
	L9B0_CVB_SYNC_REPEAT_SIZE0_T    cvb_sync_repeat_size0;           // 0x0294
	L9B0_CVB_SYNC_REPEAT_SIZE1_T    cvb_sync_repeat_size1;           // 0x0298
	L9B0_CVB_SYNC_REPEAT_SIZE2_T    cvb_sync_repeat_size2;           // 0x029c
	L9B0_CVB_SYNC_REPEAT_SIZE3_T    cvb_sync_repeat_size3;           // 0x02a0
	L9B0_CVB_SYNC_REPEAT_SIZE4_T    cvb_sync_repeat_size4;           // 0x02a4
	L9B0_CVB_SYNC_REPEAT_SIZE5_T    cvb_sync_repeat_size5;           // 0x02a8
	L9B0_CVB_DIG_FILT_CTRL4_T       cvb_dig_filt_ctrl4;              // 0x02ac
	L9B0_CVB_DIG_FILT_CTRL5_T       cvb_dig_filt_ctrl5;              // 0x02b0
	L9B0_CVB_DIG_FILT_CTRL6_T       cvb_dig_filt_ctrl6;              // 0x02b4
	UINT32                          reserved3[2];                    // 0x02b8~0x02bc
	L9B0_CVB_SIZE_DETECT_CTRL_T     cvb_size_detect_ctrl;            // 0x02c0
	L9B0_CVB_SIZE_DETECT_READ_T     cvb_size_detect_read;            // 0x02c4
	L9B0_CVB_SIZE_STATUS0_T         cvb_size_status0;                // 0x02c8
	L9B0_CVB_SIZE_STATUS5_T         cvb_size_status5;                // 0x02cc
	L9B0_CVB_SIZE_STATUS6_T         cvb_size_status6;                // 0x02d0
	L9B0_CVB_SIZE_DETECT_CTRL1_T    cvb_size_detect_ctrl1;           // 0x02d4
	L9B0_CVB_SIZE_DETECT_CTRL2_T    cvb_size_detect_ctrl2;           // 0x02d8
	L9B0_CVB_PSEUDO_SYNC_CTRL0_T    cvb_pseudo_sync_ctrl0;           // 0x02dc
	L9B0_CVB_PSEUDO_SYNC_CTRL1_T    cvb_pseudo_sync_ctrl1;           // 0x02e0
	L9B0_CVB_PSEUDO_SYNC_CTRL2_T    cvb_pseudo_sync_ctrl2;           // 0x02e4
	L9B0_CVB_PSEUDO_SYNC_CTRL3_T    cvb_pseudo_sync_ctrl3;           // 0x02e8
	L9B0_CVB_PSEUDO_SYNC_CTRL4_T    cvb_pseudo_sync_ctrl4;           // 0x02ec
	L9B0_CVB_PREADY_TIMER_T         cvb_pready_timer;                // 0x02f0
} DE_CVB_REG_L9B0_T;
