...
#ifndef _REG_DLR_L9B0_h
#define _REG_DLR_L9B0_h
...
} L9B0_DLR_STATUS_LINE_CNT_T;

typedef struct {
	L9B0_DLR_IN_IMG_FORMAT_T    dlr_in_img_format;           // 0x0300
	L9B0_DLR_FRAME_PACK_INFO_T  dlr_frame_pack_info;         // 0x0304
	L9B0_DLR_STATUS_PIC_CNT_T   dlr_status_pic_cnt;          // 0x0308
	L9B0_DLR_STATUS_LINE_CNT_T  dlr_status_line_cnt;         // 0x030c
} DE_DLR_REG_L9B0_T;
