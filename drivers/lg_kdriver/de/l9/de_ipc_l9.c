 ...
 */
int DE_IPC_L9_Init(UINT32 *pVideoBuffToMCU, UINT32 *pVideoBuffFrMCU)
{
...
#else
   *pVideoBuffToMCU = (UINT32)ioremap(DTVSOC_IPC_FROM_CPU_L9_BASE, DTVSOC_IPC_FROM_CPU_SIZE);
   *pVideoBuffFrMCU = (UINT32)ioremap(DTVSOC_IPC_FROM_MCU_L9_BASE, DTVSOC_IPC_FROM_MCU_SIZE);
#endif
 ...
 * @return RET_OK(0) if success, none zero for otherwise
 */
int DE_IPC_L9_Free(UINT32 *pVideoBuffToMCU, UINT32 *pVideoBuffFrMCU)
{
#ifdef USE_QEMU_SYSTEM
