...
#ifndef _REG_IPC_L9B0_h
#define _REG_IPC_L9B0_h
...
typedef struct {
	L9B0_SET_CTRL0_T            set_ctrl0;                   // 0x4e00
	L9B0_SET_CTRL1_T            set_ctrl1;                   // 0x4e04
	L9B0_EXT_INTR_EVENT_T       ext_intr_event;              // 0x4e08
	L9B0_EXT_INTR_ENABLE_T      ext_intr_enable;             // 0x4e0c
	L9B0_EXT_INTR_STATUS_T      ext_intr_status;             // 0x4e10
	L9B0_EXT_INTR_CLEAR_T       ext_intr_clear;              // 0x4e14
	L9B0_INT_INTR_EVENT_T       int_intr_event;              // 0x4e18
	L9B0_INT_INTR_ENABLE_T      int_intr_enable;             // 0x4e1c
	L9B0_INT_INTR_STATUS_T      int_intr_status;             // 0x4e20
	L9B0_INT_INTR_CLEAR_T       int_intr_clear;              // 0x4e24
	L9B0_SROM_BOOT_OFFSET_T     srom_boot_offset;            // 0x4e28
	L9B0_ATLAS_PORT_SEL_T       atlas_port_sel;              // 0x4e2c
	L9B0_PDEBUG_STATUS_T        pdebug_status;               // 0x4e30
	L9B0_PDEBUG_DATA_T          pdebug_data;                 // 0x4e34
	L9B0_PDEBUG_PC_T            pdebug_pc;                   // 0x4e38
	L9B0_AXI_USER_ID_T          axi_user_id;                 // 0x4e3c
	L9B0_SRAM0_ATLAS_OFFSET_T   sram0_atlas_offset;          // 0x4e40
	L9B0_SRAM1_ATLAS_OFFSET_T   sram1_atlas_offset;          // 0x4e44
	L9B0_SRAM2_ATLAS_OFFSET_T   sram2_atlas_offset;          // 0x4e48
	L9B0_SROM_BOOT_OFFSET2_T    srom_boot_offset2;           // 0x4e4c
	UINT32                      reserved0[3];                // 0x4e50~0x4e58
	L9B0_SPP_MCU_VERSION_T      spp_mcu_version;             // 0x4e5c
	UINT32                      reserved1[40];               // 0x4e60~0x4efc
	L9B0_TX_LOCKED_ID_T         tx_locked_id;                // 0x4f00
	L9B0_TX_SRC_ADDR_T          tx_src_addr;                 // 0x4f04
	L9B0_TX_DST_ADDR_T          tx_dst_addr;                 // 0x4f08
	L9B0_TX_NXT_ADDR_T          tx_nxt_addr;                 // 0x4f0c
	L9B0_TX_LENGTH_T            tx_length;                   // 0x4f10
	L9B0_EDMA_CTRL_T            edma_ctrl;                   // 0x4f14
	L9B0_PATTERN_ADDR_T         pattern_addr;                // 0x4f18
	L9B0_PATTERN_DATA_T         pattern_data;                // 0x4f1c
} DE_IPC_REG_L9B0_T;
