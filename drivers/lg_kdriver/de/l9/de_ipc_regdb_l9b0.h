...
const DBG_REG_FIELD_T dbg_INT_INTR_STATUS[] = {
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,29 ,0  ,"ipc_interrupt_staus_mcu"     },
...
------------------------------------*/
const DBG_REG_FIELD_T dbg_SROM_BOOT_OFFSET2[] = {
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,31 ,0  ,"boot_img_offset2"            },
};
...
DBG_REG_T gDbgRegIPC[] = {
	...
	{ 0x4e4c ,N_FLD(dbg_SROM_BOOT_OFFSET2)       ,"SROM_BOOT_OFFSET2"         ,dbg_SROM_BOOT_OFFSET2       },
	{ 0x4e5c ,0                                  ,"SPP_MCU_VERSION"           ,NULL                        },
