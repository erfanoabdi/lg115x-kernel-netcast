...
const DBG_REG_FIELD_T dbg_MIFD_RD_CTRL[] = {
	...
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,2  ,2  ,"block_req_r_osd_0"           },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,3  ,3  ,"block_req_r_osd_1"           },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,4  ,4  ,"block_req_r_osd_2"           },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,5  ,5  ,"block_req_r_osd_3"           },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,6  ,6  ,"block_req_r_cve_y"           },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,7  ,7  ,"block_req_r_cve_c"           },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,12 ,12 ,"disable_rd_mif"              },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,13 ,13 ,"load_rd_req_stv_v"           },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,14 ,14 ,"load_rd_req_pri_v"           },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,15 ,15 ,"load_rd_cmd_saddr_v"         },
...
const DBG_REG_FIELD_T dbg_MIFD_RD_CMD_PRI0[] = {
	...
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,11 ,8  ,"cmd_rd_pri_v_osd_0"          },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,15 ,12 ,"cmd_rd_pri_v_osd_1"          },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,19 ,16 ,"cmd_rd_pri_v_osd_2"          },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,23 ,20 ,"cmd_rd_pri_v_osd_3"          },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,27 ,24 ,"cmd_rd_pri_v_cve_y"          },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,31 ,28 ,"cmd_rd_pri_v_cve_c"          },
};
...
const DBG_REG_FIELD_T dbg_MIFD_RD_REQ_PRI0[] = {
	...
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,11 ,8  ,"req_rd_pri_v_osd_0"          },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,15 ,12 ,"req_rd_pri_v_osd_1"          },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,19 ,16 ,"req_rd_pri_v_osd_2"          },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,23 ,20 ,"req_rd_pri_v_osd_3"          },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,27 ,24 ,"req_rd_pri_v_cve_y"          },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,31 ,28 ,"req_rd_pri_v_cve_c"          },
};
...
const DBG_REG_FIELD_T dbg_MIFD_RD_REQ_STV0[] = {
	...
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,11 ,8  ,"req_rd_stv_v_osd_0"          },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,15 ,12 ,"req_rd_stv_v_osd_1"          },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,19 ,16 ,"req_rd_stv_v_osd_2"          },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,23 ,20 ,"req_rd_stv_v_osd_3"          },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,27 ,24 ,"req_rd_stv_v_cve_y"          },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,31 ,28 ,"req_rd_stv_v_cve_c"          },
};
...
const DBG_REG_FIELD_T dbg_MIFD_RD_CMD_PEND0[] = {
	...
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,11 ,8  ,"cmd_rd_pend_v_osd_0"         },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,15 ,12 ,"cmd_rd_pend_v_osd_1"         },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,19 ,16 ,"cmd_rd_pend_v_osd_2"         },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,23 ,20 ,"cmd_rd_pend_v_osd_3"         },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,27 ,24 ,"cmd_rd_pend_v_cve_y"         },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,31 ,28 ,"cmd_rd_pend_v_cve_c"         },
};

/*--------------------------------------------
	0x3e24 MIFD_WD_CMD_PEND1
--------------------------------------------*/
const DBG_REG_FIELD_T dbg_MIFD_WD_CMD_PEND1[] = {
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,3  ,0  ,"cmd_wd_pend_v_sm_y"          },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,7  ,4  ,"cmd_wd_pend_v_sm_c"          },
};
...
const DBG_REG_FIELD_T dbg_MIFD_RD_CMD_STRIDE0[] = {
	...
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,11 ,8  ,"cmd_rd_stride_v_osd_0"       },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,15 ,12 ,"cmd_rd_stride_v_osd_1"       },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,19 ,16 ,"cmd_rd_stride_v_osd_2"       },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,23 ,20 ,"cmd_rd_stride_v_osd_3"       },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,27 ,24 ,"cmd_rd_stride_v_cve_y"       },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,31 ,28 ,"cmd_rd_stride_v_cve_c"       },
};
...
const DBG_REG_FIELD_T dbg_MIFD_RD_CMD_STRIDE_SET[] = {
	...
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,2  ,2  ,"man_cmd_rd_stride_v_osd_0"   },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,3  ,3  ,"man_cmd_rd_stride_v_osd_1"   },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,4  ,4  ,"man_cmd_rd_stride_v_osd_2"   },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,5  ,5  ,"man_cmd_rd_stride_v_osd_3"   },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,6  ,6  ,"man_cmd_rd_stride_v_cve_y"   },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,7  ,7  ,"man_cmd_rd_stride_v_cve_c"   },
};
...
const DBG_REG_FIELD_T dbg_MIFD_SADDR_RD_EXT0[] = {
	...
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,11 ,8  ,"req_rd_saddr_osd_0_msb4b"    },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,15 ,12 ,"req_rd_saddr_osd_1_msb4b"    },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,19 ,16 ,"req_rd_saddr_osd_2_msb4b"    },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,23 ,20 ,"req_rd_saddr_osd_3_msb4b"    },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,27 ,24 ,"req_rd_saddr_cve_y_msb4b"    },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,31 ,28 ,"req_rd_saddr_cve_c_msb4b"    },
};

/*--------------------------------------------
	0x3e50 MIFD_SADDR_WD_EXT0
--------------------------------------------*/
...
const DBG_REG_FIELD_T dbg_MIFD_STATUS[] = {
	...
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,2  ,2  ,"fr_rd_valid_osd_0"           },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,3  ,3  ,"fr_rd_valid_osd_1"           },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,4  ,4  ,"fr_rd_valid_osd_2"           },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,5  ,5  ,"fr_rd_valid_osd_3"           },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,6  ,6  ,"fr_rd_valid_cve_y"           },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,7  ,7  ,"fr_rd_valid_cve_c"           },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,8  ,8  ,"fr_wd_q_full_sm_y"           },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,9  ,9  ,"fr_wd_q_full_sm_c"           },
};

/*--------------------------------------------
	0x3e58 MIFD_SADDR_PARAM_UPDATE0_M
--------------------------------------------*/
...
const DBG_REG_FIELD_T dbg_MIFD_RD_BANK_8_ADDR0[] = {
	...
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,10 ,8  ,"req_rd_bank_addr_8_osd_0"    },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,14 ,12 ,"req_rd_bank_addr_8_osd_1"    },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,18 ,16 ,"req_rd_bank_addr_8_osd_2"    },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,22 ,20 ,"req_rd_bank_addr_8_osd_3"    },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,26 ,24 ,"req_rd_bank_addr_8_cve_y"    },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,30 ,28 ,"req_rd_bank_addr_8_cve_c"    },
};

/*--------------------------------------------
	0x3e60 MIFD_RD_BANK_8_ADDR1
--------------------------------------------*/
/* no field */

/*--------------------------------------------
	0x3e64 MIFD_RD_BANK_2_ADDR0
--------------------------------------------*/
/* no field */

/*--------------------------------------------
	0x3e68 MIFD_RD_BANK_2_ADDR1
--------------------------------------------*/
/* no field */

/*--------------------------------------------
	0x3e6c MIFD_WD_BANK_8_ADDR0
--------------------------------------------*/
...
/*--------------------------------------------
	0x3e70 MIFD_WD_BANK_8_ADDR1
--------------------------------------------*/
/* no field */

/*--------------------------------------------
	0x3e74 MIFD_WD_BANK_2_ADDR0
--------------------------------------------*/
/* no field */

/*--------------------------------------------
	0x3e78 MIFD_WD_BANK_2_ADDR1
--------------------------------------------*/
/* no field */

/*--------------------------------------------
	0x3e7c MIFD_RD_REQ_PEND0
--------------------------------------------*/
...
/*--------------------------------------------
	0x3e80 MIFD_WD_REQ_PEND0
--------------------------------------------*/
const DBG_REG_FIELD_T dbg_MIFD_WD_REQ_PEND0[] = {
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,7  ,0  ,"req_wd_pend_v_sm_y"          },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,15 ,8  ,"req_wd_pend_v_sm_c"          },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,23 ,16 ,"req_rd_pend_v_ov_y"          },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,31 ,24 ,"req_rd_pend_v_ov_c"          },
};

/*--------------------------------------------
	0x3e84 MIFD_RD_CMD_PRI0_S
--------------------------------------------*/
const DBG_REG_FIELD_T dbg_MIFD_RD_CMD_PRI0_S[] = {
	...
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,11 ,8  ,"cmd_rd_pri_s_v_osd_0"        },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,15 ,12 ,"cmd_rd_pri_s_v_osd_1"        },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,19 ,16 ,"cmd_rd_pri_s_v_osd_2"        },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,23 ,20 ,"cmd_rd_pri_s_v_osd_3"        },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,27 ,24 ,"cmd_rd_pri_s_v_cve_y"        },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,31 ,28 ,"cmd_rd_pri_s_v_cve_c"        },
};

/*--------------------------------------------
	0x3e88 MIFD_WD_CMD_PRI0_S
--------------------------------------------*/
...
const DBG_REG_FIELD_T dbg_MIFD_RESET[] = {
	...
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,2  ,2  ,"reset_mif_r_osd_0"           },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,3  ,3  ,"reset_mif_r_osd_1"           },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,4  ,4  ,"reset_mif_r_osd_2"           },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,5  ,5  ,"reset_mif_r_osd_3"           },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,6  ,6  ,"reset_mif_r_cve_y"           },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,7  ,7  ,"reset_mif_r_cve_c"           },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,8  ,8  ,"reset_mif_w_sm_y"            },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,9  ,9  ,"reset_mif_w_sm_c"            },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,31 ,20 ,"reset_time_out_cnt"          },
};
...
DBG_REG_T gDbgRegMIF[] = {
	...
	{ 0x3e00 ,N_FLD(dbg_MIFD_RD_CTRL)                    ,"MIFD_RD_CTRL"                      ,dbg_MIFD_RD_CTRL                    },
	{ 0x3e04 ,N_FLD(dbg_MIFD_WD_CTRL)                    ,"MIFD_WD_CTRL"                      ,dbg_MIFD_WD_CTRL                    },
	{ 0x3e08 ,N_FLD(dbg_MIFD_RD_CMD_PRI0)                ,"MIFD_RD_CMD_PRI0"                  ,dbg_MIFD_RD_CMD_PRI0                },
	{ 0x3e0c ,N_FLD(dbg_MIFD_WD_CMD_PRI0)                ,"MIFD_WD_CMD_PRI0"                  ,dbg_MIFD_WD_CMD_PRI0                },
	{ 0x3e10 ,N_FLD(dbg_MIFD_RD_REQ_PRI0)                ,"MIFD_RD_REQ_PRI0"                  ,dbg_MIFD_RD_REQ_PRI0                },
	{ 0x3e14 ,N_FLD(dbg_MIFD_WD_REQ_PRI0)                ,"MIFD_WD_REQ_PRI0"                  ,dbg_MIFD_WD_REQ_PRI0                },
	{ 0x3e18 ,N_FLD(dbg_MIFD_RD_REQ_STV0)                ,"MIFD_RD_REQ_STV0"                  ,dbg_MIFD_RD_REQ_STV0                },
	{ 0x3e1c ,N_FLD(dbg_MIFD_WD_REQ_STV0)                ,"MIFD_WD_REQ_STV0"                  ,dbg_MIFD_WD_REQ_STV0                },
	{ 0x3e20 ,N_FLD(dbg_MIFD_RD_CMD_PEND0)               ,"MIFD_RD_CMD_PEND0"                 ,dbg_MIFD_RD_CMD_PEND0               },
	{ 0x3e24 ,N_FLD(dbg_MIFD_WD_CMD_PEND1)               ,"MIFD_WD_CMD_PEND1"                 ,dbg_MIFD_WD_CMD_PEND1               },
	{ 0x3e28 ,N_FLD(dbg_MIFD_RD_CMD_STRIDE0)             ,"MIFD_RD_CMD_STRIDE0"               ,dbg_MIFD_RD_CMD_STRIDE0             },
	{ 0x3e2c ,N_FLD(dbg_MIFD_RD_CMD_STRIDE_SET)          ,"MIFD_RD_CMD_STRIDE_SET"            ,dbg_MIFD_RD_CMD_STRIDE_SET          },
	{ 0x3e30 ,N_FLD(dbg_MIFD_WD_CMD_STRIDE0)             ,"MIFD_WD_CMD_STRIDE0"               ,dbg_MIFD_WD_CMD_STRIDE0             },
	{ 0x3e34 ,N_FLD(dbg_MIFD_WD_CMD_STRIDE_SET)          ,"MIFD_WD_CMD_STRIDE_SET"            ,dbg_MIFD_WD_CMD_STRIDE_SET          },
	{ 0x3e38 ,N_FLD(dbg_MIFD_SADDR_RD_OV_Y_OV_C)         ,"MIFD_SADDR_RD_OV_Y_OV_C"           ,dbg_MIFD_SADDR_RD_OV_Y_OV_C         },
	{ 0x3e3c ,N_FLD(dbg_MIFD_SADDR_RD_OSD_01)            ,"MIFD_SADDR_RD_OSD_01"              ,dbg_MIFD_SADDR_RD_OSD_01            },
	{ 0x3e40 ,N_FLD(dbg_MIFD_SADDR_RD_OSD_23)            ,"MIFD_SADDR_RD_OSD_23"              ,dbg_MIFD_SADDR_RD_OSD_23            },
	{ 0x3e44 ,N_FLD(dbg_MIFD_SADDR_RD_CVE_YC)            ,"MIFD_SADDR_RD_CVE_YC"              ,dbg_MIFD_SADDR_RD_CVE_YC            },
	{ 0x3e48 ,N_FLD(dbg_MIFD_SADDR_WD_SM_YC)             ,"MIFD_SADDR_WD_SM_YC"               ,dbg_MIFD_SADDR_WD_SM_YC             },
	{ 0x3e4c ,N_FLD(dbg_MIFD_SADDR_RD_EXT0)              ,"MIFD_SADDR_RD_EXT0"                ,dbg_MIFD_SADDR_RD_EXT0              },
	{ 0x3e50 ,N_FLD(dbg_MIFD_SADDR_WD_EXT0)              ,"MIFD_SADDR_WD_EXT0"                ,dbg_MIFD_SADDR_WD_EXT0              },
	{ 0x3e54 ,N_FLD(dbg_MIFD_STATUS)                     ,"MIFD_STATUS"                       ,dbg_MIFD_STATUS                     },
	{ 0x3e58 ,N_FLD(dbg_MIFD_SADDR_PARAM_UPDATE0_M)      ,"MIFD_SADDR_PARAM_UPDATE0_M"        ,dbg_MIFD_SADDR_PARAM_UPDATE0_M      },
	{ 0x3e5c ,N_FLD(dbg_MIFD_RD_BANK_8_ADDR0)            ,"MIFD_RD_BANK_8_ADDR0"              ,dbg_MIFD_RD_BANK_8_ADDR0            },
	{ 0x3e60 ,0                                          ,"MIFD_RD_BANK_8_ADDR1"              ,NULL                                },
	{ 0x3e64 ,0                                          ,"MIFD_RD_BANK_2_ADDR0"              ,NULL                                },
	{ 0x3e68 ,0                                          ,"MIFD_RD_BANK_2_ADDR1"              ,NULL                                },
	{ 0x3e6c ,N_FLD(dbg_MIFD_WD_BANK_8_ADDR0)            ,"MIFD_WD_BANK_8_ADDR0"              ,dbg_MIFD_WD_BANK_8_ADDR0            },
	{ 0x3e70 ,0                                          ,"MIFD_WD_BANK_8_ADDR1"              ,NULL                                },
	{ 0x3e74 ,0                                          ,"MIFD_WD_BANK_2_ADDR0"              ,NULL                                },
	{ 0x3e78 ,0                                          ,"MIFD_WD_BANK_2_ADDR1"              ,NULL                                },
	{ 0x3e7c ,N_FLD(dbg_MIFD_RD_REQ_PEND0)               ,"MIFD_RD_REQ_PEND0"                 ,dbg_MIFD_RD_REQ_PEND0               },
	{ 0x3e80 ,N_FLD(dbg_MIFD_WD_REQ_PEND0)               ,"MIFD_WD_REQ_PEND0"                 ,dbg_MIFD_WD_REQ_PEND0               },
	{ 0x3e84 ,N_FLD(dbg_MIFD_RD_CMD_PRI0_S)              ,"MIFD_RD_CMD_PRI0_S"                ,dbg_MIFD_RD_CMD_PRI0_S              },
	{ 0x3e88 ,N_FLD(dbg_MIFD_WD_CMD_PRI0_S)              ,"MIFD_WD_CMD_PRI0_S"                ,dbg_MIFD_WD_CMD_PRI0_S              },
	{ 0x3e8c ,N_FLD(dbg_MIFD_RESET)                      ,"MIFD_RESET"                        ,dbg_MIFD_RESET                      },
	{ 0 , } // end marker
};
