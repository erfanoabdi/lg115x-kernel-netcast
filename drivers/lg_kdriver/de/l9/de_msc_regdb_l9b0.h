...
const DBG_REG_FIELD_T dbg_MSC_ADAPTIVE_TH_L[] = {
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,3  ,0  ,"reg_th"                          },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,5  ,4  ,"blending_range"                  },
};
...
/*----------------------------------------
	0x11a0 CHROMA_V_CTI
----------------------------------------*/
const DBG_REG_FIELD_T dbg_CHROMA_V_CTI[] = {
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,0  ,0  ,"chroma_v_cti_enable"             },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,5  ,4  ,"v_cti_strength"                  },
};
...
DBG_REG_T gDbgRegMSC[] = {
	...
	{ 0x11a0 ,N_FLD(dbg_CHROMA_V_CTI)                ,"CHROMA_V_CTI"                  ,dbg_CHROMA_V_CTI                },
