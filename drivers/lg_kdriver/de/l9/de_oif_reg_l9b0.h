...
#ifndef _REG_OIF_L9B0_h
#define _REG_OIF_L9B0_h
...
} L9B0_LVDS_FORCE_DATA_T;

typedef struct {
	L9B0_OUT_VIDEO_INFO_T       out_video_info;              // 0x5c00
	L9B0_DATA_COLOR_FROM_T      data_color_from;             // 0x5c04
	L9B0_DATA_COLOR_T           data_color;                  // 0x5c08
	L9B0_SYNC_COLOR_T           sync_color;                  // 0x5c0c
	L9B0_DELAY_DATA_T           delay_data;                  // 0x5c10
	L9B0_SYNC_DE_CONTROL_T      sync_de_control;             // 0x5c14
	UINT32                      reserved0[2];                // 0x5c18~0x5c1c
	L9B0_LVDS_IF_CONTROL_T      lvds_if_control;             // 0x5c20
	L9B0_LVDS_PORT_SWAP_T       lvds_port_swap;              // 0x5c24
	UINT32                      reserved1[4];                // 0x5c28~0x5c34
	L9B0_LVDS_FORCE_DATA_EN_T   lvds_force_data_en;          // 0x5c38
	L9B0_LVDS_FORCE_DATA_T      lvds_force_data;             // 0x5c3c
} DE_OIF_REG_L9B0_T;
