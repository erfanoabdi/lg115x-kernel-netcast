...
DBG_REG_T gDbgRegOIF[] = {
	{ 0x3d00 ,N_FLD(dbg_OUT_VIDEO_INFO)          ,"OUT_VIDEO_INFO"            ,dbg_OUT_VIDEO_INFO          },
	{ 0x3d04 ,N_FLD(dbg_DATA_COLOR_FROM)         ,"DATA_COLOR_FROM"           ,dbg_DATA_COLOR_FROM         },
	{ 0x3d08 ,N_FLD(dbg_DATA_COLOR)              ,"DATA_COLOR"                ,dbg_DATA_COLOR              },
	{ 0x3d0c ,N_FLD(dbg_SYNC_COLOR)              ,"SYNC_COLOR"                ,dbg_SYNC_COLOR              },
	{ 0x3d10 ,N_FLD(dbg_DELAY_DATA)              ,"DELAY_DATA"                ,dbg_DELAY_DATA              },
	{ 0x3d14 ,N_FLD(dbg_SYNC_DE_CONTROL)         ,"SYNC_DE_CONTROL"           ,dbg_SYNC_DE_CONTROL         },
	{ 0x3d20 ,N_FLD(dbg_LVDS_IF_CONTROL)         ,"LVDS_IF_CONTROL"           ,dbg_LVDS_IF_CONTROL         },
	{ 0x3d24 ,N_FLD(dbg_LVDS_PORT_SWAP)          ,"LVDS_PORT_SWAP"            ,dbg_LVDS_PORT_SWAP          },
	{ 0x3d38 ,N_FLD(dbg_LVDS_FORCE_DATA_EN)      ,"LVDS_FORCE_DATA_EN"        ,dbg_LVDS_FORCE_DATA_EN      },
	{ 0x3d3c ,N_FLD(dbg_LVDS_FORCE_DATA)         ,"LVDS_FORCE_DATA"           ,dbg_LVDS_FORCE_DATA         },
	{ 0 , } // end marker
};
