...
#ifndef _REG_SSC_L9B0_h
#define _REG_SSC_L9B0_h
...
} L9B0_SSC_CANVAS_MODE_T;

typedef struct {
	L9B0_SSC_CTRL_T                 ssc_ctrl;                        // 0x2100
	L9B0_SSC_FIELD_T                ssc_field;                       // 0x2104
	L9B0_SSC_Y_INIT_POS_H_T         ssc_y_init_pos_h;                // 0x2108
	L9B0_SSC_Y_INIT_POS_V_T         ssc_y_init_pos_v;                // 0x210c
	L9B0_SSC_C_INIT_POS_H_T         ssc_c_init_pos_h;                // 0x2110
	L9B0_SSC_C_INIT_POS_V_T         ssc_c_init_pos_v;                // 0x2114
	L9B0_SSC_SCR_SIZE_T             ssc_scr_size;                    // 0x2118
	L9B0_SSC_WIN_OUT_SIZE_T         ssc_win_out_size;                // 0x211c
	L9B0_SSC_WIN_IN_OFFSET_T        ssc_win_in_offset;               // 0x2120
	L9B0_SSC_WIN_IN_SIZE_T          ssc_win_in_size;                 // 0x2124
	L9B0_SSC_C_FORMAT_T             ssc_c_format;                    // 0x2128
	UINT32                          reserved0;                       // 0x212c
	L9B0_SSC_H_FIR_COEF_DATA0_T     ssc_h_fir_coef_data0;            // 0x2130
	L9B0_SSC_H_FIR_COEF_DATA1_T     ssc_h_fir_coef_data1;            // 0x2134
	L9B0_SSC_H_FIR_COEF_DATA2_T     ssc_h_fir_coef_data2;            // 0x2138
	L9B0_SSC_H_FIR_COEF_DATA3_T     ssc_h_fir_coef_data3;            // 0x213c
	L9B0_SSC_H_FIR_COEF_CTRL_T      ssc_h_fir_coef_ctrl;             // 0x2140
	UINT32                          reserved1[9];                    // 0x2144~0x2164
	L9B0_SSC_STATUS_REV_T           ssc_status_rev;                  // 0x2168
	L9B0_SSC_MANUAL_LOAD_T          ssc_manual_load;                 // 0x216c
	L9B0_SSC_CANVAS_MODE_T          ssc_canvas_mode;                 // 0x2170
} DE_SSC_REG_L9B0_T;
