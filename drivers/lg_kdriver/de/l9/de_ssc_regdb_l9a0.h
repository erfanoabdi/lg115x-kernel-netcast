...
/*----------------------------------------
	0x2160 SSC_UPDATE_FROM_DDR
----------------------------------------*/
const DBG_REG_FIELD_T dbg_SSC_UPDATE_FROM_DDR[] = {
...
DBG_REG_T gDbgRegSSC[] = {
	...
	{ 0x2160 ,N_FLD(dbg_SSC_UPDATE_FROM_DDR)         ,"SSC_UPDATE_FROM_DDR"           ,dbg_SSC_UPDATE_FROM_DDR         },
