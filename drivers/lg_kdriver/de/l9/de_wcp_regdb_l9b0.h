...
const DBG_REG_FIELD_T dbg_OVL_OV_CTRL0[] = {
	...
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,17 ,16 ,"mif_last_mode"               },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,21 ,20 ,"ov_out_sync_mux"             },
};
...
/*------------------------------------
	0x1254 OV_CTRL7
------------------------------------*/
const DBG_REG_FIELD_T dbg_OV_CTRL7[] = {
...
------------------------------------*/
const DBG_REG_FIELD_T dbg_OVL_OV_YC_DELAY[] = {
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,11 ,0  ,"c_delay_h"                   },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,27 ,16 ,"c_delay_v"                   },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,30 ,30 ,"v_delay_mode"                },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,31 ,31 ,"delay_disable"               },
};

/*------------------------------------
	0x125c OV_MIF_CTRL0
------------------------------------*/
const DBG_REG_FIELD_T dbg_OV_MIF_CTRL0[] = {
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,11 ,0  ,"main_c_mif_line_offset"      },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,14 ,13 ,"main_c_mif_line_inc"         },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,15 ,15 ,"main_c_manual_mif_ctrl_en"   },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,27 ,16 ,"main_y_mif_line_offset"      },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,30 ,29 ,"main_y_mif_line_inc"         },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,31 ,31 ,"main_y_manual_mif_ctrl_en"   },
};

/*------------------------------------
	0x1260 OV_MIF_CTRL1
------------------------------------*/
const DBG_REG_FIELD_T dbg_OV_MIF_CTRL1[] = {
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,11 ,0  ,"sub_c_mif_line_offset"       },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,14 ,13 ,"sub_c_mif_line_inc"          },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,15 ,15 ,"sub_c_manual_mif_ctrl_en"    },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,27 ,16 ,"sub_y_mif_line_offset"       },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,30 ,29 ,"sub_y_mif_line_inc"          },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,31 ,31 ,"sub_y_manual_mif_ctrl_en"    },
};
...
const DBG_REG_FIELD_T dbg_OVR_OV_CTRL0[] = {
	...
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,2  ,2  ,"main_420"                    },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,7  ,6  ,"main_cflt_mode"              },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,16 ,16 ,"mif_last_mode"               },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,20 ,20 ,"ov_out_sync_mux"             },
};
...
------------------------------------*/
const DBG_REG_FIELD_T dbg_OVR_OV_YC_DELAY[] = {
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,11 ,0  ,"c_delay_h"                   },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,27 ,16 ,"c_delay_v"                   },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,30 ,30 ,"v_delay_mode"                },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,31 ,31 ,"delay_disable"               },
...
/*------------------------------------
	0x325c OV_MIF_CTRL
------------------------------------*/
const DBG_REG_FIELD_T dbg_OV_MIF_CTRL[] = {
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,11 ,0  ,"main_c_mif_line_offset"      },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,14 ,13 ,"main_c_mif_line_inc"         },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,15 ,15 ,"main_c_manual_mif_ctrl_en"   },
	{ REG_XS_N_RW ,0 ,0 ,0 ,0 ,27 ,16 ,"main_y_mif_line_offset"      },
...
DBG_REG_T gDbgRegWCP[] = {
	...
	{ 0x1254 ,N_FLD(dbg_OV_CTRL7)                ,"OV_CTRL7"                  ,dbg_OV_CTRL7                },
	{ 0x1258 ,N_FLD(dbg_OVL_OV_YC_DELAY)         ,"OVL_OV_YC_DELAY"           ,dbg_OVL_OV_YC_DELAY         },
	{ 0x125c ,N_FLD(dbg_OV_MIF_CTRL0)            ,"OV_MIF_CTRL0"              ,dbg_OV_MIF_CTRL0            },
	{ 0x1260 ,N_FLD(dbg_OV_MIF_CTRL1)            ,"OV_MIF_CTRL1"              ,dbg_OV_MIF_CTRL1            },
	...
	{ 0x3258 ,N_FLD(dbg_OVR_OV_YC_DELAY)         ,"OVR_OV_YC_DELAY"           ,dbg_OVR_OV_YC_DELAY         },
	{ 0x325c ,N_FLD(dbg_OV_MIF_CTRL)             ,"OV_MIF_CTRL"               ,dbg_OV_MIF_CTRL             },
	{ 0 , } // end marker
};
