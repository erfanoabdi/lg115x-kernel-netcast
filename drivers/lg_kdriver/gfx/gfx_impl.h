...
#define GFX_WARN(format, args...)		DBG_PRINT( g_gfx_debug_fd, 2, "<wrn> %s:%d - " format, __F__,__L__,##args)
#define	GFX_ERROR(format, args...)		DBG_PRINT( g_gfx_debug_fd, 3, "<err> %s:%d - " format, __F__,__L__,##args)
