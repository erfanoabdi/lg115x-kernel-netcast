...
extern void 	GFX_H13_SetRegister(UINT32 addr, UINT32 val);
extern UINT32 	GFX_H13_GetRegister(UINT32 addr);
...
const static	GFX_HAL_T		g_gfx_hal_h13 =
{
	...
	.SetRegister			= GFX_H13_SetRegister,
	.GetRegister			= GFX_H13_GetRegister,
...
int 			GFX_H13_ShutdownHW	(void)
{
	g_gfx_reg_h13->gfx_intr_ctrl.intr_en = 0;	// interrupt disable
