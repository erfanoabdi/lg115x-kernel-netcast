...
#ifndef _GFX_REG_L9A0_H_
#define _GFX_REG_L9A0_H_
 ...
 * g_gfx_reg_l9a0 : real register of GFX.
 * g_gfx_reg_l9a0_cache     : shadow register.
 *
 ...
 * */
#define GFX_RdFL(_r)			((g_gfx_reg_l9a0_cache->_r)=(g_gfx_reg_l9a0->_r))
#define GFX_WrFL(_r)			((g_gfx_reg_l9a0->_r)=(g_gfx_reg_l9a0_cache->_r))

#define GFX_Rd(_r)				*((UINT32*)(&(g_gfx_reg_l9a0_cache->_r)))
...
#define GFX_Rd01(_r,_f01,_v01)													\
								do { 											\
									(_v01) = (g_gfx_reg_l9a0_cache->_r._f01);				\
								} while(0)

#define GFX_Rd02(_r,_f01,_v01,_f02,_v02)										\
								do { 											\
									(_v01) = (g_gfx_reg_l9a0_cache->_r._f01);				\
									(_v02) = (g_gfx_reg_l9a0_cache->_r._f02);				\
								} while(0)
...
#define GFX_Rd03(_r,_f01,_v01,_f02,_v02,_f03,_v03)								\
								do { 											\
									(_v01) = (g_gfx_reg_l9a0_cache->_r._f01);				\
									(_v02) = (g_gfx_reg_l9a0_cache->_r._f02);				\
									(_v03) = (g_gfx_reg_l9a0_cache->_r._f03);				\
								} while(0)
...
#define GFX_Rd04(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04)					\
								do { 											\
									...
									(_v02) = (g_gfx_reg_l9a0_cache->_r._f02);				\
									(_v03) = (g_gfx_reg_l9a0_cache->_r._f03);				\
									(_v04) = (g_gfx_reg_l9a0_cache->_r._f04);				\
								} while(0)
...
#define GFX_Rd05(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05)													\
								do { 											\
									...
									(_v03) = (g_gfx_reg_l9a0_cache->_r._f03);				\
									(_v04) = (g_gfx_reg_l9a0_cache->_r._f04);				\
									(_v05) = (g_gfx_reg_l9a0_cache->_r._f05);				\
								} while(0)
...
#define GFX_Rd06(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06)										\
								do { 											\
									...
									(_v04) = (g_gfx_reg_l9a0_cache->_r._f04);				\
									(_v05) = (g_gfx_reg_l9a0_cache->_r._f05);				\
									(_v06) = (g_gfx_reg_l9a0_cache->_r._f06);				\
								} while(0)
...
#define GFX_Rd07(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07)								\
								do { 											\
									...
									(_v05) = (g_gfx_reg_l9a0_cache->_r._f05);				\
									(_v06) = (g_gfx_reg_l9a0_cache->_r._f06);				\
									(_v07) = (g_gfx_reg_l9a0_cache->_r._f07);				\
								} while(0)
...
#define GFX_Rd08(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08)					\
								do { 											\
									...
									(_v06) = (g_gfx_reg_l9a0_cache->_r._f06);				\
									(_v07) = (g_gfx_reg_l9a0_cache->_r._f07);				\
									(_v08) = (g_gfx_reg_l9a0_cache->_r._f08);				\
								} while(0)
...
#define GFX_Rd09(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					...
					_f09,_v09)													\
								do { 											\
									...
									(_v07) = (g_gfx_reg_l9a0_cache->_r._f07);				\
									(_v08) = (g_gfx_reg_l9a0_cache->_r._f08);				\
									(_v09) = (g_gfx_reg_l9a0_cache->_r._f09);				\
								} while(0)
...
#define GFX_Rd10(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					...
					_f09,_v09,_f10,_v10)										\
								do { 											\
									...
									(_v08) = (g_gfx_reg_l9a0_cache->_r._f08);				\
									(_v09) = (g_gfx_reg_l9a0_cache->_r._f09);				\
									(_v10) = (g_gfx_reg_l9a0_cache->_r._f10);				\
								} while(0)
...
#define GFX_Rd11(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					...
					_f09,_v09,_f10,_v10,_f11,_v11)								\
								do { 											\
									...
									(_v09) = (g_gfx_reg_l9a0_cache->_r._f09);				\
									(_v10) = (g_gfx_reg_l9a0_cache->_r._f10);				\
									(_v11) = (g_gfx_reg_l9a0_cache->_r._f11);				\
								} while(0)
...
#define GFX_Rd12(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					...
					_f09,_v09,_f10,_v10,_f11,_v11,_f12,_v12)					\
								do { 											\
									...
									(_v10) = (g_gfx_reg_l9a0_cache->_r._f10);				\
									(_v11) = (g_gfx_reg_l9a0_cache->_r._f11);				\
									(_v12) = (g_gfx_reg_l9a0_cache->_r._f12);				\
								} while(0)
...
#define GFX_Rd13(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					...
					_f13,_v13)													\
								do { 											\
									...
									(_v11) = (g_gfx_reg_l9a0_cache->_r._f11);				\
									(_v12) = (g_gfx_reg_l9a0_cache->_r._f12);				\
									(_v13) = (g_gfx_reg_l9a0_cache->_r._f13);				\
								} while(0)
...
#define GFX_Rd14(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					...
					_f13,_v13,_f14,_v14)										\
								do { 											\
									...
									(_v12) = (g_gfx_reg_l9a0_cache->_r._f12);				\
									(_v13) = (g_gfx_reg_l9a0_cache->_r._f13);				\
									(_v14) = (g_gfx_reg_l9a0_cache->_r._f14);				\
								} while(0)
...
#define GFX_Rd15(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					...
					_f13,_v13,_f14,_v14,_f15,_v15)								\
								do { 											\
									...
									(_v13) = (g_gfx_reg_l9a0_cache->_r._f13);				\
									(_v14) = (g_gfx_reg_l9a0_cache->_r._f14);				\
									(_v15) = (g_gfx_reg_l9a0_cache->_r._f15);				\
								} while(0)
...
#define GFX_Rd16(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					...
					_f13,_v13,_f14,_v14,_f15,_v15,_f16,_v16)					\
								do { 											\
									...
									(_v14) = (g_gfx_reg_l9a0_cache->_r._f14);				\
									(_v15) = (g_gfx_reg_l9a0_cache->_r._f15);				\
									(_v16) = (g_gfx_reg_l9a0_cache->_r._f16);				\
								} while(0)
...
#define GFX_Wr01(_r,_f01,_v01)													\
								do { 											\
									(g_gfx_reg_l9a0_cache->_r._f01) = (_v01);				\
								} while(0)

#define GFX_Wr02(_r,_f01,_v01,_f02,_v02)										\
								do { 											\
									(g_gfx_reg_l9a0_cache->_r._f01) = (_v01);				\
									(g_gfx_reg_l9a0_cache->_r._f02) = (_v02);				\
								} while(0)
...
#define GFX_Wr03(_r,_f01,_v01,_f02,_v02,_f03,_v03)								\
								do { 											\
									(g_gfx_reg_l9a0_cache->_r._f01) = (_v01);				\
									(g_gfx_reg_l9a0_cache->_r._f02) = (_v02);				\
									(g_gfx_reg_l9a0_cache->_r._f03) = (_v03);				\
								} while(0)
...
#define GFX_Wr04(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04)					\
								do { 											\
									...
									(g_gfx_reg_l9a0_cache->_r._f02) = (_v02);				\
									(g_gfx_reg_l9a0_cache->_r._f03) = (_v03);				\
									(g_gfx_reg_l9a0_cache->_r._f04) = (_v04);				\
								} while(0)
...
#define GFX_Wr05(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05)													\
								do { 											\
									...
									(g_gfx_reg_l9a0_cache->_r._f03) = (_v03);				\
									(g_gfx_reg_l9a0_cache->_r._f04) = (_v04);				\
									(g_gfx_reg_l9a0_cache->_r._f05) = (_v05);				\
								} while(0)
...
#define GFX_Wr06(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06)										\
								do { 											\
									...
									(g_gfx_reg_l9a0_cache->_r._f04) = (_v04);				\
									(g_gfx_reg_l9a0_cache->_r._f05) = (_v05);				\
									(g_gfx_reg_l9a0_cache->_r._f06) = (_v06);				\
								} while(0)
...
#define GFX_Wr07(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07)								\
								do { 											\
									...
									(g_gfx_reg_l9a0_cache->_r._f05) = (_v05);				\
									(g_gfx_reg_l9a0_cache->_r._f06) = (_v06);				\
									(g_gfx_reg_l9a0_cache->_r._f07) = (_v07);				\
								} while(0)
...
#define GFX_Wr08(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08)					\
								do { 											\
									...
									(g_gfx_reg_l9a0_cache->_r._f06) = (_v06);				\
									(g_gfx_reg_l9a0_cache->_r._f07) = (_v07);				\
									(g_gfx_reg_l9a0_cache->_r._f08) = (_v08);				\
								} while(0)
...
#define GFX_Wr09(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					...
					_f09,_v09)													\
								do { 											\
									...
									(g_gfx_reg_l9a0_cache->_r._f07) = (_v07);				\
									(g_gfx_reg_l9a0_cache->_r._f08) = (_v08);				\
									(g_gfx_reg_l9a0_cache->_r._f09) = (_v09);				\
								} while(0)
...
#define GFX_Wr10(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					...
					_f09,_v09,_f10,_v10)										\
								do { 											\
									...
									(g_gfx_reg_l9a0_cache->_r._f08) = (_v08);				\
									(g_gfx_reg_l9a0_cache->_r._f09) = (_v09);				\
									(g_gfx_reg_l9a0_cache->_r._f10) = (_v10);				\
								} while(0)
...
#define GFX_Wr11(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					...
					_f09,_v09,_f10,_v10,_f11,_v11)								\
								do { 											\
									...
									(g_gfx_reg_l9a0_cache->_r._f09) = (_v09);				\
									(g_gfx_reg_l9a0_cache->_r._f10) = (_v10);				\
									(g_gfx_reg_l9a0_cache->_r._f11) = (_v11);				\
								} while(0)
...
#define GFX_Wr12(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					...
					_f09,_v09,_f10,_v10,_f11,_v11,_f12,_v12)					\
								do { 											\
									...
									(g_gfx_reg_l9a0_cache->_r._f10) = (_v10);				\
									(g_gfx_reg_l9a0_cache->_r._f11) = (_v11);				\
									(g_gfx_reg_l9a0_cache->_r._f12) = (_v12);				\
								} while(0)
...
#define GFX_Wr13(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					...
					_f13,_v13)													\
								do { 											\
									...
									(g_gfx_reg_l9a0_cache->_r._f11) = (_v11);				\
									(g_gfx_reg_l9a0_cache->_r._f12) = (_v12);				\
									(g_gfx_reg_l9a0_cache->_r._f13) = (_v13);				\
								} while(0)
...
#define GFX_Wr14(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					...
					_f13,_v13,_f14,_v14)										\
								do { 											\
									...
									(g_gfx_reg_l9a0_cache->_r._f12) = (_v12);				\
									(g_gfx_reg_l9a0_cache->_r._f13) = (_v13);				\
									(g_gfx_reg_l9a0_cache->_r._f14) = (_v14);				\
								} while(0)
...
#define GFX_Wr15(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					...
					_f13,_v13,_f14,_v14,_f15,_v15)								\
								do { 											\
									...
									(g_gfx_reg_l9a0_cache->_r._f13) = (_v13);				\
									(g_gfx_reg_l9a0_cache->_r._f14) = (_v14);				\
									(g_gfx_reg_l9a0_cache->_r._f15) = (_v15);				\
								} while(0)
...
#define GFX_Wr16(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					...
					_f13,_v13,_f14,_v14,_f15,_v15,_f16,_v16)					\
								do { 											\
									...
									(g_gfx_reg_l9a0_cache->_r._f14) = (_v14);				\
									(g_gfx_reg_l9a0_cache->_r._f15) = (_v15);				\
									(g_gfx_reg_l9a0_cache->_r._f16) = (_v16);				\
								} while(0)
...
/* from 'LG1152-GFX-MAN.csv' 20110405 13:32:14   대한민국 표준시 by getregs v2.7 */
