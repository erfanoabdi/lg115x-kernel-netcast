...
#define HDMI_H13_READ_COUNT		10
#define HDMI_H13_SCDT_COUNT		 4
#define HDMI_H13_CHEAK_COUNT	 4
...
#define DEBUG_HDMI_AUDIO_MSG_PRINT_TIME_1S		(1000/HDMI_THREAD_TIMEOUT)	///<  1 second, Thread calls a every 20 ms.
