...
#define AUD_MASTER_IO_RESET_AAD_MODULE					_IO( AUD_MASTER_IOC_MAGIC, 25)
...
typedef enum {
	...
	LX_AUD_MASTER_SE_FN_002				=	2,			///< not used
	LX_AUD_MASTER_SE_FN_003				=	3,			///< DEQ
	LX_AUD_MASTER_SE_FN_005				=	5,			///< not used
	LX_AUD_MASTER_SE_FN_006				=	6,			///< Infinite Sound
	...
	LX_AUD_MASTER_SE_FN_011 			=	11,			///< EME
	LX_AUD_MASTER_SE_FN_012 			=	12,			///< AGCCI
	LX_AUD_MASTER_SE_FN_013 			=	13,			///< AGCN
...
/**
 * AUDIO MASTER SOUND BAR SET STATUS.
 */
typedef struct {
