...
#define HDMI_IOR_GET_HDMI_AVI				_IOR(HDMI_IOC_MAGIC,  40, LX_HDMI_AVI_PACKET_T)
#define HDMI_IOR_GET_HDMI_VSI				_IOR(HDMI_IOC_MAGIC,  41, LX_HDMI_VSI_PACKET_T)
#define HDMI_IOR_GET_HDMI_SPD				_IOR(HDMI_IOC_MAGIC,  42, LX_HDMI_SPD_PACKET_T)
