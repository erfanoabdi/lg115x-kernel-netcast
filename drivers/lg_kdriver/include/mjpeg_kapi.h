...
#define LX_MJPEG_IOR_GET_CFG				_IOR(MJPEG_IOC_MAGIC, 9, LX_MJPEG_CFG_T )
...
#define	LX_MJPEG_DECODE_CAPS_PROGRESSIVE		0x00000001	/** if progressive jpeg can be decoded ? */
	UINT32			decode_caps;
