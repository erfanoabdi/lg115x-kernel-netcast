...
----------------------------------------------------------------------------------------*/
#define MONITOR_IORW_READ_REG			_IOWR(MONITOR_IOC_MAGIC, 0, LX_REGISTER_T )
#define MONITOR_IOW_WRITE_REG			_IOW(MONITOR_IOC_MAGIC, 1, LX_REGISTER_T )
#define DOUMI_I2C_INIT_CONFIG			_IO(MONITOR_IOC_MAGIC, 2 )
#define DOUMI_I2C_IOR_READ_REG			_IOWR(MONITOR_IOC_MAGIC, 3, LX_REGISTER_T )
#define DOUMI_I2C_IOW_WRITE_REG			_IOW(MONITOR_IOC_MAGIC, 4, LX_REGISTER_T )
