...
/* SDEC Input Path 설정을 Refactoring 하기 위한 Definition 
     Temporal 한 것입니다. 2012. 08. 10 ~ 2012. 08. 31 ?? */
#define LX_SDEC_USE_NEW_INPUTCONFIG		1
...
#define SDEC_IOW_CFG_INPUT_PORT				_IOWR(SDEC_IOC_MAGIC, 61, LX_SDEC_CFG_INPUT_T)
...
#define SDEC_IOW_GET_CHIPCFG					_IOWR(SDEC_IOC_MAGIC, 75, LX_SDEC_CHIP_CFG_T)

#define SDEC_IOW_DBG_CMD						_IOWR(SDEC_IOC_MAGIC, 80, LX_SDEC_DBG_CMD_T)


#define SDEC_IOC_MAXNR				80
/** @} */
...
typedef enum
{
	...
	LX_SDEC_BLOCK_CTOP				= 0x00000005,	/**< CTOP Register */
} LX_SDEC_BLOCK_T;
