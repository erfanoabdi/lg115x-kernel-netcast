...
typedef enum {
	...
	LX_VBI_CP_TYPE_WSS		=16,		///< WSS Copy protection
	LX_VBI_CP_TYPE_ANALOG_1 =32,	///< Analog protection Type 1
	LX_VBI_CP_TYPE_ANALOG_2 =64,	///< Analog protection Type 2
	LX_VBI_CP_TYPE_ANALOG_3 =128,	///< Analog protection Type 3
