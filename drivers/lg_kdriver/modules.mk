...
# [H13]
BASE_MODULE		+= $(call cond_assign, lg1154, PLATFORM_CHIP_VER, $(call cond_assign, YES, INCLUDE_KDRV_BE, be,),)
BASE_MODULE		+= $(call cond_assign, lg1154, PLATFORM_CHIP_VER, $(call cond_assign, YES, INCLUDE_KDRV_LGBUS, lgbus,),)
BASE_MODULE		+= $(call cond_assign, lg1154, PLATFORM_CHIP_VER, $(call cond_assign, YES, INCLUDE_KDRV_OVI, ovi,),)
...
EXTRA_CFLAGS	+= -include $(KDRV_TOP_DIR)/base/platform/$(KDRV_PLATFORM_CFG)/platform_config.h
EXTRA_CFLAGS	+= -include $(KDRV_TOP_DIR)/base/platform/$(KDRV_PLATFORM_CFG)/platform_mem_map.h
