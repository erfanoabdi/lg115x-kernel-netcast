...
/*----------------------------------------------------------------------------------------
	Macro Definitions
----------------------------------------------------------------------------------------*/
#define	MONITOR_PRINT(format, args...)		DBG_PRINT( g_monitor_debug_fd, 0, format, ##args)
#define MONITOR_WARN(fmt, args...) 			DBG_PRINT( g_monitor_debug_fd, 2, "^y^[MON-WAN] %s:%d -- " fmt, __F__, __L__, ##args)
#define MONITOR_ERROR(fmt, args...) 		DBG_PRINT( g_monitor_debug_fd, 3, "^y^[MON-ERR] %s:%d -- " fmt, __F__, __L__, ##args)
