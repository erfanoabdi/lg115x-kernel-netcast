...
#ifndef _PE_CTR_REG_L9B0_H_
#define _PE_CTR_REG_L9B0_H_
...
} PE_L9B0_DEA_MSRC_SYNC_MUX_CTRL_T;
...
} PE_L9B0_DEA_PIC_INIT_G0_TIMER_T;
...
} PE_L9B0_DEA_PIC_INIT_G1_TIMER_T;
...
} PE_L9B0_DEA_SRC_INTR_TIME_STP_T;
...
} PE_L9B0_DEA_ADDR_SW_CPU_SHADOW_T;
...
} PE_L9B0_DEA_PIC_START_DELAY_CTRL_T;
...
} PE_L9B0_DEA_PIC_START_G0_TIMER_T;
...
} PE_L9B0_DEA_PIC_START_G1_TIMER_T;
...
} PE_L9B0_DEB_DISP_SYNC_PARAMS_T;
...
} PE_L9B0_DEB_PIC_INIT_G0_TIMER_T;
...
} PE_L9B0_DEB_PIC_INIT_G1_TIMER_T;
...
} PE_L9B0_DEB_DISP_INTR_TIME_STP_T;
...
} PE_L9B0_DEB_ADDR_SW_CPU_SHADOW_T;
...
} PE_L9B0_DEB_DLY_DISP_SYNC_DLY_PARAM_T;
...
} PE_L9B0_DEB_DLY_DISP_SYNC_UPDATE_T;
...
typedef struct {
	UINT32 h_active                        : 1;   //     0
	UINT32 v_active                        : 1;   //     1
} PE_L9B0_DEB_DLY_DISP_SYNC_CTRL_T;
...
} PE_L9B0_DEB_DEF_DISP_SYNC_SEL_T;
...
} PE_L9B0_DEB_OV_PIC_START_DLY_EN_T;
...
} PE_L9B0_DEB_PIC_INIT_G1_TIMER_C_T;
...
} PE_L9B0_DEC_MSRC_SYNC_MUX_CTRL_T;
...
} PE_L9B0_DEC_MEM0_SYNC_PERIOD_T;
...
} PE_L9B0_DEC_MEM1_SYNC_PERIOD_T;
...
} PE_L9B0_DEC_SSRC_SYNC_MUX_CTRL_T;
...
typedef struct {
	UINT32 pic_init_g0_timer               : 28;  //  0:27
} PE_L9B0_DEC_PIC_INIT_G0_TIMER_T;
...
typedef struct {
	UINT32 pic_init_g1_timer               : 28;  //  0:27
} PE_L9B0_DEC_PIC_INIT_G1_TIMER_T;
...
} PE_L9B0_DEC_PIC_INIT_G2_TIMER_T;
...
} PE_L9B0_DEC_MSRC_INTR_TIME_STP_T;
...
} PE_L9B0_DEC_SSRC_INTR_TIME_STP_T;
...
} PE_L9B0_DEC_ADDR_SW_CPU_SHADOW_T;
...
} PE_L9B0_DEC_PIC_START_DELAY_CTRL_T;
...
typedef struct {
	UINT32 pic_start_g0_timer              : 28;  //  0:27
} PE_L9B0_DEC_PIC_START_G0_TIMER_T;
...
typedef struct {
	UINT32 pic_start_g1_timer              : 28;  //  0:27
} PE_L9B0_DEC_PIC_START_G1_TIMER_T;
...
} PE_L9B0_DEC_PIC_START_G2_TIMER_T;
...
} PE_L9B0_DED_PIC_INIT_G0_TIMER_T;
...
} PE_L9B0_DED_PIC_INIT_G1_TIMER_T;
...
} PE_L9B0_DED_ADDR_SW_CPU_SHADOW_T;
...
} PE_L9B0_DED_DLY_DISP_SYNC_PARAMS_T;
...
typedef struct {
	...
	UINT32 dly_force_update                : 1;   //    31
} PE_L9B0_DED_DLY_DISP_SYNC_FORCE_UPDATE_T;
...
typedef struct {
	UINT32 h_active                        : 1;   //     0
	UINT32 v_active                        : 1;   //     1
} PE_L9B0_DED_DLY_DISP_SYNC_CTRL_T;
...
} PE_L9B0_DED_DEF_DISP_SYNC_SEL_T;
...
typedef struct {
	...
	UINT32 pic_end_g1_c_force_en           : 1;   //    16
	UINT32 pic_end_g1_c_force_value        : 1;   //    17
} PE_L9B0_DED_OV_PIC_START_DLY_EN_T;
...
typedef struct {
	UINT32 pic_init_g1_timer_c             : 28;  //  0:27
} PE_L9B0_DED_PIC_INIT_G1_TIMER_C_T;
...
typedef struct {
	UINT32 vsync_bp                        : 16;  //  0:15
	UINT32 vsync_fp                        : 16;  // 16:31
} PE_L9B0_DED_DLY_DISP_V_PORCH_T;
...
typedef struct {
	UINT32 hsync_bp                        : 16;  //  0:15
	UINT32 hsync_fp                        : 16;  // 16:31
} PE_L9B0_DED_DLY_DISP_H_PORCH_T;
...
} PE_L9B0_DEC_DE_INTR_FLAG_MCU_T;
...
} PE_L9B0_DEC_DE_INTR_FLAG_CPU_T;
...
} PE_L9B0_DEE_CVD_ADDR_SW_DE_SAV_T;
...
} PE_L9B0_DEE_CVD_ADDR_SW_CPU_GPU_T;
...
} PE_L9B0_DEE_CVD_ADDR_SW_CPU_SHADOW_T;
...
} PE_L9B0_DEE_MCU_ADDR_SW_DE_SAV_T;
...
} PE_L9B0_DEE_MCU_ADDR_SW_CPU_GPU_T;
...
} PE_L9B0_DEE_MCU_ADDR_SW_CPU_SHADOW_T;
...
} PE_L9B0_DEF_PIC_INIT_G2_TIMER_T;
...
} PE_L9B0_DEF_PIC_INIT_G3_TIMER_T;
...
} PE_L9B0_DEF_CVE_INTR_TIME_STP_T;
...
} PE_L9B0_DEF_ADDR_SW_CPU_SHADOW_T;
...
} PE_L9B0_DEF_MG_LS_CTRL_T;

typedef struct {
	PE_L9B0_DEA_CHA_INFO_T                     dea_cha_info;                            // 0x0000
	PE_L9B0_DEA_CHB_INFO_T                     dea_chb_info;                            // 0x0004
	PE_L9B0_DEA_PIC_INIT_T                     dea_pic_init;                            // 0x0008
	PE_L9B0_DEA_PIC_START_T                    dea_pic_start;                           // 0x000c
	PE_L9B0_DEA_SMUX_CTRL_T                    dea_smux_ctrl;                           // 0x0010
	PE_L9B0_DEA_SMUX_SIZE_T                    dea_smux_size;                           // 0x0014
	PE_L9B0_DEA_MVI_V_INFO_T                   dea_mvi_v_info;                          // 0x0018
	PE_L9B0_DEA_MVI_H_INFO_T                   dea_mvi_h_info;                          // 0x001c
	PE_L9B0_DEA_MVI_CTRL_T                     dea_mvi_ctrl;                            // 0x0020
	PE_L9B0_DEA_MSRC_SYNC_MUX_CTRL_T           dea_msrc_sync_mux_ctrl;                  // 0x0024
	PE_L9B0_DEA_MSRC_SYNC_DLY_T                dea_msrc_sync_dly;                       // 0x0028
	PE_L9B0_DEA_MEM_SYNC_PERIOD_T              dea_mem_sync_period;                     // 0x002c
	PE_L9B0_DEA_DCO_MFC_T                      dea_dco_mfc;                             // 0x0030
	PE_L9B0_DEA_DCO_DFC_T                      dea_dco_dfc;                             // 0x0034
	PE_L9B0_DEA_DCO_DFLC_T                     dea_dco_dflc;                            // 0x0038
	PE_L9B0_DEA_DCO_FCW_T                      dea_dco_fcw;                             // 0x003c
	PE_L9B0_DEA_SMUX_RO_LCNT_T                 dea_smux_ro_lcnt;                        // 0x0040
	PE_L9B0_DEA_GMAU_CTRL_T                    dea_gmau_ctrl;                           // 0x0044
	PE_L9B0_DEA_PIC_END_EN_T                   dea_pic_end_en;                          // 0x0048
	PE_L9B0_DEA_PIC_INIT_G0_TIMER_T            dea_pic_init_g0_timer;                   // 0x004c
	PE_L9B0_DEA_PIC_INIT_G1_TIMER_T            dea_pic_init_g1_timer;                   // 0x0050
	PE_L9B0_DEA_PIC_END_INFO_T                 dea_pic_end_info;                        // 0x0054
	PE_L9B0_DEA_INTR_REG_T                     dea_intr_reg;                            // 0x0058
	PE_L9B0_DEA_INTR_MASK_T                    dea_intr_mask;                           // 0x005c
	PE_L9B0_DEA_INTR_MUX_T                     dea_intr_mux;                            // 0x0060
	PE_L9B0_DEA_SRC_INTR_TIME_STP_T            dea_src_intr_time_stp;                   // 0x0064
	PE_L9B0_DE_GPIO_MUX_T                      de_gpio_mux;                             // 0x0068
	PE_L9B0_DEA_ADDR_SW_DE_SAV_T               dea_addr_sw_de_sav;                      // 0x006c
	PE_L9B0_DEA_ADDR_SW_CPU_GPU_T              dea_addr_sw_cpu_gpu;                     // 0x0070
	PE_L9B0_DEA_ADDR_SW_CPU_SHADOW_T           dea_addr_sw_cpu_shadow;                  // 0x0074
	UINT32                                     reserved0;                               // 0x0078
	PE_L9B0_DE_VERSION_T                       de_version;                              // 0x007c
	PE_L9B0_DEA_SMUX_SIZE_I_T                  dea_smux_size_i;                         // 0x0080
	UINT32                                     reserved1[15];                           // 0x0084~0x00bc
	PE_L9B0_DEA_DEA_MVI_CTRL_0_T               dea_dea_mvi_ctrl_0;                      // 0x00c0
	PE_L9B0_DEA_DEA_MVI_CTRL_1_T               dea_dea_mvi_ctrl_1;                      // 0x00c4
	PE_L9B0_DEA_DEA_MVI_CTRL_2_T               dea_dea_mvi_ctrl_2;                      // 0x00c8
	PE_L9B0_DEA_DEA_MVI_CTRL_3_T               dea_dea_mvi_ctrl_3;                      // 0x00cc
	PE_L9B0_DEA_DEA_MVI_CTRL_4_T               dea_dea_mvi_ctrl_4;                      // 0x00d0
	PE_L9B0_DEA_DEA_MVI_CTRL_5_T               dea_dea_mvi_ctrl_5;                      // 0x00d4
	PE_L9B0_DEA_DEA_MVI_CTRL_6_T               dea_dea_mvi_ctrl_6;                      // 0x00d8
	UINT32                                     reserved2;                               // 0x00dc
	PE_L9B0_DEA_PIC_START_DELAY_CTRL_T         dea_pic_start_delay_ctrl;                // 0x00e0
	PE_L9B0_DEA_PIC_START_G0_TIMER_T           dea_pic_start_g0_timer;                  // 0x00e4
	PE_L9B0_DEA_PIC_START_G1_TIMER_T           dea_pic_start_g1_timer;                  // 0x00e8
	UINT32                                     reserved3[2];                            // 0x00ec~0x00f0
	PE_L9B0_DEA_PIC_END_FORCE_T                dea_pic_end_force;                       // 0x00f4
	PE_L9B0_DEA_GMAU_FLUSH_T                   dea_gmau_flush;                          // 0x00f8
	PE_L9B0_DEA_MG_LS_CTRL_T                   dea_mg_ls_ctrl;                          // 0x00fc
} PE_DEA_REG_L9B0_T;

typedef struct {
	PE_L9B0_DEB_PIC_INIT_T                     deb_pic_init;                            // 0x1000
	PE_L9B0_DEB_PIC_START_T                    deb_pic_start;                           // 0x1004
	PE_L9B0_DEB_DISP_V_PORCH_T                 deb_disp_v_porch;                        // 0x1008
	PE_L9B0_DEB_DISP_VS_VA_T                   deb_disp_vs_va;                          // 0x100c
	PE_L9B0_DEB_DISP_H_PORCH_T                 deb_disp_h_porch;                        // 0x1010
	PE_L9B0_DEB_DISP_HS_HA_T                   deb_disp_hs_ha;                          // 0x1014
	PE_L9B0_DEB_DISP_SYNC_DLY_T                deb_disp_sync_dly;                       // 0x1018
	PE_L9B0_DEB_DISP_PULSE_DLY_T               deb_disp_pulse_dly;                      // 0x101c
	PE_L9B0_DEB_DISP_SYNC_PARAMS_T             deb_disp_sync_params;                    // 0x1020
	UINT32                                     reserved4[2];                            // 0x1024~0x1028
	PE_L9B0_DEB_PWM0_CTRL0_T                   deb_pwm0_ctrl0;                          // 0x102c
	PE_L9B0_DEB_PWM0_CTRL1_T                   deb_pwm0_ctrl1;                          // 0x1030
	PE_L9B0_DEB_PWM1_CTRL0_T                   deb_pwm1_ctrl0;                          // 0x1034
	PE_L9B0_DEB_PWM1_CTRL1_T                   deb_pwm1_ctrl1;                          // 0x1038
	PE_L9B0_DEB_PWM2_CTRL0_T                   deb_pwm2_ctrl0;                          // 0x103c
	PE_L9B0_DEB_PWM2_CTRL1_T                   deb_pwm2_ctrl1;                          // 0x1040
	PE_L9B0_DEB_PWM3_CTRL_T                    deb_pwm3_ctrl;                           // 0x1044
	PE_L9B0_PWM3_0_LOW_T                       pwm3_0_low;                              // 0x1048
	PE_L9B0_PWM3_0_HIGH_T                      pwm3_0_high;                             // 0x104c
	PE_L9B0_PWM3_1_LOW_T                       pwm3_1_low;                              // 0x1050
	PE_L9B0_PWM3_1_HIGH_T                      pwm3_1_high;                             // 0x1054
	PE_L9B0_PWM3_2_LOW_T                       pwm3_2_low;                              // 0x1058
	PE_L9B0_PWM3_2_HIGH_T                      pwm3_2_high;                             // 0x105c
	PE_L9B0_PWM3_3_LOW_T                       pwm3_3_low;                              // 0x1060
	PE_L9B0_PWM3_3_HIGH_T                      pwm3_3_high;                             // 0x1064
	PE_L9B0_DEB_DPATH_CTRL_T                   deb_dpath_ctrl;                          // 0x1068
	PE_L9B0_DEB_GMAU_CTRL_T                    deb_gmau_ctrl;                           // 0x106c
	PE_L9B0_DEB_PIC_END_EN_T                   deb_pic_end_en;                          // 0x1070
	PE_L9B0_DEB_PIC_INIT_G0_TIMER_T            deb_pic_init_g0_timer;                   // 0x1074
	PE_L9B0_DEB_PIC_INIT_G1_TIMER_T            deb_pic_init_g1_timer;                   // 0x1078
	PE_L9B0_DEB_PIC_END_INFO_T                 deb_pic_end_info;                        // 0x107c
	PE_L9B0_DEB_INTR_REG_T                     deb_intr_reg;                            // 0x1080
	PE_L9B0_DEB_INTR_MASK_T                    deb_intr_mask;                           // 0x1084
	PE_L9B0_DEB_INTR_MUX_T                     deb_intr_mux;                            // 0x1088
	PE_L9B0_DEB_DISP_INTR_TIME_STP_T           deb_disp_intr_time_stp;                  // 0x108c
	PE_L9B0_DEB_ADDR_SW_DE_SAV_T               deb_addr_sw_de_sav;                      // 0x1090
	PE_L9B0_DEB_ADDR_SW_CPU_GPU_T              deb_addr_sw_cpu_gpu;                     // 0x1094
	PE_L9B0_DEB_ADDR_SW_CPU_SHADOW_T           deb_addr_sw_cpu_shadow;                  // 0x1098
	UINT32                                     reserved5;                               // 0x109c
	PE_L9B0_PWM0_V_T                           pwm0_v;                                  // 0x10a0
	PE_L9B0_PWM1_V_T                           pwm1_v;                                  // 0x10a4
	PE_L9B0_PWM2_V_T                           pwm2_v;                                  // 0x10a8
	UINT32                                     reserved6;                               // 0x10ac
	PE_L9B0_PWM0_V_SUB_T                       pwm0_v_sub;                              // 0x10b0
	PE_L9B0_PWM1_V_SUB_T                       pwm1_v_sub;                              // 0x10b4
	PE_L9B0_PWM2_V_SUB_T                       pwm2_v_sub;                              // 0x10b8
	UINT32                                     reserved7;                               // 0x10bc
	PE_L9B0_DEB_DLY_DISP_SYNC_DLY_PARAM_T      deb_dly_disp_sync_dly_param;             // 0x10c0
	PE_L9B0_DEB_DLY_DISP_SYNC_UPDATE_T         deb_dly_disp_sync_update;                // 0x10c4
	PE_L9B0_DEB_DLY_DISP_SYNC_CTRL_T           deb_dly_disp_sync_ctrl;                  // 0x10c8
	PE_L9B0_DEB_DEF_DISP_SYNC_SEL_T            deb_def_disp_sync_sel;                   // 0x10cc
	PE_L9B0_DEB_OV_PIC_START_DLY_EN_T          deb_ov_pic_start_dly_en;                 // 0x10d0
	PE_L9B0_DEB_PIC_INIT_G1_TIMER_C_T          deb_pic_init_g1_timer_c;                 // 0x10d4
	UINT32                                     reserved8[8];                            // 0x10d8~0x10f4
	PE_L9B0_DEB_GMAU_FLUSH_T                   deb_gmau_flush;                          // 0x10f8
	PE_L9B0_DEB_MG_LS_CTRL_T                   deb_mg_ls_ctrl;                          // 0x10fc
} PE_DEB_REG_L9B0_T;

typedef struct {
	PE_L9B0_DEC_PIC_INIT_T                     dec_pic_init;                            // 0x2000
	PE_L9B0_DEC_PIC_START_T                    dec_pic_start;                           // 0x2004
	PE_L9B0_DEC_SMUX_CTRL_T                    dec_smux_ctrl;                           // 0x2008
	PE_L9B0_DEC_SMUX_SIZE_T                    dec_smux_size;                           // 0x200c
	PE_L9B0_DEC_MVI_V_INFO_T                   dec_mvi_v_info;                          // 0x2010
	PE_L9B0_DEC_MVI_H_INFO_T                   dec_mvi_h_info;                          // 0x2014
	PE_L9B0_DEC_MVI_CTRL_T                     dec_mvi_ctrl;                            // 0x2018
	PE_L9B0_DEC_MSRC_SYNC_MUX_CTRL_T           dec_msrc_sync_mux_ctrl;                  // 0x201c
	PE_L9B0_DEC_MSRC_SYNC_DLY_T                dec_msrc_sync_dly;                       // 0x2020
	PE_L9B0_DEC_MEM0_SYNC_PERIOD_T             dec_mem0_sync_period;                    // 0x2024
	PE_L9B0_DEC_MEM1_SYNC_PERIOD_T             dec_mem1_sync_period;                    // 0x2028
	PE_L9B0_DEC_SSMUX_CTRL_T                   dec_ssmux_ctrl;                          // 0x202c
	PE_L9B0_DEC_SSRC_SYNC_MUX_CTRL_T           dec_ssrc_sync_mux_ctrl;                  // 0x2030
	PE_L9B0_DEC_SSRC_SYNC_DLY_T                dec_ssrc_sync_dly;                       // 0x2034
	PE_L9B0_DEC_MD_CSC_CTRL_T                  dec_md_csc_ctrl;                         // 0x2038
	PE_L9B0_DEC_MD_CSC_COEF0_T                 dec_md_csc_coef0;                        // 0x203c
	PE_L9B0_DEC_MD_CSC_COEF1_T                 dec_md_csc_coef1;                        // 0x2040
	PE_L9B0_DEC_MD_CSC_COEF2_T                 dec_md_csc_coef2;                        // 0x2044
	PE_L9B0_DEC_MD_CSC_COEF3_T                 dec_md_csc_coef3;                        // 0x2048
	PE_L9B0_DEC_MD_CSC_COEF4_T                 dec_md_csc_coef4;                        // 0x204c
	PE_L9B0_DEC_MD_CSC_OFFSET0_T               dec_md_csc_offset0;                      // 0x2050
	PE_L9B0_DEC_MD_CSC_OFFSET1_T               dec_md_csc_offset1;                      // 0x2054
	PE_L9B0_DEC_MD_CSC_OFFSET2_T               dec_md_csc_offset2;                      // 0x2058
	PE_L9B0_DEC_SMUX_RO_LCNT_T                 dec_smux_ro_lcnt;                        // 0x205c
	PE_L9B0_DEC_GMAU_CTRL_T                    dec_gmau_ctrl;                           // 0x2060
	PE_L9B0_DEC_PIC_END_EN_T                   dec_pic_end_en;                          // 0x2064
	PE_L9B0_DEC_PIC_INIT_G0_TIMER_T            dec_pic_init_g0_timer;                   // 0x2068
	PE_L9B0_DEC_PIC_INIT_G1_TIMER_T            dec_pic_init_g1_timer;                   // 0x206c
	PE_L9B0_DEC_PIC_INIT_G2_TIMER_T            dec_pic_init_g2_timer;                   // 0x2070
	PE_L9B0_DEC_PIC_END_INFO_T                 dec_pic_end_info;                        // 0x2074
	PE_L9B0_DEC_INTR_REG_T                     dec_intr_reg;                            // 0x2078
	PE_L9B0_DEC_INTR_MASK_T                    dec_intr_mask;                           // 0x207c
	PE_L9B0_DEC_INTR_MUX_T                     dec_intr_mux;                            // 0x2080
	PE_L9B0_DEC_MSRC_INTR_TIME_STP_T           dec_msrc_intr_time_stp;                  // 0x2084
	PE_L9B0_DEC_SSRC_INTR_TIME_STP_T           dec_ssrc_intr_time_stp;                  // 0x2088
	PE_L9B0_DEC_ADDR_SW_DE_SAV_T               dec_addr_sw_de_sav;                      // 0x208c
	PE_L9B0_DEC_ADDR_SW_CPU_GPU_T              dec_addr_sw_cpu_gpu;                     // 0x2090
	PE_L9B0_DEC_ADDR_SW_CPU_SHADOW_T           dec_addr_sw_cpu_shadow;                  // 0x2094
	PE_L9B0_DEC_GMAU_FLUSH_T                   dec_gmau_flush;                          // 0x2098
	UINT32                                     reserved9;                               // 0x209c
	PE_L9B0_DEC_SMUX_SIZE_I_T                  dec_smux_size_i;                         // 0x20a0
	UINT32                                     reserved10[7];                           // 0x20a4~0x20bc
	PE_L9B0_DEC_DEA_MVI_CTRL_0_T               dec_dea_mvi_ctrl_0;                      // 0x20c0
	PE_L9B0_DEC_DEA_MVI_CTRL_1_T               dec_dea_mvi_ctrl_1;                      // 0x20c4
	PE_L9B0_DEC_DEA_MVI_CTRL_2_T               dec_dea_mvi_ctrl_2;                      // 0x20c8
	PE_L9B0_DEC_DEA_MVI_CTRL_3_T               dec_dea_mvi_ctrl_3;                      // 0x20cc
	PE_L9B0_DEC_DEA_MVI_CTRL_4_T               dec_dea_mvi_ctrl_4;                      // 0x20d0
	PE_L9B0_DEC_DEA_MVI_CTRL_5_T               dec_dea_mvi_ctrl_5;                      // 0x20d4
	PE_L9B0_DEC_DEA_MVI_CTRL_6_T               dec_dea_mvi_ctrl_6;                      // 0x20d8
	UINT32                                     reserved11;                              // 0x20dc
	PE_L9B0_DEC_PIC_START_DELAY_CTRL_T         dec_pic_start_delay_ctrl;                // 0x20e0
	PE_L9B0_DEC_PIC_START_G0_TIMER_T           dec_pic_start_g0_timer;                  // 0x20e4
	PE_L9B0_DEC_PIC_START_G1_TIMER_T           dec_pic_start_g1_timer;                  // 0x20e8
	PE_L9B0_DEC_PIC_START_G2_TIMER_T           dec_pic_start_g2_timer;                  // 0x20ec
	UINT32                                     reserved12;                              // 0x20f0
	PE_L9B0_DEC_PIC_END_FORCE_T                dec_pic_end_force;                       // 0x20f4
	UINT32                                     reserved13;                              // 0x20f8
	PE_L9B0_DEC_MG_LS_CTRL_T                   dec_mg_ls_ctrl;                          // 0x20fc
} PE_DEC_REG_L9B0_T;

typedef struct {
	PE_L9B0_DED_PIC_INIT_T                     ded_pic_init;                            // 0x3000
	PE_L9B0_DED_PIC_START_T                    ded_pic_start;                           // 0x3004
	UINT32                                     reserved14[7];                           // 0x3008~0x3020
	PE_L9B0_DED_GMAU_CTRL_T                    ded_gmau_ctrl;                           // 0x3024
	PE_L9B0_DED_PIC_END_EN_T                   ded_pic_end_en;                          // 0x3028
	PE_L9B0_DED_PIC_INIT_G0_TIMER_T            ded_pic_init_g0_timer;                   // 0x302c
	PE_L9B0_DED_PIC_INIT_G1_TIMER_T            ded_pic_init_g1_timer;                   // 0x3030
	UINT32                                     reserved15[2];                           // 0x3034~0x3038
	PE_L9B0_DED_PIC_END_INFO_T                 ded_pic_end_info;                        // 0x303c
	PE_L9B0_DED_INTR_REG_T                     ded_intr_reg;                            // 0x3040
	PE_L9B0_DED_INTR_MASK_T                    ded_intr_mask;                           // 0x3044
	PE_L9B0_DED_INTR_MUX_T                     ded_intr_mux;                            // 0x3048
	UINT32                                     reserved16;                              // 0x304c
	PE_L9B0_DED_ADDR_SW_DE_SAV_T               ded_addr_sw_de_sav;                      // 0x3050
	PE_L9B0_DED_ADDR_SW_CPU_GPU_T              ded_addr_sw_cpu_gpu;                     // 0x3054
	PE_L9B0_DED_ADDR_SW_CPU_SHADOW_T           ded_addr_sw_cpu_shadow;                  // 0x3058
	UINT32                                     reserved17[25];                          // 0x305c~0x30bc
	PE_L9B0_DED_DLY_DISP_SYNC_PARAMS_T         ded_dly_disp_sync_params;                // 0x30c0
	PE_L9B0_DED_DLY_DISP_SYNC_FORCE_UPDATE_T   ded_dly_disp_sync_force_update;          // 0x30c4
	PE_L9B0_DED_DLY_DISP_SYNC_CTRL_T           ded_dly_disp_sync_ctrl;                  // 0x30c8
	PE_L9B0_DED_DEF_DISP_SYNC_SEL_T            ded_def_disp_sync_sel;                   // 0x30cc
	PE_L9B0_DED_OV_PIC_START_DLY_EN_T          ded_ov_pic_start_dly_en;                 // 0x30d0
	PE_L9B0_DED_PIC_INIT_G1_TIMER_C_T          ded_pic_init_g1_timer_c;                 // 0x30d4
	UINT32                                     reserved18[2];                           // 0x30d8~0x30dc
	PE_L9B0_DED_DLY_DISP_V_PORCH_T             ded_dly_disp_v_porch;                    // 0x30e0
	PE_L9B0_DED_DLY_DISP_VS_VA_T               ded_dly_disp_vs_va;                      // 0x30e4
	PE_L9B0_DED_DLY_DISP_H_PORCH_T             ded_dly_disp_h_porch;                    // 0x30e8
	PE_L9B0_DED_DLY_DISP_HS_HA_T               ded_dly_disp_hs_ha;                      // 0x30ec
	UINT32                                     reserved19[2];                           // 0x30f0~0x30f4
	PE_L9B0_DED_GMAU_FLUSH_T                   ded_gmau_flush;                          // 0x30f8
	PE_L9B0_DED_MG_LS_CTRL_T                   ded_mg_ls_ctrl;                          // 0x30fc
} PE_DED_REG_L9B0_T;

typedef struct {
	PE_L9B0_DEC_DE_INTR_FLAG_MCU_T             dec_de_intr_flag_mcu;                    // 0x4000
	PE_L9B0_DEC_DE_INTR_FLAG_CPU_T             dec_de_intr_flag_cpu;                    // 0x4004
	PE_L9B0_DEE_CVI_MUX_SEL_T                  dee_cvi_mux_sel;                         // 0x4008
	PE_L9B0_DEE_PE0_HIF_OFFSET_T               dee_pe0_hif_offset;                      // 0x400c
	PE_L9B0_DEE_SM_HIF_OFFSET_T                dee_sm_hif_offset;                       // 0x4010
	PE_L9B0_DEE_PE1_HIF_OFFSET_T               dee_pe1_hif_offset;                      // 0x4014
	PE_L9B0_DEE_CVD_ADDR_SW_DE_SAV_T           dee_cvd_addr_sw_de_sav;                  // 0x4018
	PE_L9B0_DEE_CVD_ADDR_SW_CPU_GPU_T          dee_cvd_addr_sw_cpu_gpu;                 // 0x401c
	PE_L9B0_DEE_CVD_ADDR_SW_CPU_SHADOW_T       dee_cvd_addr_sw_cpu_shadow;              // 0x4020
	PE_L9B0_DEE_MCU_ADDR_SW_DE_SAV_T           dee_mcu_addr_sw_de_sav;                  // 0x4024
	PE_L9B0_DEE_MCU_ADDR_SW_CPU_GPU_T          dee_mcu_addr_sw_cpu_gpu;                 // 0x4028
	PE_L9B0_DEE_MCU_ADDR_SW_CPU_SHADOW_T       dee_mcu_addr_sw_cpu_shadow;              // 0x402c
	PE_L9B0_DEE_MCU_ADDR_WINDOW_T              dee_mcu_addr_window;                     // 0x4030
	PE_L9B0_DEE_INTR_REG_T                     dee_intr_reg;                            // 0x4034
	PE_L9B0_DEE_INTR_MASK_T                    dee_intr_mask;                           // 0x4038
	PE_L9B0_DEE_GMAU_FLUSH_T                   dee_gmau_flush;                          // 0x403c
	UINT32                                     reserved20[47];                          // 0x4040~0x40f8
	PE_L9B0_DEE_MG_LS_CTRL_T                   dee_mg_ls_ctrl;                          // 0x40fc
} PE_DEE_REG_L9B0_T;

typedef struct {
	PE_L9B0_DEF_PIC_INIT_T                     def_pic_init;                            // 0x5000
	PE_L9B0_DEF_PIC_START_T                    def_pic_start;                           // 0x5004
	PE_L9B0_DEF_DE_VENC_IF_T                   def_de_venc_if;                          // 0x5008
	PE_L9B0_DEF_DPATH_CTRL_T                   def_dpath_ctrl;                          // 0x500c
	PE_L9B0_DEF_CVE_PARAM0_T                   def_cve_param0;                          // 0x5010
	PE_L9B0_DEF_CVE_PARAM1_T                   def_cve_param1;                          // 0x5014
	PE_L9B0_DEF_CVE_PARAM2_T                   def_cve_param2;                          // 0x5018
	PE_L9B0_DEF_CVE_PARAM3_T                   def_cve_param3;                          // 0x501c
	PE_L9B0_DEF_CVE_PULSE_DLY_T                def_cve_pulse_dly;                       // 0x5020
	PE_L9B0_DEF_GMAU_CTRL_T                    def_gmau_ctrl;                           // 0x5024
	PE_L9B0_DEF_PIC_END_EN_T                   def_pic_end_en;                          // 0x5028
	UINT32                                     reserved21[2];                           // 0x502c~0x5030
	PE_L9B0_DEF_PIC_INIT_G2_TIMER_T            def_pic_init_g2_timer;                   // 0x5034
	PE_L9B0_DEF_PIC_INIT_G3_TIMER_T            def_pic_init_g3_timer;                   // 0x5038
	PE_L9B0_DEF_PIC_END_INFO_T                 def_pic_end_info;                        // 0x503c
	PE_L9B0_DEF_INTR_REG_T                     def_intr_reg;                            // 0x5040
	PE_L9B0_DEF_INTR_MASK_T                    def_intr_mask;                           // 0x5044
	PE_L9B0_DEF_INTR_MUX_T                     def_intr_mux;                            // 0x5048
	PE_L9B0_DEF_CVE_INTR_TIME_STP_T            def_cve_intr_time_stp;                   // 0x504c
	PE_L9B0_DEF_ADDR_SW_DE_SAV_T               def_addr_sw_de_sav;                      // 0x5050
	PE_L9B0_DEF_ADDR_SW_CPU_GPU_T              def_addr_sw_cpu_gpu;                     // 0x5054
	PE_L9B0_DEF_ADDR_SW_CPU_SHADOW_T           def_addr_sw_cpu_shadow;                  // 0x5058
	UINT32                                     reserved22[39];                          // 0x505c~0x50f4
	PE_L9B0_DEF_GMAU_FLUSH_T                   def_gmau_flush;                          // 0x50f8
	PE_L9B0_DEF_MG_LS_CTRL_T                   def_mg_ls_ctrl;                          // 0x50fc
} PE_DEF_REG_L9B0_T;
