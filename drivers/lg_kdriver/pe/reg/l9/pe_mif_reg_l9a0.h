...
#ifndef _PE_MIF_REG_L9A0_H_
#define _PE_MIF_REG_L9A0_H_
...
} PE_L9A0_MIFA_RD_CMD_STRIDE_SET_T;
...
} PE_L9A0_MIFA_WD_BANK_8_ADDR0_T;

typedef struct { // 0x08e4
	UINT32 mifa_wd_bank_8_addr1_f      : 32;   // 31: 0
} PE_L9A0_MIFA_WD_BANK_8_ADDR1_T;
...
} PE_L9A0_MIFA_WD_BANK_2_ADDR0_T;

typedef struct { // 0x08ec
	UINT32 mifa_wd_bank_2_addr1_f      : 32;   // 31: 0
} PE_L9A0_MIFA_WD_BANK_2_ADDR1_T;
...
} PE_L9A0_MIFB_RD_CMD_STRIDE_SET_T;
...
} PE_L9A0_MIFB_STATUS_T;

typedef struct { // 0x1b60
	UINT32 load                        : 1;   //     0
	UINT32                             : 10;  // 10: 1
	UINT32 register_update_address0_m  : 21;  // 31:11
} PE_L9A0_MIFB_SADDR_PARAM_UPDATE0_M_T;
...
typedef struct { // 0x2820
	...
	UINT32 req_rd_stv_v_ipc1_y         : 4;   // 27:24
	UINT32 req_rd_stv_v_tnr0_y         : 4;   // 31:28
} PE_L9A0_MIFC_RD_REQ_STV0_T;

typedef struct { // 0x2824
	UINT32 req_rd_pri_v_tnr_c          : 4;   //  3: 0
	UINT32 req_rd_pri_v_ss_y           : 4;   //  7: 4
	UINT32 req_rd_pri_v_ss_c           : 4;   // 11: 8
} PE_L9A0_MIFC_RD_REQ_STV1_T;
...
} PE_L9A0_MIFC_RD_CMD_STRIDE_SET_T;
...
} PE_L9A0_MIFC_STATUS_T;

typedef struct { // 0x2898
	UINT32 load                        : 1;   //     0
	UINT32                             : 10;  // 10: 1
	UINT32 register_update_address0_m  : 21;  // 31:11
} PE_L9A0_MIFC_SADDR_PARAM_UPDATE0_M_T;
...
typedef struct { // 0x289c
	...
	UINT32                             : 1;   //    27
	UINT32 req_rd_bank_addr_8_tnr0_y   : 3;   // 30:28
} PE_L9A0_MIFC_RD_BANK_8_ADDR0_T;
...
} PE_L9A0_MIFD_RD_CMD_PRI0_T;

typedef struct { // 0x3e0c
	UINT32 cmd_wd_pri_v_sm_y           : 4;   //  3: 0
	UINT32 cmd_wd_pri_v_sm_c           : 4;   //  7: 4
} PE_L9A0_MIFD_WD_CMD_PRI0_T;
...
} PE_L9A0_MIFD_RD_REQ_STV0_T;

typedef struct { // 0x3e1c
	UINT32 req_wd_stv_v_sm_y           : 4;   //  3: 0
	UINT32 req_wd_stv_v_sm_c           : 4;   //  7: 4
} PE_L9A0_MIFD_WD_REQ_STV0_T;
...
} PE_L9A0_MIFD_RD_CMD_PEND0_T;

typedef struct { // 0x3e24
	UINT32 cmd_wd_pend_v_sm_y          : 4;   //  3: 0
	UINT32 cmd_wd_pend_v_sm_c          : 4;   //  7: 4
} PE_L9A0_MIFD_WD_CMD_PEND1_T;
...
} PE_L9A0_MIFD_STATUS_T;

typedef struct { // 0x3e58
	UINT32 load                        : 1;   //     0
	UINT32                             : 10;  // 10: 1
	UINT32 register_update_address0_m  : 21;  // 31:11
} PE_L9A0_MIFD_SADDR_PARAM_UPDATE0_M_T;
...
} PE_L9A0_MIFD_RD_CMD_PRI0_S_T;

typedef struct { // 0x3e88
	UINT32 cmd_wd_pri_s_v_sm_y         : 4;   //  3: 0
	UINT32 cmd_wd_pri_s_v_sm_c         : 4;   //  7: 4
} PE_L9A0_MIFD_WD_CMD_PRI0_S_T;
...
typedef struct { // 0x3e8c
	...
	UINT32                             : 10;  // 19:10
	UINT32 reset_time_out_cnt          : 12;  // 31:20
} PE_L9A0_MIFD_RESET_T;

typedef struct {
	PE_L9A0_MIFA_RD_CTRL_T                 mifa_rd_ctrl;                        // 0x0800
	PE_L9A0_MIFA_WD_CTRL_T                 mifa_wd_ctrl;                        // 0x0804
	PE_L9A0_MIF_RD_SET_10B_T               mif_rd_set_10b;                      // 0x0808
	PE_L9A0_MIF_WD_SET_10B_T               mif_wd_set_10b;                      // 0x080c
	PE_L9A0_MIFA_RD_CMD_PRI0_T             mifa_rd_cmd_pri0;                    // 0x0810
	PE_L9A0_MIFA_RD_CMD_PRI1_T             mifa_rd_cmd_pri1;                    // 0x0814
	PE_L9A0_MIFA_WD_CMD_PRI0_T             mifa_wd_cmd_pri0;                    // 0x0818
	PE_L9A0_MIFA_RD_REQ_PRI0_T             mifa_rd_req_pri0;                    // 0x081c
	PE_L9A0_MIFA_RD_REQ_PRI1_T             mifa_rd_req_pri1;                    // 0x0820
	PE_L9A0_MIFA_WD_REQ_PRI0_T             mifa_wd_req_pri0;                    // 0x0824
	PE_L9A0_MIFA_RD_REQ_STV0_T             mifa_rd_req_stv0;                    // 0x0828
	PE_L9A0_MIFA_RD_REQ_STV1_T             mifa_rd_req_stv1;                    // 0x082c
	PE_L9A0_MIFA_WD_REQ_STV0_T             mifa_wd_req_stv0;                    // 0x0830
	PE_L9A0_MIFA_RD_CMD_PEND0_T            mifa_rd_cmd_pend0;                   // 0x0834
	PE_L9A0_MIFA_RD_CMD_PEND1_T            mifa_rd_cmd_pend1;                   // 0x0838
	PE_L9A0_MIFA_WD_CMD_PEND0_T            mifa_wd_cmd_pend0;                   // 0x083c
	PE_L9A0_MIFA_RD_CMD_STRIDE0_T          mifa_rd_cmd_stride0;                 // 0x0840
	PE_L9A0_MIFA_RD_CMD_STRIDE1_T          mifa_rd_cmd_stride1;                 // 0x0844
	PE_L9A0_MIFA_RD_CMD_STRIDE2_T          mifa_rd_cmd_stride2;                 // 0x0848
	PE_L9A0_MIFA_RD_CMD_STRIDE_SET_T       mifa_rd_cmd_stride_set;              // 0x084c
	PE_L9A0_MIFA_WD_CMD_STRIDE0_T          mifa_wd_cmd_stride0;                 // 0x0850
	PE_L9A0_MIFA_WD_CMD_STRIDE_SET_T       mifa_wd_cmd_stride_set;              // 0x0854
	PE_L9A0_MIFA_SADDR_RD_MVI_Y_MVI_C_T    mifa_saddr_rd_mvi_y_mvi_c;           // 0x0858
	PE_L9A0_MIFA_SADDR_RD_PREW_Y_T         mifa_saddr_rd_prew_y;                // 0x085c
	PE_L9A0_MIFA_SADDR_RD_PREW_C_T         mifa_saddr_rd_prew_c;                // 0x0860
	PE_L9A0_MIFA_SADDR_RD_IPC0_Y_T         mifa_saddr_rd_ipc0_y;                // 0x0864
	PE_L9A0_MIFA_SADDR_RD_IPC_C_T          mifa_saddr_rd_ipc_c;                 // 0x0868
	PE_L9A0_MIFA_SADDR_RD_IPC1_Y_T         mifa_saddr_rd_ipc1_y;                // 0x086c
	PE_L9A0_MIFA_SADDR_RD_TNR0_Y_T         mifa_saddr_rd_tnr0_y;                // 0x0870
	PE_L9A0_MIFA_SADDR_RD_TNR_C_T          mifa_saddr_rd_tnr_c;                 // 0x0874
	PE_L9A0_MIFA_SADDR_RD_TNR1_Y_T         mifa_saddr_rd_tnr1_y;                // 0x0878
	PE_L9A0_MIFA_SADDR_WD_TNR_Y_T          mifa_saddr_wd_tnr_y;                 // 0x087c
	PE_L9A0_MIFA_SADDR_WD_TNR_C_T          mifa_saddr_wd_tnr_c;                 // 0x0880
	PE_L9A0_MIFA_SADDR_WD_PREW_Y_T         mifa_saddr_wd_prew_y;                // 0x0884
	PE_L9A0_MIFA_SADDR_WD_PREW_C_T         mifa_saddr_wd_prew_c;                // 0x0888
	PE_L9A0_MIFA_SADDR_RD_DL_Y_T           mifa_saddr_rd_dl_y;                  // 0x088c
	PE_L9A0_MIFA_SADDR_RD_DL_C_T           mifa_saddr_rd_dl_c;                  // 0x0890
	PE_L9A0_MIFA_SADDR_RD_DR_Y_T           mifa_saddr_rd_dr_y;                  // 0x0894
	PE_L9A0_MIFA_SADDR_RD_DR_C_T           mifa_saddr_rd_dr_c;                  // 0x0898
	PE_L9A0_MIFA_SADDR_WD_DL_Y_T           mifa_saddr_wd_dl_y;                  // 0x089c
	PE_L9A0_MIFA_SADDR_WD_DL_C_T           mifa_saddr_wd_dl_c;                  // 0x08a0
	PE_L9A0_MIFA_SADDR_WD_DR_Y_T           mifa_saddr_wd_dr_y;                  // 0x08a4
	PE_L9A0_MIFA_SADDR_WD_DR_C_T           mifa_saddr_wd_dr_c;                  // 0x08a8
	PE_L9A0_MIFA_SADDR_RD_EXT0_T           mifa_saddr_rd_ext0;                  // 0x08ac
	PE_L9A0_MIFA_SADDR_RD_EXT1_T           mifa_saddr_rd_ext1;                  // 0x08b0
	PE_L9A0_MIFA_SADDR_RD_EXT2_T           mifa_saddr_rd_ext2;                  // 0x08b4
	PE_L9A0_MIFA_SADDR_WD_EXT0_T           mifa_saddr_wd_ext0;                  // 0x08b8
	PE_L9A0_MIFA_RD_DR_DL_EXT_T            mifa_rd_dr_dl_ext;                   // 0x08bc
	PE_L9A0_MIFA_WD_DR_DL_EXT_T            mifa_wd_dr_dl_ext;                   // 0x08c0
	PE_L9A0_MIFA_STATUS_T                  mifa_status;                         // 0x08c4
	PE_L9A0_MIFA_SADDR_PARAM_UPDATE0_M_T   mifa_saddr_param_update0_m;          // 0x08c8
	PE_L9A0_MIFA_SADDR_PARAM_UPDATE0_M1_T  mifa_saddr_param_update0_m1;         // 0x08cc
	PE_L9A0_MIFA_RD_BANK_8_ADDR0_T         mifa_rd_bank_8_addr0;                // 0x08d0
	PE_L9A0_MIFA_RD_BANK_8_ADDR1_T         mifa_rd_bank_8_addr1;                // 0x08d4
	PE_L9A0_MIFA_RD_BANK_2_ADDR0_T         mifa_rd_bank_2_addr0;                // 0x08d8
	PE_L9A0_MIFA_RD_BANK_2_ADDR1_T         mifa_rd_bank_2_addr1;                // 0x08dc
	PE_L9A0_MIFA_WD_BANK_8_ADDR0_T         mifa_wd_bank_8_addr0;                // 0x08e0
	PE_L9A0_MIFA_WD_BANK_8_ADDR1_T         mifa_wd_bank_8_addr1;                // 0x08e4
	PE_L9A0_MIFA_WD_BANK_2_ADDR0_T         mifa_wd_bank_2_addr0;                // 0x08e8
	PE_L9A0_MIFA_WD_BANK_2_ADDR1_T         mifa_wd_bank_2_addr1;                // 0x08ec
	PE_L9A0_MIFA_LSB_SWITCH_T              mifa_lsb_switch;                     // 0x08f0
	PE_L9A0_MIFA_RD_REQ_PEND0_T            mifa_rd_req_pend0;                   // 0x08f4
	PE_L9A0_MIFA_RD_REQ_PEND1_T            mifa_rd_req_pend1;                   // 0x08f8
	PE_L9A0_MIFA_RD_REQ_PEND2_T            mifa_rd_req_pend2;                   // 0x08fc
	PE_L9A0_MIFA_WD_REQ_PEND0_T            mifa_wd_req_pend0;                   // 0x0900
	PE_L9A0_MIFA_RD_CMD_PRI0_S_T           mifa_rd_cmd_pri0_s;                  // 0x0904
	PE_L9A0_MIFA_RD_CMD_PRI1_S_T           mifa_rd_cmd_pri1_s;                  // 0x0908
	PE_L9A0_MIFA_WD_CMD_PRI0_S_T           mifa_wd_cmd_pri0_s;                  // 0x090c
	PE_L9A0_MIFA_RESET_T                   mifa_reset;                          // 0x0910
} PE_MIA_REG_L9A0_T;

typedef struct {
	PE_L9A0_MIFB_RD_CTRL_T                 mifb_rd_ctrl;                        // 0x1b00
	PE_L9A0_MIFB_WD_CTRL_T                 mifb_wd_ctrl;                        // 0x1b04
	PE_L9A0_MIFB_RD_SET_10B_T              mifb_rd_set_10b;                     // 0x1b08
	PE_L9A0_MIFB_WD_SET_10B_T              mifb_wd_set_10b;                     // 0x1b0c
	PE_L9A0_MIFB_RD_CMD_PRI0_T             mifb_rd_cmd_pri0;                    // 0x1b10
	PE_L9A0_MIFB_WD_CMD_PRI0_T             mifb_wd_cmd_pri0;                    // 0x1b14
	PE_L9A0_MIFB_RD_REQ_PRI0_T             mifb_rd_req_pri0;                    // 0x1b18
	PE_L9A0_MIFB_WD_REQ_PRI0_T             mifb_wd_req_pri0;                    // 0x1b1c
	PE_L9A0_MIFB_RD_REQ_STV0_T             mifb_rd_req_stv0;                    // 0x1b20
	PE_L9A0_MIFB_WD_REQ_STV0_T             mifb_wd_req_stv0;                    // 0x1b24
	PE_L9A0_MIFB_RD_CMD_PEND0_T            mifb_rd_cmd_pend0;                   // 0x1b28
	PE_L9A0_MIFB_WD_CMD_PEND0_T            mifb_wd_cmd_pend0;                   // 0x1b2c
	PE_L9A0_MIFB_RD_CMD_STRIDE0_T          mifb_rd_cmd_stride0;                 // 0x1b30
	PE_L9A0_MIFB_RD_CMD_STRIDE_SET_T       mifb_rd_cmd_stride_set;              // 0x1b34
	PE_L9A0_MIFB_WD_CMD_STRIDE0_T          mifb_wd_cmd_stride0;                 // 0x1b38
	PE_L9A0_MIFB_WD_CMD_STRIDE_SET_T       mifb_wd_cmd_stride_set;              // 0x1b3c
	PE_L9A0_MIFB_SADDR_RD_OVM_Y_T          mifb_saddr_rd_ovm_y;                 // 0x1b40
	PE_L9A0_MIFB_SADDR_RD_OVM_C_T          mifb_saddr_rd_ovm_c;                 // 0x1b44
	PE_L9A0_MIFB_SADDR_RD_OVS_Y_OVS_C_T    mifb_saddr_rd_ovs_y_ovs_c;           // 0x1b48
	PE_L9A0_MIFB_SADDR_WD_SM_Y_T           mifb_saddr_wd_sm_y;                  // 0x1b4c
	PE_L9A0_MIFB_SADDR_WD_SM_C_T           mifb_saddr_wd_sm_c;                  // 0x1b50
	PE_L9A0_MIFB_SADDR_RD_EXT0_T           mifb_saddr_rd_ext0;                  // 0x1b54
	PE_L9A0_MIFB_SADDR_WD_EXT0_T           mifb_saddr_wd_ext0;                  // 0x1b58
	PE_L9A0_MIFB_STATUS_T                  mifb_status;                         // 0x1b5c
	PE_L9A0_MIFB_SADDR_PARAM_UPDATE0_M_T   mifb_saddr_param_update0_m;          // 0x1b60
	PE_L9A0_MIFB_RD_BANK_8_ADDR0_T         mifb_rd_bank_8_addr0;                // 0x1b64
	PE_L9A0_MIFB_RD_BANK_8_ADDR1_T         mifb_rd_bank_8_addr1;                // 0x1b68
	PE_L9A0_MIFB_RD_BANK_2_ADDR0_T         mifb_rd_bank_2_addr0;                // 0x1b6c
	PE_L9A0_MIFB_RD_BANK_2_ADDR1_T         mifb_rd_bank_2_addr1;                // 0x1b70
	PE_L9A0_MIFB_WD_BANK_8_ADDR0_T         mifb_wd_bank_8_addr0;                // 0x1b74
	PE_L9A0_MIFB_WD_BANK_8_ADDR1_T         mifb_wd_bank_8_addr1;                // 0x1b78
	PE_L9A0_MIFB_WD_BANK_2_ADDR0_T         mifb_wd_bank_2_addr0;                // 0x1b7c
	PE_L9A0_MIFB_WD_BANK_2_ADDR1_T         mifb_wd_bank_2_addr1;                // 0x1b80
	PE_L9A0_MIFB_LSB_SWITCH_T              mifb_lsb_switch;                     // 0x1b84
	PE_L9A0_MIFB_RD_REQ_PEND0_T            mifb_rd_req_pend0;                   // 0x1b88
	PE_L9A0_MIFB_WD_REQ_PEND0_T            mifb_wd_req_pend0;                   // 0x1b8c
	PE_L9A0_MIFB_RD_CMD_PRI00_S_T          mifb_rd_cmd_pri00_s;                 // 0x1b90
	PE_L9A0_MIFB_WD_CMD_PRI00_S_T          mifb_wd_cmd_pri00_s;                 // 0x1b94
	PE_L9A0_MIFB_RESET_T                   mifb_reset;                          // 0x1b98
} PE_MIB_REG_L9A0_T;

typedef struct {
	PE_L9A0_MIFC_RD_CTRL_T                 mifc_rd_ctrl;                        // 0x2800
	PE_L9A0_MIFC_WD_CTRL_T                 mifc_wd_ctrl;                        // 0x2804
	PE_L9A0_MIFC_RD_CMD_PRI0_T             mifc_rd_cmd_pri0;                    // 0x2808
	PE_L9A0_MIFC_RD_CMD_PRI1_T             mifc_rd_cmd_pri1;                    // 0x280c
	PE_L9A0_MIFC_WD_CMD_PRI0_T             mifc_wd_cmd_pri0;                    // 0x2810
	PE_L9A0_MIFC_RD_REQ_PRI0_T             mifc_rd_req_pri0;                    // 0x2814
	PE_L9A0_MIFC_RD_REQ_PRI1_T             mifc_rd_req_pri1;                    // 0x2818
	PE_L9A0_MIFC_WD_REQ_PRI0_T             mifc_wd_req_pri0;                    // 0x281c
	PE_L9A0_MIFC_RD_REQ_STV0_T             mifc_rd_req_stv0;                    // 0x2820
	PE_L9A0_MIFC_RD_REQ_STV1_T             mifc_rd_req_stv1;                    // 0x2824
	PE_L9A0_MIFC_WD_REQ_STV0_T             mifc_wd_req_stv0;                    // 0x2828
	PE_L9A0_MIFC_RD_CMD_PEND0_T            mifc_rd_cmd_pend0;                   // 0x282c
	PE_L9A0_MIFC_RD_CMD_PEND1_T            mifc_rd_cmd_pend1;                   // 0x2830
	PE_L9A0_MIFC_WD_CMD_PEND0_T            mifc_wd_cmd_pend0;                   // 0x2834
	PE_L9A0_MIFC_RD_CMD_STRIDE0_T          mifc_rd_cmd_stride0;                 // 0x2838
	PE_L9A0_MIFC_RD_CMD_STRIDE1_T          mifc_rd_cmd_stride1;                 // 0x283c
	PE_L9A0_MIFC_RD_CMD_STRIDE_SET_T       mifc_rd_cmd_stride_set;              // 0x2840
	PE_L9A0_MIFC_WD_CMD_STRIDE0_T          mifc_wd_cmd_stride0;                 // 0x2844
	PE_L9A0_MIFC_WD_CMD_STRIDE_SET_T       mifc_wd_cmd_stride_set;              // 0x2848
	PE_L9A0_MIFC_SADDR_RD_MVI_Y_MVI_C_T    mifc_saddr_rd_mvi_y_mvi_c;           // 0x284c
	PE_L9A0_MIFC_SADDR_RD_PREW_Y_PREW_C_T  mifc_saddr_rd_prew_y_prew_c;         // 0x2850
	PE_L9A0_MIFC_SADDR_RD_IPC0_Y_IPC_C_T   mifc_saddr_rd_ipc0_y_ipc_c;          // 0x2854
	PE_L9A0_MIFC_SADDR_RD_IPC1_Y_TNR0_Y_T  mifc_saddr_rd_ipc1_y_tnr0_y;         // 0x2858
	PE_L9A0_MIFC_SADDR_RD_SS_Y_SS_C_T      mifc_saddr_rd_ss_y_ss_c;             // 0x285c
	PE_L9A0_MIFC_SADDR_RD_TNR_C_T          mifc_saddr_rd_tnr_c;                 // 0x2860
	PE_L9A0_MIFC_SADDR_WD_SS_Y_SS_C_T      mifc_saddr_wd_ss_y_ss_c;             // 0x2864
	PE_L9A0_MIFC_SADDR_WD_TNR_Y_TNR_C_T    mifc_saddr_wd_tnr_y_tnr_c;           // 0x2868
	PE_L9A0_MIFC_SADDR_WD_PREW_Y_PREW_C_T  mifc_saddr_wd_prew_y_prew_c;         // 0x286c
	PE_L9A0_MIFC_SADDR_RD_DL_Y_DL_C_T      mifc_saddr_rd_dl_y_dl_c;             // 0x2870
	PE_L9A0_MIFC_SADDR_RD_DR_Y_DR_C_T      mifc_saddr_rd_dr_y_dr_c;             // 0x2874
	PE_L9A0_MIFC_SADDR_WD_DL_Y_DL_C_T      mifc_saddr_wd_dl_y_dl_c;             // 0x2878
	PE_L9A0_MIFC_SADDR_WD_DR_Y_DR_C_T      mifc_saddr_wd_dr_y_dr_c;             // 0x287c
	PE_L9A0_MIFC_SADDR_RD_EXT0_T           mifc_saddr_rd_ext0;                  // 0x2880
	PE_L9A0_MIFC_SADDR_RD_EXT1_T           mifc_saddr_rd_ext1;                  // 0x2884
	PE_L9A0_MIFC_SADDR_WD_EXT0_T           mifc_saddr_wd_ext0;                  // 0x2888
	PE_L9A0_MIFC_RD_DR_DL_EXT_T            mifc_rd_dr_dl_ext;                   // 0x288c
	PE_L9A0_MIFC_WD_DR_DL_EXT_T            mifc_wd_dr_dl_ext;                   // 0x2890
	PE_L9A0_MIFC_STATUS_T                  mifc_status;                         // 0x2894
	PE_L9A0_MIFC_SADDR_PARAM_UPDATE0_M_T   mifc_saddr_param_update0_m;          // 0x2898
	PE_L9A0_MIFC_RD_BANK_8_ADDR0_T         mifc_rd_bank_8_addr0;                // 0x289c
	PE_L9A0_MIFC_RD_BANK_8_ADDR1_T         mifc_rd_bank_8_addr1;                // 0x28a0
	PE_L9A0_MIFC_RD_BANK_2_ADDR0_T         mifc_rd_bank_2_addr0;                // 0x28a4
	PE_L9A0_MIFC_RD_BANK_2_ADDR1_T         mifc_rd_bank_2_addr1;                // 0x28a8
	PE_L9A0_MIFC_WD_BANK_8_ADDR0_T         mifc_wd_bank_8_addr0;                // 0x28ac
	PE_L9A0_MIFC_WD_BANK_8_ADDR1_T         mifc_wd_bank_8_addr1;                // 0x28b0
	PE_L9A0_MIFC_WD_BANK_2_ADDR0_T         mifc_wd_bank_2_addr0;                // 0x28b4
	PE_L9A0_MIFC_WD_BANK_2_ADDR1_T         mifc_wd_bank_2_addr1;                // 0x28b8
	PE_L9A0_MIFC_RD_REQ_PEND0_T            mifc_rd_req_pend0;                   // 0x28bc
	PE_L9A0_MIFC_RD_REQ_PEND1_T            mifc_rd_req_pend1;                   // 0x28c0
	PE_L9A0_MIFC_RD_REQ_PEND2_T            mifc_rd_req_pend2;                   // 0x28c4
	PE_L9A0_MIFC_WD_REQ_PEND0_T            mifc_wd_req_pend0;                   // 0x28c8
	PE_L9A0_MIFC_WD_REQ_PEND1_T            mifc_wd_req_pend1;                   // 0x28cc
	PE_L9A0_MIFC_RD_CMD_PRI0_S_T           mifc_rd_cmd_pri0_s;                  // 0x28d0
	PE_L9A0_MIFC_RD_CMD_PRI1_S_T           mifc_rd_cmd_pri1_s;                  // 0x28d4
	PE_L9A0_MIFC_WD_CMD_PRI0_S_T           mifc_wd_cmd_pri0_s;                  // 0x28d8
	PE_L9A0_MIFC_RESET_T                   mifc_reset;                          // 0x28dc
} PE_MIC_REG_L9A0_T;

typedef struct {
	PE_L9A0_MIFD_RD_CTRL_T                 mifd_rd_ctrl;                        // 0x3e00
	PE_L9A0_MIFD_WD_CTRL_T                 mifd_wd_ctrl;                        // 0x3e04
	PE_L9A0_MIFD_RD_CMD_PRI0_T             mifd_rd_cmd_pri0;                    // 0x3e08
	PE_L9A0_MIFD_WD_CMD_PRI0_T             mifd_wd_cmd_pri0;                    // 0x3e0c
	PE_L9A0_MIFD_RD_REQ_PRI0_T             mifd_rd_req_pri0;                    // 0x3e10
	PE_L9A0_MIFD_WD_REQ_PRI0_T             mifd_wd_req_pri0;                    // 0x3e14
	PE_L9A0_MIFD_RD_REQ_STV0_T             mifd_rd_req_stv0;                    // 0x3e18
	PE_L9A0_MIFD_WD_REQ_STV0_T             mifd_wd_req_stv0;                    // 0x3e1c
	PE_L9A0_MIFD_RD_CMD_PEND0_T            mifd_rd_cmd_pend0;                   // 0x3e20
	PE_L9A0_MIFD_WD_CMD_PEND1_T            mifd_wd_cmd_pend1;                   // 0x3e24
	PE_L9A0_MIFD_RD_CMD_STRIDE0_T          mifd_rd_cmd_stride0;                 // 0x3e28
	PE_L9A0_MIFD_RD_CMD_STRIDE_SET_T       mifd_rd_cmd_stride_set;              // 0x3e2c
	PE_L9A0_MIFD_WD_CMD_STRIDE0_T          mifd_wd_cmd_stride0;                 // 0x3e30
	PE_L9A0_MIFD_WD_CMD_STRIDE_SET_T       mifd_wd_cmd_stride_set;              // 0x3e34
	PE_L9A0_MIFD_SADDR_RD_OV_Y_OV_C_T      mifd_saddr_rd_ov_y_ov_c;             // 0x3e38
	PE_L9A0_MIFD_SADDR_RD_OSD_01_T         mifd_saddr_rd_osd_01;                // 0x3e3c
	PE_L9A0_MIFD_SADDR_RD_OSD_23_T         mifd_saddr_rd_osd_23;                // 0x3e40
	PE_L9A0_MIFD_SADDR_RD_CVE_YC_T         mifd_saddr_rd_cve_yc;                // 0x3e44
	PE_L9A0_MIFD_SADDR_WD_SM_YC_T          mifd_saddr_wd_sm_yc;                 // 0x3e48
	PE_L9A0_MIFD_SADDR_RD_EXT0_T           mifd_saddr_rd_ext0;                  // 0x3e4c
	PE_L9A0_MIFD_SADDR_WD_EXT0_T           mifd_saddr_wd_ext0;                  // 0x3e50
	PE_L9A0_MIFD_STATUS_T                  mifd_status;                         // 0x3e54
	PE_L9A0_MIFD_SADDR_PARAM_UPDATE0_M_T   mifd_saddr_param_update0_m;          // 0x3e58
	PE_L9A0_MIFD_RD_BANK_8_ADDR0_T         mifd_rd_bank_8_addr0;                // 0x3e5c
	PE_L9A0_MIFD_RD_BANK_8_ADDR1_T         mifd_rd_bank_8_addr1;                // 0x3e60
	PE_L9A0_MIFD_RD_BANK_2_ADDR0_T         mifd_rd_bank_2_addr0;                // 0x3e64
	PE_L9A0_MIFD_RD_BANK_2_ADDR1_T         mifd_rd_bank_2_addr1;                // 0x3e68
	PE_L9A0_MIFD_WD_BANK_8_ADDR0_T         mifd_wd_bank_8_addr0;                // 0x3e6c
	PE_L9A0_MIFD_WD_BANK_8_ADDR1_T         mifd_wd_bank_8_addr1;                // 0x3e70
	PE_L9A0_MIFD_WD_BANK_2_ADDR0_T         mifd_wd_bank_2_addr0;                // 0x3e74
	PE_L9A0_MIFD_WD_BANK_2_ADDR1_T         mifd_wd_bank_2_addr1;                // 0x3e78
	PE_L9A0_MIFD_RD_REQ_PEND0_T            mifd_rd_req_pend0;                   // 0x3e7c
	PE_L9A0_MIFD_WD_REQ_PEND0_T            mifd_wd_req_pend0;                   // 0x3e80
	PE_L9A0_MIFD_RD_CMD_PRI0_S_T           mifd_rd_cmd_pri0_s;                  // 0x3e84
	PE_L9A0_MIFD_WD_CMD_PRI0_S_T           mifd_wd_cmd_pri0_s;                  // 0x3e88
	PE_L9A0_MIFD_RESET_T                   mifd_reset;                          // 0x3e8c
} PE_MID_REG_L9A0_T;
