...
} PE_L9A0_P0L_PE0_STATUS0_T;

typedef struct { // 0x040c
	UINT32 line_cnt                            : 11;  // 10: 0
} PE_L9A0_P0L_PE0_STATUS1_T;
...
} PE_L9A0_P0L_PE0_SRC_SIZE_T;

typedef struct { // 0x0418
	UINT32 field_id                            : 1;   //     0
	UINT32                                     : 3;   //  3: 1
	UINT32 field_mode                          : 2;   //  5: 4
} PE_L9A0_P0L_PE0_FIELD_T;
...
} PE_L9A0_P0L_PE0_PARAM_BY_DDR_T;

typedef struct { // 0x0420
	UINT32 x0                                  : 11;  // 10: 0
	UINT32                                     : 5;   // 15:11
	UINT32 y0                                  : 11;  // 26:16
} PE_L9A0_P0L_WIN_CTRL_0_T;

typedef struct { // 0x0424
	UINT32 x1                                  : 11;  // 10: 0
	UINT32                                     : 5;   // 15:11
	UINT32 y1                                  : 11;  // 26:16
} PE_L9A0_P0L_WIN_CTRL_1_T;
...
} PE_L9A0_P0L_WIN_CTRL_2_T;

typedef struct { // 0x042c
	UINT32 x1                                  : 11;  // 10: 0
	UINT32                                     : 5;   // 15:11
	UINT32 y1                                  : 11;  // 26:16
} PE_L9A0_P0L_WIN_CTRL_3_T;
...
} PE_L9A0_P0L_TNR_CTRL_14_T;

typedef struct { // 0x047c
	UINT32 x1                                  : 11;  // 10: 0
	UINT32                                     : 5;   // 15:11
	UINT32 y1                                  : 11;  // 26:16
} PE_L9A0_P0L_TNR_CTRL_15_T;
...
} PE_L9A0_P0L_TNR_CRG_CTRL_00_T;

typedef struct { // 0x04f4
	UINT32 crgn_ctrl_indir_data                : 32;  // 31: 0
} PE_L9A0_P0L_TNR_CRG_CTRL_01_T;
...
} PE_L9A0_P0L_IPC_STATUS_02_T;

typedef struct { // 0x055c
	UINT32                                     : 16;  // 15: 0
	UINT32 fmd_badeditth_hw                    : 16;  // 31:16
} PE_L9A0_P0L_IPC_STATUS_03_T;
...
typedef struct { // 0x05ac
	...
	UINT32                                     : 3;   // 23:21
	UINT32 gain                                : 8;   // 31:24
} PE_L9A0_P0L_BNR_DC_CTRL_00_T;

typedef struct { // 0x05b0
	UINT32 blur_enable                         : 2;   //  1: 0
} PE_L9A0_P0L_BNR_DC_CTRL_01_T;
...
} PE_L9A0_P0L_BBD_CTRL_00_T;

typedef struct { // 0x0674
	UINT32 x0                                  : 12;  // 11: 0
	UINT32                                     : 4;   // 15:12
	UINT32 y0                                  : 12;  // 27:16
} PE_L9A0_P0L_BBD_CTRL_01_T;

typedef struct { // 0x0678
	UINT32 x1                                  : 12;  // 11: 0
	UINT32                                     : 4;   // 15:12
	UINT32 y1                                  : 12;  // 27:16
} PE_L9A0_P0L_BBD_CTRL_02_T;

typedef struct { // 0x067c
	UINT32 x0                                  : 12;  // 11: 0
	UINT32                                     : 4;   // 15:12
	UINT32 y0                                  : 12;  // 27:16
} PE_L9A0_P0L_BBD_STAT_00_T;

typedef struct { // 0x0680
	UINT32 x1                                  : 12;  // 11: 0
	UINT32                                     : 4;   // 15:12
	UINT32 y1                                  : 12;  // 27:16
} PE_L9A0_P0L_BBD_STAT_01_T;

typedef struct { // 0x0684
	UINT32 p0l_apl_stat_00_f                   : 32;   // 31: 0
} PE_L9A0_P0L_APL_STAT_00_T;

typedef struct { // 0x2400
	UINT32 load_time                           : 1;   //     0
	UINT32 load_enable                         : 1;   //     1
	UINT32 load_type                           : 1;   //     2
} PE_L9A0_P0R_PE0_LOAD_T;
...
typedef struct { // 0x2408
	...
	UINT32 dnr_frame_id                        : 8;   // 23:16
	UINT32 pic_init_frame_id                   : 4;   // 27:24
} PE_L9A0_P0R_PE0_STATUS0_T;

typedef struct { // 0x240c
	UINT32 line_cnt                            : 11;  // 10: 0
} PE_L9A0_P0R_PE0_STATUS1_T;
...
typedef struct { // 0x2414
	...
	UINT32                                     : 3;   // 30:28
	UINT32 scan_type                           : 1;   //    31
} PE_L9A0_P0R_PE0_SRC_SIZE_T;

typedef struct { // 0x2418
	UINT32 field_id                            : 1;   //     0
	UINT32                                     : 3;   //  3: 1
	UINT32 field_mode                          : 2;   //  5: 4
} PE_L9A0_P0R_PE0_FIELD_T;
...
typedef struct { // 0x241c
	...
	UINT32 endian                              : 1;   //    30
	UINT32 update_by_ddr                       : 1;   //    31
} PE_L9A0_P0R_PE0_PARAM_BY_DDR_T;

typedef struct { // 0x2420
	UINT32 x0                                  : 11;  // 10: 0
	UINT32                                     : 5;   // 15:11
	UINT32 y0                                  : 11;  // 26:16
} PE_L9A0_P0R_WIN_CTRL_0_T;

typedef struct { // 0x2424
	UINT32 x1                                  : 11;  // 10: 0
	UINT32                                     : 5;   // 15:11
	UINT32 y1                                  : 11;  // 26:16
} PE_L9A0_P0R_WIN_CTRL_1_T;
...
typedef struct { // 0x2428
	...
	UINT32                                     : 1;   //    27
	UINT32 ac_bnr_feature_cal_mode             : 2;   // 29:28
} PE_L9A0_P0R_WIN_CTRL_2_T;

typedef struct { // 0x242c
	UINT32 x1                                  : 11;  // 10: 0
	UINT32                                     : 5;   // 15:11
	UINT32 y1                                  : 11;  // 26:16
} PE_L9A0_P0R_WIN_CTRL_3_T;
...
typedef struct { // 0x2468
	...
	UINT32 ignore_active_window                : 1;   //    15
	UINT32 dbg_tnrw_port_ctrl                  : 2;   // 17:16
} PE_L9A0_P0R_TNR_CTRL_10_T;

typedef struct { // 0x246c
	UINT32 dbg_calc_motion                     : 8;   //  7: 0
	UINT32 dbg_alpha                           : 8;   // 15: 8
} PE_L9A0_P0R_TNR_CTRL_11_T;
...
typedef struct { // 0x2478
	...
	UINT32                                     : 4;   // 30:27
	UINT32 noise_measure_win_en                : 1;   //    31
} PE_L9A0_P0R_TNR_CTRL_14_T;

typedef struct { // 0x247c
	UINT32 x1                                  : 11;  // 10: 0
	UINT32                                     : 5;   // 15:11
	UINT32 y1                                  : 11;  // 26:16
} PE_L9A0_P0R_TNR_CTRL_15_T;
...
typedef struct { // 0x2480
	...
	UINT32 show_dbg_bar_ctrl2                  : 8;   // 23:16
	UINT32 show_dbg_bar_ctrl3                  : 8;   // 31:24
} PE_L9A0_P0R_TNR_CTRL_16_T;

typedef struct { // 0x2484
	UINT32 show_dbg_bar_ctrl4                  : 8;   //  7: 0
} PE_L9A0_P0R_TNR_CTRL_17_T;
...
typedef struct { // 0x24b0
	...
	UINT32 crgn_gain_in_rgn3                   : 8;   // 23:16
	UINT32 crgn_gain_out_rgn3                  : 8;   // 31:24
} PE_L9A0_P0R_TNR_CTRL_28_T;

typedef struct { // 0x24b4
	UINT32 wa2_min_slope	                   : 8;   //  7: 0
	UINT32 wa2_max_slope	                   : 8;	  // 15: 8
	UINT32 wa2_cc			                   : 8;	  // 23:16	
} PE_L9A0_P0R_TNR_CTRL_29_T;

typedef struct { // 0x24b8
	UINT32 wa2_min			                   : 8;   //  7: 0
	UINT32 wa2_max	    		               : 8;	  // 15: 8
} PE_L9A0_P0R_TNR_CTRL_30_T;
...
typedef struct { // 0x24c0
	...
	UINT32 nt_lvl                              : 8;   // 23:16
	UINT32 scene_change                        : 8;   // 31:24
} PE_L9A0_P0R_TNR_STATUS_00_T;

typedef struct { // 0x24c4
	UINT32 x_avg_s                             : 8;   //  7: 0
	UINT32 x_peak_s                            : 8;   // 15: 8
	UINT32 ns_lvl                              : 8;   // 23:16
} PE_L9A0_P0R_TNR_STATUS_01_T;
...
typedef struct { // 0x24c8
	...
	UINT32 gm                                  : 8;   // 23:16
	UINT32 lp                                  : 8;   // 31:24
} PE_L9A0_P0R_TNR_STATUS_02_T;

typedef struct { // 0x24cc
	UINT32 sum_of_temp_pel_diff                : 29;  // 28: 0
} PE_L9A0_P0R_TNR_STATUS_03_T;

typedef struct { // 0x24d0
	UINT32 main_lut_indir_addr                 : 4;   //  3: 0
	UINT32                                     : 8;   // 11: 4
	UINT32 main_lut_ai_enable                  : 1;   //    12
} PE_L9A0_P0R_TNR_MAIN_LUT_00_T;

typedef struct { // 0x24d4
	UINT32 main_lut_indir_data0                : 32;  // 31: 0
} PE_L9A0_P0R_TNR_MAIN_LUT_01_T;

typedef struct { // 0x24d8
	UINT32 main_lut_indir_data1                : 32;  // 31: 0
} PE_L9A0_P0R_TNR_MAIN_LUT_02_T;
...
typedef struct { // 0x24dc
	...
	UINT32 ti_h_gain                           : 8;   // 23:16
	UINT32 ti_v_gain                           : 8;   // 31:24
} PE_L9A0_P0R_TI_CTRL_T;

typedef struct { // 0x24e0
	UINT32 nt_lvl_lut_indir_addr               : 3;   //  2: 0
	UINT32                                     : 9;   // 11: 3
	UINT32 nt_lvl_lut_ai_enable                : 1;   //    12
} PE_L9A0_P0R_TNR_NT_LVL_LUT_00_T;

typedef struct { // 0x24e4
	UINT32 nt_lvl_lut_indir_data0              : 32;  // 31: 0
} PE_L9A0_P0R_TNR_NT_LVL_LUT_01_T;

typedef struct { // 0x24e8
	UINT32 nt_lvl_lut_indir_data1              : 32;  // 31: 0
} PE_L9A0_P0R_TNR_NT_LVL_LUT_02_T;

typedef struct { // 0x24ec
	UINT32 nt_lvl_lut_indir_data2              : 32;  // 31: 0
} PE_L9A0_P0R_TNR_NT_LVL_LUT_03_T;
...
typedef struct { // 0x24f0
	...
	UINT32 crgn_ctrl_csc_sel                   : 1;   //    14
	UINT32 crgn_ctrl_access_off                : 1;   //    15
} PE_L9A0_P0R_TNR_CRG_CTRL_00_T;

typedef struct { // 0x24f4
	UINT32 crgn_ctrl_indir_data                : 32;  // 31: 0
} PE_L9A0_P0R_TNR_CRG_CTRL_01_T;
...
typedef struct { // 0x250c
	...
	UINT32 fuzzy_ctrl_point_x3                 : 8;   // 23:16
	UINT32 fuzzy_ctrl_point_y3                 : 8;   // 31:24
} PE_L9A0_P0R_IPC_CTRL_03_T;

typedef struct { // 0x2510
	UINT32 hmc_filter_range_top                : 12;  // 11: 0
	UINT32                                     : 4;   // 15:12
	UINT32 hmc_filter_range_bot                : 12;  // 27:16
} PE_L9A0_P0R_IPC_CTRL_04_T;
...
typedef struct { // 0x2514
	...
	UINT32 protect_filtering_enable            : 1;   //    25
	UINT32 protect_th                          : 6;   // 31:26
} PE_L9A0_P0R_IPC_CTRL_05_T;

typedef struct { // 0x2518
	UINT32 hmc_point_max                       : 8;   //  7: 0
	UINT32 hmc_point_penalty                   : 8;   // 15: 8
	UINT32 hmc_point_valid_th                  : 8;   // 23:16
} PE_L9A0_P0R_IPC_CTRL_06_T;
...
typedef struct { // 0x2548
	...
	UINT32                                     : 4;   // 30:27
	UINT32 v_filt_ctrl_hmc_line_info_en        : 1;   //    31
} PE_L9A0_P0R_IPC_CTRL_18_T;

typedef struct { // 0x254c
	UINT32 repeat_det_line_cnt_th              : 8;   //  7: 0
	UINT32 repeat_det_diff_pel_cnt_th          : 8;   // 15: 8
	UINT32 repeat_det_noise_th                 : 4;   // 19:16
} PE_L9A0_P0R_IPC_CTRL_19_T;

typedef struct { // 0x2550
	UINT32 pc_cnt                              : 16;  // 15: 0
	UINT32 nc_cnt                              : 16;  // 31:16
} PE_L9A0_P0R_IPC_STATUS_00_T;

typedef struct { // 0x2554
	UINT32 pn_cnt                              : 16;  // 15: 0
	UINT32 same_cnt                            : 16;  // 31:16
} PE_L9A0_P0R_IPC_STATUS_01_T;
...
typedef struct { // 0x2558
	...
	UINT32 fmd32_still_detected                : 1;   //    28
	UINT32 repeat_detected                     : 1;   //    29
} PE_L9A0_P0R_IPC_STATUS_02_T;

typedef struct { // 0x255c
	UINT32                                     : 16;  // 15: 0
	UINT32 fmd_badeditth_hw                    : 16;  // 31:16
} PE_L9A0_P0R_IPC_STATUS_03_T;
...
typedef struct { // 0x2568
	...
	UINT32 cl_y_bound_ignore_p2                : 1;   //    19
	UINT32 cl_y_bound_ignore_p4                : 1;   //    20
} PE_L9A0_P0R_CLC_CTRL_02_T;

typedef struct { // 0x256c
	UINT32 cl_sat_min                          : 8;   //  7: 0
	UINT32 cc_sat_min                          : 8;   // 15: 8
	UINT32 cc_sat_max                          : 8;   // 23:16
} PE_L9A0_P0R_CLC_CTRL_03_T;

typedef struct { // 0x2570
	UINT32 p0r_clc_ctrl_04_f                   : 32;   // 31: 0
} PE_L9A0_P0R_CLC_CTRL_04_T;
...
typedef struct { // 0x2574
	...
	UINT32 clc_c_gain                          : 8;   // 15: 8
	UINT32 clc_dbg_show_mask                   : 12;  // 27:16
} PE_L9A0_P0R_CLC_CTRL_05_T;

typedef struct { // 0x2578
	UINT32 cc_c_filter_gain                    : 8;   //  7: 0
	UINT32 cc_y_filter_when_cc_detected        : 1;   //     8
} PE_L9A0_P0R_CLC_CTRL_06_T;

typedef struct { // 0x257c
	UINT32 cc_detection_count                  : 16;  // 15: 0
	UINT32 cl_detection_count                  : 16;  // 31:16
} PE_L9A0_P0R_CLC_STAT_00_T;
...
typedef struct { // 0x25ac
	...
	UINT32                                     : 3;   // 23:21
	UINT32 gain                                : 8;   // 31:24
} PE_L9A0_P0R_BNR_DC_CTRL_00_T;

typedef struct { // 0x25b0
	UINT32 blur_enable                         : 2;   //  1: 0
} PE_L9A0_P0R_BNR_DC_CTRL_01_T;
...
typedef struct { // 0x25c0
	...
	UINT32                                     : 3;   // 23:21
	UINT32 output_mux                          : 2;   // 25:24
} PE_L9A0_P0R_BNR_AC_CTRL_00_T;

typedef struct { // 0x25c4
	UINT32 strength_h_x0                       : 8;   //  7: 0
	UINT32 strength_h_x1                       : 8;   // 15: 8
	UINT32 strength_h_max                      : 8;   // 23:16
} PE_L9A0_P0R_BNR_AC_CTRL_01_T;

typedef struct { // 0x25c8
	UINT32 strength_v_x0                       : 8;   //  7: 0
	UINT32 strength_v_x1                       : 8;   // 15: 8
	UINT32 strength_v_max                      : 8;   // 23:16
} PE_L9A0_P0R_BNR_AC_CTRL_02_T;
...
typedef struct { // 0x25d0
	...
	UINT32 h_blockness_th                      : 8;   // 23:16
	UINT32 h_weight_max                        : 8;   // 31:24
} PE_L9A0_P0R_BNR_AC_CTRL_04_T;

typedef struct { // 0x25d4
	UINT32 use_of_hysterisis                   : 4;   //  3: 0
	UINT32 block_boundary_processing_type      : 1;   //     4
} PE_L9A0_P0R_BNR_AC_CTRL_05_T;
...
typedef struct { // 0x25dc
	...
	UINT32                                     : 1;   //     7
	UINT32 sd_hd_sel                           : 2;   //  9: 8
} PE_L9A0_P0R_DNR_DBAR_CTRL_T;

typedef struct { // 0x25e0
	UINT32 ac_bnr_h_status                     : 8;   //  7: 0
	UINT32 ac_bnr_v_status                     : 8;   // 15: 8
	UINT32 dc_bnr_th                           : 14;  // 29:16
} PE_L9A0_P0R_BNR_STAT_0_T;
...
typedef struct { // 0x25e4
	...
	UINT32                                     : 2;   //  7: 6
	UINT32 bif_th                              : 8;   // 15: 8
} PE_L9A0_P0R_DER_CTRL_0_T;

typedef struct { // 0x25e8
	UINT32 gain_th0                            : 8;   //  7: 0
	UINT32 gain_th1                            : 8;   // 15: 8
} PE_L9A0_P0R_DER_CTRL_1_T;
...
typedef struct { // 0x2600
	...
	UINT32 motion_min                          : 8;   // 23:16
	UINT32 ta_gain                             : 8;   // 31:24
} PE_L9A0_P0R_IPC_CTRL_24_T;

typedef struct { // 0x2604
	UINT32                                     : 16;  // 15: 0
	UINT32 h_gradiant_weight_                  : 8;   // 23:16
	UINT32 v_gradiant_weight_                  : 8;   // 31:24
} PE_L9A0_P0R_IPC_CTRL_25_T;
...
typedef struct { // 0x2670
	...
	UINT32                                     : 1;   //    27
	UINT32 apl_mux                             : 3;   // 30:28
} PE_L9A0_P0R_BBD_CTRL_00_T;

typedef struct { // 0x2674
	UINT32 x0                                  : 12;  // 11: 0
	UINT32                                     : 4;   // 15:12
	UINT32 y0                                  : 12;  // 27:16
} PE_L9A0_P0R_BBD_CTRL_01_T;

typedef struct { // 0x2678
	UINT32 x1                                  : 12;  // 11: 0
	UINT32                                     : 4;   // 15:12
	UINT32 y1                                  : 12;  // 27:16
} PE_L9A0_P0R_BBD_CTRL_02_T;

typedef struct { // 0x267c
	UINT32 x0                                  : 12;  // 11: 0
	UINT32                                     : 4;   // 15:12
	UINT32 y0                                  : 12;  // 27:16
} PE_L9A0_P0R_BBD_STAT_00_T;

typedef struct { // 0x2680
	UINT32 x1                                  : 12;  // 11: 0
	UINT32                                     : 4;   // 15:12
	UINT32 y1                                  : 12;  // 27:16
} PE_L9A0_P0R_BBD_STAT_01_T;

typedef struct { // 0x2684
	UINT32 p0r_apl_stat_00_f                   : 32;   // 31: 0
} PE_L9A0_P0R_APL_STAT_00_T;

typedef struct {
	PE_L9A0_P0L_PE0_LOAD_T             p0l_pe0_load;                    // 0x0400
	PE_L9A0_P0L_PE0_INTR_T             p0l_pe0_intr;                    // 0x0404
	PE_L9A0_P0L_PE0_STATUS0_T          p0l_pe0_status0;                 // 0x0408
	PE_L9A0_P0L_PE0_STATUS1_T          p0l_pe0_status1;                 // 0x040c
	PE_L9A0_P0L_PE0_OPMODE_T           p0l_pe0_opmode;                  // 0x0410
	PE_L9A0_P0L_PE0_SRC_SIZE_T         p0l_pe0_src_size;                // 0x0414
	PE_L9A0_P0L_PE0_FIELD_T            p0l_pe0_field;                   // 0x0418
	PE_L9A0_P0L_PE0_PARAM_BY_DDR_T     p0l_pe0_param_by_ddr;            // 0x041c
	PE_L9A0_P0L_WIN_CTRL_0_T           p0l_win_ctrl_0;                  // 0x0420
	PE_L9A0_P0L_WIN_CTRL_1_T           p0l_win_ctrl_1;                  // 0x0424
	PE_L9A0_P0L_WIN_CTRL_2_T           p0l_win_ctrl_2;                  // 0x0428
	PE_L9A0_P0L_WIN_CTRL_3_T           p0l_win_ctrl_3;                  // 0x042c
	UINT32                             reserved0[4];                    // 0x0430~0x043c
	PE_L9A0_P0L_TNR_CTRL_00_T          p0l_tnr_ctrl_00;                 // 0x0440
	PE_L9A0_P0L_TNR_CTRL_01_T          p0l_tnr_ctrl_01;                 // 0x0444
	PE_L9A0_P0L_TNR_CTRL_02_T          p0l_tnr_ctrl_02;                 // 0x0448
	PE_L9A0_P0L_TNR_CTRL_03_T          p0l_tnr_ctrl_03;                 // 0x044c
	PE_L9A0_P0L_TNR_CTRL_04_T          p0l_tnr_ctrl_04;                 // 0x0450
	PE_L9A0_P0L_TNR_CTRL_05_T          p0l_tnr_ctrl_05;                 // 0x0454
	PE_L9A0_P0L_TNR_CTRL_06_T          p0l_tnr_ctrl_06;                 // 0x0458
	PE_L9A0_P0L_TNR_CTRL_07_T          p0l_tnr_ctrl_07;                 // 0x045c
	PE_L9A0_P0L_TNR_CTRL_08_T          p0l_tnr_ctrl_08;                 // 0x0460
	PE_L9A0_P0L_TNR_CTRL_09_T          p0l_tnr_ctrl_09;                 // 0x0464
	PE_L9A0_P0L_TNR_CTRL_10_T          p0l_tnr_ctrl_10;                 // 0x0468
	PE_L9A0_P0L_TNR_CTRL_11_T          p0l_tnr_ctrl_11;                 // 0x046c
	PE_L9A0_P0L_TNR_CTRL_12_T          p0l_tnr_ctrl_12;                 // 0x0470
	PE_L9A0_P0L_TNR_CTRL_13_T          p0l_tnr_ctrl_13;                 // 0x0474
	PE_L9A0_P0L_TNR_CTRL_14_T          p0l_tnr_ctrl_14;                 // 0x0478
	PE_L9A0_P0L_TNR_CTRL_15_T          p0l_tnr_ctrl_15;                 // 0x047c
	PE_L9A0_P0L_TNR_CTRL_16_T          p0l_tnr_ctrl_16;                 // 0x0480
	PE_L9A0_P0L_TNR_CTRL_17_T          p0l_tnr_ctrl_17;                 // 0x0484
	PE_L9A0_P0L_TNR_CTRL_18_T          p0l_tnr_ctrl_18;                 // 0x0488
	PE_L9A0_P0L_TNR_CTRL_19_T          p0l_tnr_ctrl_19;                 // 0x048c
	PE_L9A0_P0L_TNR_CTRL_20_T          p0l_tnr_ctrl_20;                 // 0x0490
	PE_L9A0_P0L_TNR_CTRL_21_T          p0l_tnr_ctrl_21;                 // 0x0494
	PE_L9A0_P0L_TNR_CTRL_22_T          p0l_tnr_ctrl_22;                 // 0x0498
	PE_L9A0_P0L_TNR_CTRL_23_T          p0l_tnr_ctrl_23;                 // 0x049c
	PE_L9A0_P0L_TNR_CTRL_24_T          p0l_tnr_ctrl_24;                 // 0x04a0
	PE_L9A0_P0L_TNR_CTRL_25_T          p0l_tnr_ctrl_25;                 // 0x04a4
	PE_L9A0_P0L_TNR_CTRL_26_T          p0l_tnr_ctrl_26;                 // 0x04a8
	PE_L9A0_P0L_TNR_CTRL_27_T          p0l_tnr_ctrl_27;                 // 0x04ac
	PE_L9A0_P0L_TNR_CTRL_28_T          p0l_tnr_ctrl_28;                 // 0x04b0
	PE_L9A0_P0L_TNR_CTRL_29_T          p0l_tnr_ctrl_29;                 // 0x04b4
	PE_L9A0_P0L_TNR_CTRL_30_T          p0l_tnr_ctrl_30;                 // 0x04b8
	PE_L9A0_P0L_TNR_CTRL_31_T          p0l_tnr_ctrl_31;                 // 0x04bc
	PE_L9A0_P0L_TNR_STATUS_00_T        p0l_tnr_status_00;               // 0x04c0
	PE_L9A0_P0L_TNR_STATUS_01_T        p0l_tnr_status_01;               // 0x04c4
	PE_L9A0_P0L_TNR_STATUS_02_T        p0l_tnr_status_02;               // 0x04c8
	PE_L9A0_P0L_TNR_STATUS_03_T        p0l_tnr_status_03;               // 0x04cc
	PE_L9A0_P0L_TNR_MAIN_LUT_00_T      p0l_tnr_main_lut_00;             // 0x04d0
	PE_L9A0_P0L_TNR_MAIN_LUT_01_T      p0l_tnr_main_lut_01;             // 0x04d4
	PE_L9A0_P0L_TNR_MAIN_LUT_02_T      p0l_tnr_main_lut_02;             // 0x04d8
	PE_L9A0_P0L_TI_CTRL_T              p0l_ti_ctrl;                     // 0x04dc
	PE_L9A0_P0L_TNR_NT_LVL_LUT_00_T    p0l_tnr_nt_lvl_lut_00;           // 0x04e0
	PE_L9A0_P0L_TNR_NT_LVL_LUT_01_T    p0l_tnr_nt_lvl_lut_01;           // 0x04e4
	PE_L9A0_P0L_TNR_NT_LVL_LUT_02_T    p0l_tnr_nt_lvl_lut_02;           // 0x04e8
	PE_L9A0_P0L_TNR_NT_LVL_LUT_03_T    p0l_tnr_nt_lvl_lut_03;           // 0x04ec
	PE_L9A0_P0L_TNR_CRG_CTRL_00_T      p0l_tnr_crg_ctrl_00;             // 0x04f0
	PE_L9A0_P0L_TNR_CRG_CTRL_01_T      p0l_tnr_crg_ctrl_01;             // 0x04f4
	UINT32                             reserved1[2];                    // 0x04f8~0x04fc
	PE_L9A0_P0L_IPC_CTRL_00_T          p0l_ipc_ctrl_00;                 // 0x0500
	PE_L9A0_P0L_IPC_CTRL_01_T          p0l_ipc_ctrl_01;                 // 0x0504
	PE_L9A0_P0L_IPC_CTRL_02_T          p0l_ipc_ctrl_02;                 // 0x0508
	PE_L9A0_P0L_IPC_CTRL_03_T          p0l_ipc_ctrl_03;                 // 0x050c
	PE_L9A0_P0L_IPC_CTRL_04_T          p0l_ipc_ctrl_04;                 // 0x0510
	PE_L9A0_P0L_IPC_CTRL_05_T          p0l_ipc_ctrl_05;                 // 0x0514
	PE_L9A0_P0L_IPC_CTRL_06_T          p0l_ipc_ctrl_06;                 // 0x0518
	PE_L9A0_P0L_IPC_CTRL_07_T          p0l_ipc_ctrl_07;                 // 0x051c
	PE_L9A0_P0L_IPC_CTRL_08_T          p0l_ipc_ctrl_08;                 // 0x0520
	PE_L9A0_P0L_IPC_CTRL_09_T          p0l_ipc_ctrl_09;                 // 0x0524
	PE_L9A0_P0L_IPC_CTRL_10_T          p0l_ipc_ctrl_10;                 // 0x0528
	PE_L9A0_P0L_IPC_CTRL_11_T          p0l_ipc_ctrl_11;                 // 0x052c
	PE_L9A0_P0L_IPC_CTRL_12_T          p0l_ipc_ctrl_12;                 // 0x0530
	PE_L9A0_P0L_IPC_CTRL_13_T          p0l_ipc_ctrl_13;                 // 0x0534
	PE_L9A0_P0L_IPC_CTRL_14_T          p0l_ipc_ctrl_14;                 // 0x0538
	PE_L9A0_P0L_IPC_CTRL_15_T          p0l_ipc_ctrl_15;                 // 0x053c
	PE_L9A0_P0L_IPC_CTRL_16_T          p0l_ipc_ctrl_16;                 // 0x0540
	PE_L9A0_P0L_IPC_CTRL_17_T          p0l_ipc_ctrl_17;                 // 0x0544
	PE_L9A0_P0L_IPC_CTRL_18_T          p0l_ipc_ctrl_18;                 // 0x0548
	PE_L9A0_P0L_IPC_CTRL_19_T          p0l_ipc_ctrl_19;                 // 0x054c
	PE_L9A0_P0L_IPC_STATUS_00_T        p0l_ipc_status_00;               // 0x0550
	PE_L9A0_P0L_IPC_STATUS_01_T        p0l_ipc_status_01;               // 0x0554
	PE_L9A0_P0L_IPC_STATUS_02_T        p0l_ipc_status_02;               // 0x0558
	PE_L9A0_P0L_IPC_STATUS_03_T        p0l_ipc_status_03;               // 0x055c
	PE_L9A0_P0L_CLC_CTRL_00_T          p0l_clc_ctrl_00;                 // 0x0560
	PE_L9A0_P0L_CLC_CTRL_01_T          p0l_clc_ctrl_01;                 // 0x0564
	PE_L9A0_P0L_CLC_CTRL_02_T          p0l_clc_ctrl_02;                 // 0x0568
	PE_L9A0_P0L_CLC_CTRL_03_T          p0l_clc_ctrl_03;                 // 0x056c
	PE_L9A0_P0L_CLC_CTRL_04_T          p0l_clc_ctrl_04;                 // 0x0570
	PE_L9A0_P0L_CLC_CTRL_05_T          p0l_clc_ctrl_05;                 // 0x0574
	PE_L9A0_P0L_CLC_CTRL_06_T          p0l_clc_ctrl_06;                 // 0x0578
	PE_L9A0_P0L_CLC_STAT_00_T          p0l_clc_stat_00;                 // 0x057c
	PE_L9A0_P0L_VFLT_CTRL_T            p0l_vflt_ctrl;                   // 0x0580
	PE_L9A0_P0L_SNR_CTRL_00_T          p0l_snr_ctrl_00;                 // 0x0584
	PE_L9A0_P0L_MNR_CTRL_00_T          p0l_mnr_ctrl_00;                 // 0x0588
	PE_L9A0_P0L_MNR_CTRL_01_T          p0l_mnr_ctrl_01;                 // 0x058c
	PE_L9A0_P0L_MNR_CTRL_02_T          p0l_mnr_ctrl_02;                 // 0x0590
	PE_L9A0_P0L_MNR_CTRL_03_T          p0l_mnr_ctrl_03;                 // 0x0594
	PE_L9A0_P0L_MNR_CTRL_04_T          p0l_mnr_ctrl_04;                 // 0x0598
	PE_L9A0_P0L_MNR_CTRL_05_T          p0l_mnr_ctrl_05;                 // 0x059c
	PE_L9A0_P0L_MNR_CTRL_06_T          p0l_mnr_ctrl_06;                 // 0x05a0
	UINT32                             reserved2;                       // 0x05a4
	PE_L9A0_P0L_VFILTER_01_T           p0l_vfilter_01;                  // 0x05a8
	PE_L9A0_P0L_BNR_DC_CTRL_00_T       p0l_bnr_dc_ctrl_00;              // 0x05ac
	PE_L9A0_P0L_BNR_DC_CTRL_01_T       p0l_bnr_dc_ctrl_01;              // 0x05b0
	PE_L9A0_P0L_BNR_DC_CTRL_02_T       p0l_bnr_dc_ctrl_02;              // 0x05b4
	PE_L9A0_P0L_BNR_DC_CTRL_03_T       p0l_bnr_dc_ctrl_03;              // 0x05b8
	PE_L9A0_P0L_BNR_AC_CTRL_06_T       p0l_bnr_ac_ctrl_06;              // 0x05bc
	PE_L9A0_P0L_BNR_AC_CTRL_00_T       p0l_bnr_ac_ctrl_00;              // 0x05c0
	PE_L9A0_P0L_BNR_AC_CTRL_01_T       p0l_bnr_ac_ctrl_01;              // 0x05c4
	PE_L9A0_P0L_BNR_AC_CTRL_02_T       p0l_bnr_ac_ctrl_02;              // 0x05c8
	PE_L9A0_P0L_BNR_AC_CTRL_03_T       p0l_bnr_ac_ctrl_03;              // 0x05cc
	PE_L9A0_P0L_BNR_AC_CTRL_04_T       p0l_bnr_ac_ctrl_04;              // 0x05d0
	PE_L9A0_P0L_BNR_AC_CTRL_05_T       p0l_bnr_ac_ctrl_05;              // 0x05d4
	PE_L9A0_P0L_DNR_MAX_CTRL_T         p0l_dnr_max_ctrl;                // 0x05d8
	PE_L9A0_P0L_DNR_DBAR_CTRL_T        p0l_dnr_dbar_ctrl;               // 0x05dc
	PE_L9A0_P0L_BNR_STAT_0_T           p0l_bnr_stat_0;                  // 0x05e0
	PE_L9A0_P0L_DER_CTRL_0_T           p0l_der_ctrl_0;                  // 0x05e4
	PE_L9A0_P0L_DER_CTRL_1_T           p0l_der_ctrl_1;                  // 0x05e8
	UINT32                             reserved3;                       // 0x05ec
	PE_L9A0_P0L_IPC_CTRL_20_T          p0l_ipc_ctrl_20;                 // 0x05f0
	PE_L9A0_P0L_IPC_CTRL_21_T          p0l_ipc_ctrl_21;                 // 0x05f4
	PE_L9A0_P0L_IPC_CTRL_22_T          p0l_ipc_ctrl_22;                 // 0x05f8
	PE_L9A0_P0L_IPC_CTRL_23_T          p0l_ipc_ctrl_23;                 // 0x05fc
	PE_L9A0_P0L_IPC_CTRL_24_T          p0l_ipc_ctrl_24;                 // 0x0600
	PE_L9A0_P0L_IPC_CTRL_25_T          p0l_ipc_ctrl_25;                 // 0x0604
	PE_L9A0_P0L_IPC_CTRL_26_T          p0l_ipc_ctrl_26;                 // 0x0608
	PE_L9A0_P0L_IPC_CTRL_27_T          p0l_ipc_ctrl_27;                 // 0x060c
	PE_L9A0_P0L_IPC_CTRL_28_T          p0l_ipc_ctrl_28;                 // 0x0610
	PE_L9A0_P0L_IPC_CTRL_29_T          p0l_ipc_ctrl_29;                 // 0x0614
	UINT32                             reserved4[10];                   // 0x0618~0x063c
	PE_L9A0_P0L_TPD_CTRL_00_T          p0l_tpd_ctrl_00;                 // 0x0640
	UINT32                             reserved5[11];                   // 0x0644~0x066c
	PE_L9A0_P0L_BBD_CTRL_00_T          p0l_bbd_ctrl_00;                 // 0x0670
	PE_L9A0_P0L_BBD_CTRL_01_T          p0l_bbd_ctrl_01;                 // 0x0674
	PE_L9A0_P0L_BBD_CTRL_02_T          p0l_bbd_ctrl_02;                 // 0x0678
	PE_L9A0_P0L_BBD_STAT_00_T          p0l_bbd_stat_00;                 // 0x067c
	PE_L9A0_P0L_BBD_STAT_01_T          p0l_bbd_stat_01;                 // 0x0680
	PE_L9A0_P0L_APL_STAT_00_T          p0l_apl_stat_00;                 // 0x0684
} PE_P0L_REG_L9A0_T;

typedef struct {
	PE_L9A0_P0R_PE0_LOAD_T             p0r_pe0_load;                    // 0x2400
	PE_L9A0_P0R_PE0_INTR_T             p0r_pe0_intr;                    // 0x2404
	PE_L9A0_P0R_PE0_STATUS0_T          p0r_pe0_status0;                 // 0x2408
	PE_L9A0_P0R_PE0_STATUS1_T          p0r_pe0_status1;                 // 0x240c
	PE_L9A0_P0R_PE0_OPMODE_T           p0r_pe0_opmode;                  // 0x2410
	PE_L9A0_P0R_PE0_SRC_SIZE_T         p0r_pe0_src_size;                // 0x2414
	PE_L9A0_P0R_PE0_FIELD_T            p0r_pe0_field;                   // 0x2418
	PE_L9A0_P0R_PE0_PARAM_BY_DDR_T     p0r_pe0_param_by_ddr;            // 0x241c
	PE_L9A0_P0R_WIN_CTRL_0_T           p0r_win_ctrl_0;                  // 0x2420
	PE_L9A0_P0R_WIN_CTRL_1_T           p0r_win_ctrl_1;                  // 0x2424
	PE_L9A0_P0R_WIN_CTRL_2_T           p0r_win_ctrl_2;                  // 0x2428
	PE_L9A0_P0R_WIN_CTRL_3_T           p0r_win_ctrl_3;                  // 0x242c
	UINT32                             reserved6[4];                    // 0x2430~0x243c
	PE_L9A0_P0R_TNR_CTRL_00_T          p0r_tnr_ctrl_00;                 // 0x2440
	PE_L9A0_P0R_TNR_CTRL_01_T          p0r_tnr_ctrl_01;                 // 0x2444
	PE_L9A0_P0R_TNR_CTRL_02_T          p0r_tnr_ctrl_02;                 // 0x2448
	PE_L9A0_P0R_TNR_CTRL_03_T          p0r_tnr_ctrl_03;                 // 0x244c
	PE_L9A0_P0R_TNR_CTRL_04_T          p0r_tnr_ctrl_04;                 // 0x2450
	PE_L9A0_P0R_TNR_CTRL_05_T          p0r_tnr_ctrl_05;                 // 0x2454
	PE_L9A0_P0R_TNR_CTRL_06_T          p0r_tnr_ctrl_06;                 // 0x2458
	PE_L9A0_P0R_TNR_CTRL_07_T          p0r_tnr_ctrl_07;                 // 0x245c
	PE_L9A0_P0R_TNR_CTRL_08_T          p0r_tnr_ctrl_08;                 // 0x2460
	PE_L9A0_P0R_TNR_CTRL_09_T          p0r_tnr_ctrl_09;                 // 0x2464
	PE_L9A0_P0R_TNR_CTRL_10_T          p0r_tnr_ctrl_10;                 // 0x2468
	PE_L9A0_P0R_TNR_CTRL_11_T          p0r_tnr_ctrl_11;                 // 0x246c
	PE_L9A0_P0R_TNR_CTRL_12_T          p0r_tnr_ctrl_12;                 // 0x2470
	PE_L9A0_P0R_TNR_CTRL_13_T          p0r_tnr_ctrl_13;                 // 0x2474
	PE_L9A0_P0R_TNR_CTRL_14_T          p0r_tnr_ctrl_14;                 // 0x2478
	PE_L9A0_P0R_TNR_CTRL_15_T          p0r_tnr_ctrl_15;                 // 0x247c
	PE_L9A0_P0R_TNR_CTRL_16_T          p0r_tnr_ctrl_16;                 // 0x2480
	PE_L9A0_P0R_TNR_CTRL_17_T          p0r_tnr_ctrl_17;                 // 0x2484
	PE_L9A0_P0R_TNR_CTRL_18_T          p0r_tnr_ctrl_18;                 // 0x2488
	PE_L9A0_P0R_TNR_CTRL_19_T          p0r_tnr_ctrl_19;                 // 0x248c
	PE_L9A0_P0R_TNR_CTRL_20_T          p0r_tnr_ctrl_20;                 // 0x2490
	PE_L9A0_P0R_TNR_CTRL_21_T          p0r_tnr_ctrl_21;                 // 0x2494
	PE_L9A0_P0R_TNR_CTRL_22_T          p0r_tnr_ctrl_22;                 // 0x2498
	PE_L9A0_P0R_TNR_CTRL_23_T          p0r_tnr_ctrl_23;                 // 0x249c
	PE_L9A0_P0R_TNR_CTRL_24_T          p0r_tnr_ctrl_24;                 // 0x24a0
	PE_L9A0_P0R_TNR_CTRL_25_T          p0r_tnr_ctrl_25;                 // 0x24a4
	PE_L9A0_P0R_TNR_CTRL_26_T          p0r_tnr_ctrl_26;                 // 0x24a8
	PE_L9A0_P0R_TNR_CTRL_27_T          p0r_tnr_ctrl_27;                 // 0x24ac
	PE_L9A0_P0R_TNR_CTRL_28_T          p0r_tnr_ctrl_28;                 // 0x24b0
	PE_L9A0_P0R_TNR_CTRL_29_T          p0r_tnr_ctrl_29;                 // 0x24b4
	PE_L9A0_P0R_TNR_CTRL_30_T          p0r_tnr_ctrl_30;                 // 0x24b8
	PE_L9A0_P0R_TNR_CTRL_31_T          p0r_tnr_ctrl_31;                 // 0x24bc
	PE_L9A0_P0R_TNR_STATUS_00_T        p0r_tnr_status_00;               // 0x24c0
	PE_L9A0_P0R_TNR_STATUS_01_T        p0r_tnr_status_01;               // 0x24c4
	PE_L9A0_P0R_TNR_STATUS_02_T        p0r_tnr_status_02;               // 0x24c8
	PE_L9A0_P0R_TNR_STATUS_03_T        p0r_tnr_status_03;               // 0x24cc
	PE_L9A0_P0R_TNR_MAIN_LUT_00_T      p0r_tnr_main_lut_00;             // 0x24d0
	PE_L9A0_P0R_TNR_MAIN_LUT_01_T      p0r_tnr_main_lut_01;             // 0x24d4
	PE_L9A0_P0R_TNR_MAIN_LUT_02_T      p0r_tnr_main_lut_02;             // 0x24d8
	PE_L9A0_P0R_TI_CTRL_T              p0r_ti_ctrl;                     // 0x24dc
	PE_L9A0_P0R_TNR_NT_LVL_LUT_00_T    p0r_tnr_nt_lvl_lut_00;           // 0x24e0
	PE_L9A0_P0R_TNR_NT_LVL_LUT_01_T    p0r_tnr_nt_lvl_lut_01;           // 0x24e4
	PE_L9A0_P0R_TNR_NT_LVL_LUT_02_T    p0r_tnr_nt_lvl_lut_02;           // 0x24e8
	PE_L9A0_P0R_TNR_NT_LVL_LUT_03_T    p0r_tnr_nt_lvl_lut_03;           // 0x24ec
	PE_L9A0_P0R_TNR_CRG_CTRL_00_T      p0r_tnr_crg_ctrl_00;             // 0x24f0
	PE_L9A0_P0R_TNR_CRG_CTRL_01_T      p0r_tnr_crg_ctrl_01;             // 0x24f4
	UINT32                             reserved7[2];                    // 0x24f8~0x24fc
	PE_L9A0_P0R_IPC_CTRL_00_T          p0r_ipc_ctrl_00;                 // 0x2500
	PE_L9A0_P0R_IPC_CTRL_01_T          p0r_ipc_ctrl_01;                 // 0x2504
	PE_L9A0_P0R_IPC_CTRL_02_T          p0r_ipc_ctrl_02;                 // 0x2508
	PE_L9A0_P0R_IPC_CTRL_03_T          p0r_ipc_ctrl_03;                 // 0x250c
	PE_L9A0_P0R_IPC_CTRL_04_T          p0r_ipc_ctrl_04;                 // 0x2510
	PE_L9A0_P0R_IPC_CTRL_05_T          p0r_ipc_ctrl_05;                 // 0x2514
	PE_L9A0_P0R_IPC_CTRL_06_T          p0r_ipc_ctrl_06;                 // 0x2518
	PE_L9A0_P0R_IPC_CTRL_07_T          p0r_ipc_ctrl_07;                 // 0x251c
	PE_L9A0_P0R_IPC_CTRL_08_T          p0r_ipc_ctrl_08;                 // 0x2520
	PE_L9A0_P0R_IPC_CTRL_09_T          p0r_ipc_ctrl_09;                 // 0x2524
	PE_L9A0_P0R_IPC_CTRL_10_T          p0r_ipc_ctrl_10;                 // 0x2528
	PE_L9A0_P0R_IPC_CTRL_11_T          p0r_ipc_ctrl_11;                 // 0x252c
	PE_L9A0_P0R_IPC_CTRL_12_T          p0r_ipc_ctrl_12;                 // 0x2530
	PE_L9A0_P0R_IPC_CTRL_13_T          p0r_ipc_ctrl_13;                 // 0x2534
	PE_L9A0_P0R_IPC_CTRL_14_T          p0r_ipc_ctrl_14;                 // 0x2538
	PE_L9A0_P0R_IPC_CTRL_15_T          p0r_ipc_ctrl_15;                 // 0x253c
	PE_L9A0_P0R_IPC_CTRL_16_T          p0r_ipc_ctrl_16;                 // 0x2540
	PE_L9A0_P0R_IPC_CTRL_17_T          p0r_ipc_ctrl_17;                 // 0x2544
	PE_L9A0_P0R_IPC_CTRL_18_T          p0r_ipc_ctrl_18;                 // 0x2548
	PE_L9A0_P0R_IPC_CTRL_19_T          p0r_ipc_ctrl_19;                 // 0x254c
	PE_L9A0_P0R_IPC_STATUS_00_T        p0r_ipc_status_00;               // 0x2550
	PE_L9A0_P0R_IPC_STATUS_01_T        p0r_ipc_status_01;               // 0x2554
	PE_L9A0_P0R_IPC_STATUS_02_T        p0r_ipc_status_02;               // 0x2558
	PE_L9A0_P0R_IPC_STATUS_03_T        p0r_ipc_status_03;               // 0x255c
	PE_L9A0_P0R_CLC_CTRL_00_T          p0r_clc_ctrl_00;                 // 0x2560
	PE_L9A0_P0R_CLC_CTRL_01_T          p0r_clc_ctrl_01;                 // 0x2564
	PE_L9A0_P0R_CLC_CTRL_02_T          p0r_clc_ctrl_02;                 // 0x2568
	PE_L9A0_P0R_CLC_CTRL_03_T          p0r_clc_ctrl_03;                 // 0x256c
	PE_L9A0_P0R_CLC_CTRL_04_T          p0r_clc_ctrl_04;                 // 0x2570
	PE_L9A0_P0R_CLC_CTRL_05_T          p0r_clc_ctrl_05;                 // 0x2574
	PE_L9A0_P0R_CLC_CTRL_06_T          p0r_clc_ctrl_06;                 // 0x2578
	PE_L9A0_P0R_CLC_STAT_00_T          p0r_clc_stat_00;                 // 0x257c
	PE_L9A0_P0R_VFLT_CTRL_T            p0r_vflt_ctrl;                   // 0x2580
	PE_L9A0_P0R_SNR_CTRL_00_T          p0r_snr_ctrl_00;                 // 0x2584
	PE_L9A0_P0R_MNR_CTRL_00_T          p0r_mnr_ctrl_00;                 // 0x2588
	PE_L9A0_P0R_MNR_CTRL_01_T          p0r_mnr_ctrl_01;                 // 0x258c
	PE_L9A0_P0R_MNR_CTRL_02_T          p0r_mnr_ctrl_02;                 // 0x2590
	PE_L9A0_P0R_MNR_CTRL_03_T          p0r_mnr_ctrl_03;                 // 0x2594
	PE_L9A0_P0R_MNR_CTRL_04_T          p0r_mnr_ctrl_04;                 // 0x2598
	PE_L9A0_P0R_MNR_CTRL_05_T          p0r_mnr_ctrl_05;                 // 0x259c
	PE_L9A0_P0R_MNR_CTRL_06_T          p0r_mnr_ctrl_06;                 // 0x25a0
	UINT32                             reserved8;                       // 0x25a4
	PE_L9A0_P0R_VFILTER_01_T           p0r_vfilter_01;                  // 0x25a8
	PE_L9A0_P0R_BNR_DC_CTRL_00_T       p0r_bnr_dc_ctrl_00;              // 0x25ac
	PE_L9A0_P0R_BNR_DC_CTRL_01_T       p0r_bnr_dc_ctrl_01;              // 0x25b0
	PE_L9A0_P0R_BNR_DC_CTRL_02_T       p0r_bnr_dc_ctrl_02;              // 0x25b4
	PE_L9A0_P0R_BNR_DC_CTRL_03_T       p0r_bnr_dc_ctrl_03;              // 0x25b8
	PE_L9A0_P0R_BNR_AC_CTRL_06_T       p0r_bnr_ac_ctrl_06;              // 0x25bc
	PE_L9A0_P0R_BNR_AC_CTRL_00_T       p0r_bnr_ac_ctrl_00;              // 0x25c0
	PE_L9A0_P0R_BNR_AC_CTRL_01_T       p0r_bnr_ac_ctrl_01;              // 0x25c4
	PE_L9A0_P0R_BNR_AC_CTRL_02_T       p0r_bnr_ac_ctrl_02;              // 0x25c8
	PE_L9A0_P0R_BNR_AC_CTRL_03_T       p0r_bnr_ac_ctrl_03;              // 0x25cc
	PE_L9A0_P0R_BNR_AC_CTRL_04_T       p0r_bnr_ac_ctrl_04;              // 0x25d0
	PE_L9A0_P0R_BNR_AC_CTRL_05_T       p0r_bnr_ac_ctrl_05;              // 0x25d4
	PE_L9A0_P0R_DNR_MAX_CTRL_T         p0r_dnr_max_ctrl;                // 0x25d8
	PE_L9A0_P0R_DNR_DBAR_CTRL_T        p0r_dnr_dbar_ctrl;               // 0x25dc
	PE_L9A0_P0R_BNR_STAT_0_T           p0r_bnr_stat_0;                  // 0x25e0
	PE_L9A0_P0R_DER_CTRL_0_T           p0r_der_ctrl_0;                  // 0x25e4
	PE_L9A0_P0R_DER_CTRL_1_T           p0r_der_ctrl_1;                  // 0x25e8
	UINT32                             reserved9;                       // 0x25ec
	PE_L9A0_P0R_IPC_CTRL_20_T          p0r_ipc_ctrl_20;                 // 0x25f0
	PE_L9A0_P0R_IPC_CTRL_21_T          p0r_ipc_ctrl_21;                 // 0x25f4
	PE_L9A0_P0R_IPC_CTRL_22_T          p0r_ipc_ctrl_22;                 // 0x25f8
	PE_L9A0_P0R_IPC_CTRL_23_T          p0r_ipc_ctrl_23;                 // 0x25fc
	PE_L9A0_P0R_IPC_CTRL_24_T          p0r_ipc_ctrl_24;                 // 0x2600
	PE_L9A0_P0R_IPC_CTRL_25_T          p0r_ipc_ctrl_25;                 // 0x2604
	PE_L9A0_P0R_IPC_CTRL_26_T          p0r_ipc_ctrl_26;                 // 0x2608
	PE_L9A0_P0R_IPC_CTRL_27_T          p0r_ipc_ctrl_27;                 // 0x260c
	PE_L9A0_P0R_IPC_CTRL_28_T          p0r_ipc_ctrl_28;                 // 0x2610
	PE_L9A0_P0R_IPC_CTRL_29_T          p0r_ipc_ctrl_29;                 // 0x2614
	UINT32                             reserved10[10];                  // 0x2618~0x263c
	PE_L9A0_P0R_TPD_CTRL_00_T          p0r_tpd_ctrl_00;                 // 0x2640
	UINT32                             reserved11[11];                  // 0x2644~0x266c
	PE_L9A0_P0R_BBD_CTRL_00_T          p0r_bbd_ctrl_00;                 // 0x2670
	PE_L9A0_P0R_BBD_CTRL_01_T          p0r_bbd_ctrl_01;                 // 0x2674
	PE_L9A0_P0R_BBD_CTRL_02_T          p0r_bbd_ctrl_02;                 // 0x2678
	PE_L9A0_P0R_BBD_STAT_00_T          p0r_bbd_stat_00;                 // 0x267c
	PE_L9A0_P0R_BBD_STAT_01_T          p0r_bbd_stat_01;                 // 0x2680
	PE_L9A0_P0R_APL_STAT_00_T          p0r_apl_stat_00;                 // 0x2684
} PE_P0R_REG_L9A0_T;
