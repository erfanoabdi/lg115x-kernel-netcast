...
#ifndef _PE_PE0_REG_L9B0_H_
#define _PE_PE0_REG_L9B0_H_
...
typedef struct {
	...
	UINT32 cti_gain                        : 8;	// 16:23
	UINT32 cb_filter_c                     : 2;	// 24:25
} PE_L9B0_P0R_CTI_CTRL_00;

typedef struct {
	PE_L9B0_P0L_PE0_LOAD           pe0_load;			// 0x0400 : ''
	PE_L9B0_P0L_PE0_INTR           pe0_intr;			// 0x0404 : ''
	PE_L9B0_P0L_PE0_STATUS0        pe0_status0;		// 0x0408 : ''
	PE_L9B0_P0L_PE0_STATUS1        pe0_status1;		// 0x040c : ''
	PE_L9B0_P0L_PE0_OPMODE         pe0_opmode;			// 0x0410 : ''
	PE_L9B0_P0L_PE0_SRC_SIZE       pe0_src_size;		// 0x0414 : ''
	PE_L9B0_P0L_PE0_FIELD          pe0_field;			// 0x0418 : ''
	PE_L9B0_P0L_PE0_PARAM_BY_DDR   pe0_param_by_ddr;	// 0x041c : ''
	PE_L9B0_P0L_WIN_CTRL_0         win_ctrl_0;			// 0x0420 : ''
	PE_L9B0_P0L_WIN_CTRL_1         win_ctrl_1;			// 0x0424 : ''
	PE_L9B0_P0L_WIN_CTRL_2         win_ctrl_2;			// 0x0428 : ''
	PE_L9B0_P0L_WIN_CTRL_3         win_ctrl_3;			// 0x042c : ''
	UINT32                         reserved00[4];		// 0x0430 ~ 0x043c
	PE_L9B0_P0L_TNR_CTRL_00        tnr_ctrl_00;		// 0x0440 : ''
	PE_L9B0_P0L_TNR_CTRL_01        tnr_ctrl_01;		// 0x0444 : ''
	PE_L9B0_P0L_TNR_CTRL_02        tnr_ctrl_02;		// 0x0448 : ''
	PE_L9B0_P0L_TNR_CTRL_03        tnr_ctrl_03;		// 0x044c : ''
	PE_L9B0_P0L_TNR_CTRL_04        tnr_ctrl_04;		// 0x0450 : ''
	PE_L9B0_P0L_TNR_CTRL_05        tnr_ctrl_05;		// 0x0454 : ''
	PE_L9B0_P0L_TNR_CTRL_06        tnr_ctrl_06;		// 0x0458 : ''
	PE_L9B0_P0L_TNR_CTRL_07        tnr_ctrl_07;		// 0x045c : ''
	PE_L9B0_P0L_TNR_CTRL_08        tnr_ctrl_08;		// 0x0460 : ''
	PE_L9B0_P0L_TNR_CTRL_09        tnr_ctrl_09;		// 0x0464 : ''
	PE_L9B0_P0L_TNR_CTRL_10        tnr_ctrl_10;		// 0x0468 : ''
	PE_L9B0_P0L_TNR_CTRL_11        tnr_ctrl_11;		// 0x046c : ''
	PE_L9B0_P0L_TNR_CTRL_12        tnr_ctrl_12;		// 0x0470 : ''
	PE_L9B0_P0L_TNR_CTRL_13        tnr_ctrl_13;		// 0x0474 : ''
	PE_L9B0_P0L_TNR_CTRL_14        tnr_ctrl_14;		// 0x0478 : ''
	PE_L9B0_P0L_TNR_CTRL_15        tnr_ctrl_15;		// 0x047c : ''
	PE_L9B0_P0L_TNR_CTRL_16        tnr_ctrl_16;		// 0x0480 : ''
	PE_L9B0_P0L_TNR_CTRL_17        tnr_ctrl_17;		// 0x0484 : ''
	PE_L9B0_P0L_TNR_CTRL_18        tnr_ctrl_18;		// 0x0488 : ''
	PE_L9B0_P0L_TNR_CTRL_19        tnr_ctrl_19;		// 0x048c : ''
	PE_L9B0_P0L_TNR_CTRL_20        tnr_ctrl_20;		// 0x0490 : ''
	PE_L9B0_P0L_TNR_CTRL_21        tnr_ctrl_21;		// 0x0494 : ''
	PE_L9B0_P0L_TNR_CTRL_22        tnr_ctrl_22;		// 0x0498 : ''
	PE_L9B0_P0L_TNR_CTRL_23        tnr_ctrl_23;		// 0x049c : ''
	PE_L9B0_P0L_TNR_CTRL_24        tnr_ctrl_24;		// 0x04a0 : ''
	PE_L9B0_P0L_TNR_CTRL_25        tnr_ctrl_25;		// 0x04a4 : ''
	PE_L9B0_P0L_TNR_CTRL_26        tnr_ctrl_26;		// 0x04a8 : ''
	PE_L9B0_P0L_TNR_CTRL_27        tnr_ctrl_27;		// 0x04ac : ''
	PE_L9B0_P0L_TNR_CTRL_28        tnr_ctrl_28;		// 0x04b0 : ''
	PE_L9B0_P0L_TNR_CTRL_29        tnr_ctrl_29;		// 0x04b4 : ''
	PE_L9B0_P0L_TNR_CTRL_30        tnr_ctrl_30;		// 0x04b8 : ''
	PE_L9B0_P0L_TNR_CTRL_31        tnr_ctrl_31;		// 0x04bc : ''
	PE_L9B0_P0L_TNR_STATUS_00      tnr_status_00;		// 0x04c0 : ''
	PE_L9B0_P0L_TNR_STATUS_01      tnr_status_01;		// 0x04c4 : ''
	PE_L9B0_P0L_TNR_STATUS_02      tnr_status_02;		// 0x04c8 : ''
	PE_L9B0_P0L_TNR_STATUS_03      tnr_status_03;		// 0x04cc : ''
	PE_L9B0_P0L_TNR_MAIN_LUT_00    tnr_main_lut_00;	// 0x04d0 : ''
	PE_L9B0_P0L_TNR_MAIN_LUT_01    tnr_main_lut_01;	// 0x04d4 : ''
	PE_L9B0_P0L_TNR_MAIN_LUT_02    tnr_main_lut_02;	// 0x04d8 : ''
	UINT32                         reserved01;			// 0x04dc
	PE_L9B0_P0L_TNR_CTRL_32        tnr_ctrl_32;		// 0x04e0 : ''
	PE_L9B0_P0L_TNR_CTRL_33        tnr_ctrl_33;		// 0x04e4 : ''
	PE_L9B0_P0L_TNR_CTRL_34        tnr_ctrl_34;		// 0x04e8 : ''
	PE_L9B0_P0L_TNR_CTRL_35        tnr_ctrl_35;		// 0x04ec : ''
	PE_L9B0_P0L_TNR_CRG_CTRL_00    tnr_crg_ctrl_00;	// 0x04f0 : ''
	PE_L9B0_P0L_TNR_CRG_CTRL_01    tnr_crg_ctrl_01;	// 0x04f4 : ''
	UINT32                         reserved02[2];		// 0x04f8 ~ 0x04fc	
	PE_L9B0_P0L_IPC_CTRL_00        ipc_ctrl_00;		// 0x0500 : ''
	PE_L9B0_P0L_IPC_CTRL_01        ipc_ctrl_01;		// 0x0504 : ''
	PE_L9B0_P0L_IPC_CTRL_02        ipc_ctrl_02;		// 0x0508 : ''
	PE_L9B0_P0L_IPC_CTRL_03        ipc_ctrl_03;		// 0x050c : ''
	PE_L9B0_P0L_IPC_CTRL_04        ipc_ctrl_04;		// 0x0510 : ''
	PE_L9B0_P0L_IPC_CTRL_05        ipc_ctrl_05;		// 0x0514 : ''
	PE_L9B0_P0L_IPC_CTRL_06        ipc_ctrl_06;		// 0x0518 : ''
	PE_L9B0_P0L_IPC_CTRL_07        ipc_ctrl_07;		// 0x051c : ''
	PE_L9B0_P0L_IPC_CTRL_08        ipc_ctrl_08;		// 0x0520 : ''
	PE_L9B0_P0L_IPC_CTRL_09        ipc_ctrl_09;		// 0x0524 : ''
	PE_L9B0_P0L_IPC_CTRL_10        ipc_ctrl_10;		// 0x0528 : ''
	PE_L9B0_P0L_IPC_CTRL_11        ipc_ctrl_11;		// 0x052c : ''
	PE_L9B0_P0L_IPC_CTRL_12        ipc_ctrl_12;		// 0x0530 : ''
	PE_L9B0_P0L_IPC_CTRL_13        ipc_ctrl_13;		// 0x0534 : ''
	PE_L9B0_P0L_IPC_CTRL_14        ipc_ctrl_14;		// 0x0538 : ''
	PE_L9B0_P0L_IPC_CTRL_15        ipc_ctrl_15;		// 0x053c : ''
	PE_L9B0_P0L_IPC_CTRL_16        ipc_ctrl_16;		// 0x0540 : ''
	PE_L9B0_P0L_IPC_CTRL_17        ipc_ctrl_17;		// 0x0544 : ''
	PE_L9B0_P0L_IPC_CTRL_18        ipc_ctrl_18;		// 0x0548 : ''
	PE_L9B0_P0L_IPC_CTRL_19        ipc_ctrl_19;		// 0x054c : ''
	PE_L9B0_P0L_IPC_STATUS_00      ipc_status_00;		// 0x0550 : ''
	PE_L9B0_P0L_IPC_STATUS_01      ipc_status_01;		// 0x0554 : ''
	PE_L9B0_P0L_IPC_STATUS_02      ipc_status_02;		// 0x0558 : ''
	PE_L9B0_P0L_IPC_STATUS_03      ipc_status_03;		// 0x055c : ''
	PE_L9B0_P0L_CLC_CTRL_00        clc_ctrl_00;		// 0x0560 : ''
	PE_L9B0_P0L_CLC_CTRL_01        clc_ctrl_01;		// 0x0564 : ''
	PE_L9B0_P0L_CLC_CTRL_02        clc_ctrl_02;		// 0x0568 : ''
	PE_L9B0_P0L_CLC_CTRL_03        clc_ctrl_03;		// 0x056c : ''
	PE_L9B0_P0L_CLC_CTRL_04        clc_ctrl_04;		// 0x0570 : ''
	PE_L9B0_P0L_CLC_CTRL_05        clc_ctrl_05;		// 0x0574 : ''
	PE_L9B0_P0L_CLC_CTRL_06        clc_ctrl_06;		// 0x0578 : ''
	PE_L9B0_P0L_CLC_STAT_00        clc_stat_00;		// 0x057c : ''
	PE_L9B0_P0L_VFLT_CTRL          vflt_ctrl;			// 0x0580 : ''
	UINT32                         reserved03;			// 0x0584
	PE_L9B0_P0L_MNR_CTRL_00        mnr_ctrl_00;		// 0x0588 : ''
	PE_L9B0_P0L_MNR_CTRL_01        mnr_ctrl_01;		// 0x058c : ''
	PE_L9B0_P0L_MNR_CTRL_02        mnr_ctrl_02;		// 0x0590 : ''
	PE_L9B0_P0L_MNR_CTRL_03        mnr_ctrl_03;		// 0x0594 : ''
	PE_L9B0_P0L_MNR_CTRL_04        mnr_ctrl_04;		// 0x0598 : ''
	PE_L9B0_P0L_MNR_CTRL_05        mnr_ctrl_05;		// 0x059c : ''
	PE_L9B0_P0L_MNR_CTRL_06        mnr_ctrl_06;		// 0x05a0 : ''
	UINT32                         reserved04;			// 0x05a4
	PE_L9B0_P0L_VFILTER_01         vfilter_01;			// 0x05a8 : ''
	PE_L9B0_P0L_BNR_DC_CTRL_00     bnr_dc_ctrl_00;		// 0x05ac : ''
	PE_L9B0_P0L_BNR_DC_CTRL_01     bnr_dc_ctrl_01;		// 0x05b0 : ''
	PE_L9B0_P0L_BNR_DC_CTRL_02     bnr_dc_ctrl_02;		// 0x05b4 : ''
	PE_L9B0_P0L_BNR_DC_CTRL_03     bnr_dc_ctrl_03;		// 0x05b8 : ''
	PE_L9B0_P0L_BNR_AC_CTRL_06     bnr_ac_ctrl_06;		// 0x05bc : ''
	PE_L9B0_P0L_BNR_AC_CTRL_00     bnr_ac_ctrl_00;		// 0x05c0 : ''
	PE_L9B0_P0L_BNR_AC_CTRL_01     bnr_ac_ctrl_01;		// 0x05c4 : ''
	PE_L9B0_P0L_BNR_AC_CTRL_02     bnr_ac_ctrl_02;		// 0x05c8 : ''
	PE_L9B0_P0L_BNR_AC_CTRL_03     bnr_ac_ctrl_03;		// 0x05cc : ''
	PE_L9B0_P0L_BNR_AC_CTRL_04     bnr_ac_ctrl_04;		// 0x05d0 : ''
	PE_L9B0_P0L_BNR_AC_CTRL_05     bnr_ac_ctrl_05;		// 0x05d4 : ''
	PE_L9B0_P0L_DNR_MAX_CTRL       dnr_max_ctrl  ;		// 0x05d8 : ''
	PE_L9B0_P0L_DNR_DBAR_CTRL      dnr_dbar_ctrl ;		// 0x05dc : ''
	PE_L9B0_P0L_BNR_STAT_0         bnr_stat_0;			// 0x05e0 : ''
	PE_L9B0_P0L_DER_CTRL_0         der_ctrl_0;			// 0x05e4 : ''
	PE_L9B0_P0L_DER_CTRL_1         der_ctrl_1;			// 0x05e8 : ''
	UINT32                         reserved05;			// 0x05ec
	PE_L9B0_P0L_IPC_CTRL_20        ipc_ctrl_20;		// 0x05f0 : ''
	PE_L9B0_P0L_IPC_CTRL_21        ipc_ctrl_21;		// 0x05f4 : ''
	UINT32                         ipc_ctrl_22;		// 0x05f8 : ''
	PE_L9B0_P0L_IPC_CTRL_23        ipc_ctrl_23;		// 0x05fc : ''
	PE_L9B0_P0L_IPC_CTRL_24        ipc_ctrl_24;		// 0x0600 : ''
	PE_L9B0_P0L_IPC_CTRL_25        ipc_ctrl_25;		// 0x0604 : ''
	PE_L9B0_P0L_IPC_CTRL_26        ipc_ctrl_26;		// 0x0608 : ''
	PE_L9B0_P0L_IPC_CTRL_27        ipc_ctrl_27;		// 0x060c : ''
	UINT32                         reserved06[12];		// 0x0610 ~ 0x063c
	PE_L9B0_P0L_TPD_CTRL_00        tpd_ctrl_00;		// 0x0640 : ''
	PE_L9B0_P0L_TPD_CTRL_01        tpd_ctrl_01;		// 0x0644 : ''
	PE_L9B0_P0L_TPD_CTRL_02        tpd_ctrl_02;		// 0x0648 : ''
	PE_L9B0_P0L_TPD_CTRL_03        tpd_ctrl_03;		// 0x064c : ''
	PE_L9B0_P0L_TPD_CTRL_04        tpd_ctrl_04;		// 0x0650 : ''
	PE_L9B0_P0L_TPD_CTRL_05        tpd_ctrl_05;		// 0x0654 : ''
	PE_L9B0_P0L_TPD_CTRL_06        tpd_ctrl_06;		// 0x0658 : ''
	PE_L9B0_P0L_TPD_CTRL_07        tpd_ctrl_07;		// 0x065c : ''
	PE_L9B0_P0L_TPD_STAT_00        tpd_stat_00;		// 0x0660 : ''
	PE_L9B0_P0L_TPD_STAT_01        tpd_stat_01;		// 0x0664 : ''
	UINT32                         reserved07[2];		// 0x0668 ~ 0x066c
	PE_L9B0_P0L_BBD_CTRL_00        bbd_ctrl_00;		// 0x0670 : ''
	PE_L9B0_P0L_BBD_CTRL_01        bbd_ctrl_01;		// 0x0674 : ''
	PE_L9B0_P0L_BBD_CTRL_02        bbd_ctrl_02;		// 0x0678 : ''
	PE_L9B0_P0L_BBD_STAT_00        bbd_stat_00;		// 0x067c : ''
	PE_L9B0_P0L_BBD_STAT_01        bbd_stat_01;		// 0x0680 : ''
	PE_L9B0_P0L_APL_STAT_00        apl_stat_00;		// 0x0684 : ''
	UINT32                         reserved08[2];		// 0x0688 ~ 0x068c
	PE_L9B0_P0L_CTI_CTRL_00        cti_ctrl_00;		// 0x0690 : ''
	UINT32                         reserved09[3];		// 0x0694 ~ 0x069c
	PE_L9B0_P0L_3DFD_CTRL_00       tridfd_ctrl_00;		// 0x06a0 : ''
	PE_L9B0_P0L_3DFD_CTRL_01       tridfd_ctrl_01;		// 0x06a4 : ''
	PE_L9B0_P0L_3DFD_CTRL_02       tridfd_ctrl_02;		// 0x06a8 : ''
	PE_L9B0_P0L_3DFD_CTRL_03       tridfd_ctrl_03;		// 0x06ac : ''
	PE_L9B0_P0L_3DFD_STAT_00       tridfd_stat_00;		// 0x06b0 : ''
	PE_L9B0_P0L_3DFD_STAT_01       tridfd_stat_01;		// 0x06b4 : ''
	PE_L9B0_P0L_3DFD_STAT_02       tridfd_stat_02;		// 0x06b8 : ''
	PE_L9B0_P0L_3DFD_STAT_03       tridfd_stat_03;		// 0x06bc : ''
	PE_L9B0_P0L_3DFD_STAT_04       tridfd_stat_04;		// 0x06c0 : ''
	PE_L9B0_P0L_3DFD_STAT_05       tridfd_stat_05;		// 0x06c4 : ''
	PE_L9B0_P0L_3DFD_STAT_06       tridfd_stat_06;		// 0x06c8 : ''
	PE_L9B0_P0L_3DFD_STAT_07       tridfd_stat_07;		// 0x06cc : ''
} PE_P0L_REG_L9B0_T;

typedef struct {
	PE_L9B0_P0R_PE0_LOAD           pe0_load;			// 0x2400 : ''
	PE_L9B0_P0R_PE0_INTR           pe0_intr;			// 0x2404 : ''
	PE_L9B0_P0R_PE0_STATUS0        pe0_status0;		// 0x2408 : ''
	PE_L9B0_P0R_PE0_STATUS1        pe0_status1;		// 0x240c : ''
	PE_L9B0_P0R_PE0_OPMODE         pe0_opmode;			// 0x2410 : ''
	PE_L9B0_P0R_PE0_SRC_SIZE       pe0_src_size;		// 0x2414 : ''
	PE_L9B0_P0R_PE0_FIELD          pe0_field;			// 0x2418 : ''
	PE_L9B0_P0R_PE0_PARAM_BY_DDR   pe0_param_by_ddr;	// 0x241c : ''
	PE_L9B0_P0R_WIN_CTRL_0         win_ctrl_0;			// 0x2420 : ''
	PE_L9B0_P0R_WIN_CTRL_1         win_ctrl_1;			// 0x2424 : ''
	PE_L9B0_P0R_WIN_CTRL_2         win_ctrl_2;			// 0x2428 : ''
	PE_L9B0_P0R_WIN_CTRL_3         win_ctrl_3;			// 0x242c : ''
	UINT32                         reserved10[4];		// 0x2430 ~ 0x243c
	PE_L9B0_P0R_TNR_CTRL_00        tnr_ctrl_00;		// 0x2440 : ''
	PE_L9B0_P0R_TNR_CTRL_01        tnr_ctrl_01;		// 0x2444 : ''
	PE_L9B0_P0R_TNR_CTRL_02        tnr_ctrl_02;		// 0x2448 : ''
	PE_L9B0_P0R_TNR_CTRL_03        tnr_ctrl_03;		// 0x244c : ''
	PE_L9B0_P0R_TNR_CTRL_04        tnr_ctrl_04;		// 0x2450 : ''
	PE_L9B0_P0R_TNR_CTRL_05        tnr_ctrl_05;		// 0x2454 : ''
	PE_L9B0_P0R_TNR_CTRL_06        tnr_ctrl_06;		// 0x2458 : ''
	PE_L9B0_P0R_TNR_CTRL_07        tnr_ctrl_07;		// 0x245c : ''
	PE_L9B0_P0R_TNR_CTRL_08        tnr_ctrl_08;		// 0x2460 : ''
	PE_L9B0_P0R_TNR_CTRL_09        tnr_ctrl_09;		// 0x2464 : ''
	PE_L9B0_P0R_TNR_CTRL_10        tnr_ctrl_10;		// 0x2468 : ''
	PE_L9B0_P0R_TNR_CTRL_11        tnr_ctrl_11;		// 0x246c : ''
	PE_L9B0_P0R_TNR_CTRL_12        tnr_ctrl_12;		// 0x2470 : ''
	PE_L9B0_P0R_TNR_CTRL_13        tnr_ctrl_13;		// 0x2474 : ''
	PE_L9B0_P0R_TNR_CTRL_14        tnr_ctrl_14;		// 0x2478 : ''
	PE_L9B0_P0R_TNR_CTRL_15        tnr_ctrl_15;		// 0x247c : ''
	PE_L9B0_P0R_TNR_CTRL_16        tnr_ctrl_16;		// 0x2480 : ''
	PE_L9B0_P0R_TNR_CTRL_17        tnr_ctrl_17;		// 0x2484 : ''
	PE_L9B0_P0R_TNR_CTRL_18        tnr_ctrl_18;		// 0x2488 : ''
	PE_L9B0_P0R_TNR_CTRL_19        tnr_ctrl_19;		// 0x248c : ''
	PE_L9B0_P0R_TNR_CTRL_20        tnr_ctrl_20;		// 0x2490 : ''
	PE_L9B0_P0R_TNR_CTRL_21        tnr_ctrl_21;		// 0x2494 : ''
	PE_L9B0_P0R_TNR_CTRL_22        tnr_ctrl_22;		// 0x2498 : ''
	PE_L9B0_P0R_TNR_CTRL_23        tnr_ctrl_23;		// 0x249c : ''
	PE_L9B0_P0R_TNR_CTRL_24        tnr_ctrl_24;		// 0x24a0 : ''
	PE_L9B0_P0R_TNR_CTRL_25        tnr_ctrl_25;		// 0x24a4 : ''
	PE_L9B0_P0R_TNR_CTRL_26        tnr_ctrl_26;		// 0x24a8 : ''
	PE_L9B0_P0R_TNR_CTRL_27        tnr_ctrl_27;		// 0x24ac : ''
	PE_L9B0_P0R_TNR_CTRL_28        tnr_ctrl_28;		// 0x24b0 : ''
	PE_L9B0_P0R_TNR_CTRL_29        tnr_ctrl_29;		// 0x24b4 : ''
	PE_L9B0_P0R_TNR_CTRL_30        tnr_ctrl_30;		// 0x24b8 : ''
	PE_L9B0_P0R_TNR_CTRL_31        tnr_ctrl_31;		// 0x24bc : ''
	PE_L9B0_P0R_TNR_STATUS_00      tnr_status_00;		// 0x24c0 : ''
	PE_L9B0_P0R_TNR_STATUS_01      tnr_status_01;		// 0x24c4 : ''
	PE_L9B0_P0R_TNR_STATUS_02      tnr_status_02;		// 0x24c8 : ''
	PE_L9B0_P0R_TNR_STATUS_03      tnr_status_03;		// 0x24cc : ''
	PE_L9B0_P0R_TNR_MAIN_LUT_00    tnr_main_lut_00;	// 0x24d0 : ''
	PE_L9B0_P0R_TNR_MAIN_LUT_01    tnr_main_lut_01;	// 0x24d4 : ''
	PE_L9B0_P0R_TNR_MAIN_LUT_02    tnr_main_lut_02;	// 0x24d8 : ''
	UINT32                         reserved11;			// 0x24dc
	PE_L9B0_P0R_TNR_CTRL_32        tnr_ctrl_32;		// 0x24e0 : ''
	PE_L9B0_P0R_TNR_CTRL_33        tnr_ctrl_33;		// 0x24e4 : ''
	PE_L9B0_P0R_TNR_CTRL_34        tnr_ctrl_34;		// 0x24e8 : ''
	PE_L9B0_P0R_TNR_CTRL_35        tnr_ctrl_35;		// 0x24ec : ''
	PE_L9B0_P0R_TNR_CRG_CTRL_00    tnr_crg_ctrl_00;	// 0x24f0 : ''
	PE_L9B0_P0R_TNR_CRG_CTRL_01    tnr_crg_ctrl_01;	// 0x24f4 : ''
	UINT32                         reserved12[2];		// 0x24f8 ~ 0x24fc
	PE_L9B0_P0R_IPC_CTRL_00        ipc_ctrl_00;		// 0x2500 : ''
	PE_L9B0_P0R_IPC_CTRL_01        ipc_ctrl_01;		// 0x2504 : ''
	PE_L9B0_P0R_IPC_CTRL_02        ipc_ctrl_02;		// 0x2508 : ''
	PE_L9B0_P0R_IPC_CTRL_03        ipc_ctrl_03;		// 0x250c : ''
	PE_L9B0_P0R_IPC_CTRL_04        ipc_ctrl_04;		// 0x2510 : ''
	PE_L9B0_P0R_IPC_CTRL_05        ipc_ctrl_05;		// 0x2514 : ''
	PE_L9B0_P0R_IPC_CTRL_06        ipc_ctrl_06;		// 0x2518 : ''
	PE_L9B0_P0R_IPC_CTRL_07        ipc_ctrl_07;		// 0x251c : ''
	PE_L9B0_P0R_IPC_CTRL_08        ipc_ctrl_08;		// 0x2520 : ''
	PE_L9B0_P0R_IPC_CTRL_09        ipc_ctrl_09;		// 0x2524 : ''
	PE_L9B0_P0R_IPC_CTRL_10        ipc_ctrl_10;		// 0x2528 : ''
	PE_L9B0_P0R_IPC_CTRL_11        ipc_ctrl_11;		// 0x252c : ''
	PE_L9B0_P0R_IPC_CTRL_12        ipc_ctrl_12;		// 0x2530 : ''
	PE_L9B0_P0R_IPC_CTRL_13        ipc_ctrl_13;		// 0x2534 : ''
	PE_L9B0_P0R_IPC_CTRL_14        ipc_ctrl_14;		// 0x2538 : ''
	PE_L9B0_P0R_IPC_CTRL_15        ipc_ctrl_15;		// 0x253c : ''
	PE_L9B0_P0R_IPC_CTRL_16        ipc_ctrl_16;		// 0x2540 : ''
	PE_L9B0_P0R_IPC_CTRL_17        ipc_ctrl_17;		// 0x2544 : ''
	PE_L9B0_P0R_IPC_CTRL_18        ipc_ctrl_18;		// 0x2548 : ''
	PE_L9B0_P0R_IPC_CTRL_19        ipc_ctrl_19;		// 0x254c : ''
	PE_L9B0_P0R_IPC_STATUS_00      ipc_status_00;		// 0x2550 : ''
	PE_L9B0_P0R_IPC_STATUS_01      ipc_status_01;		// 0x2554 : ''
	PE_L9B0_P0R_IPC_STATUS_02      ipc_status_02;		// 0x2558 : ''
	PE_L9B0_P0R_IPC_STATUS_03      ipc_status_03;		// 0x255c : ''
	UINT32                         reserved13[8];		// 0x2560 ~ 0x257c
	PE_L9B0_P0R_VFLT_CTRL          vflt_ctrl;			// 0x2580 : ''
	UINT32                         reserved14;			// 0x2584
	PE_L9B0_P0R_MNR_CTRL_00        mnr_ctrl_00;		// 0x2588 : ''
	PE_L9B0_P0R_MNR_CTRL_01        mnr_ctrl_01;		// 0x258c : ''
	PE_L9B0_P0R_MNR_CTRL_02        mnr_ctrl_02;		// 0x2590 : ''
	PE_L9B0_P0R_MNR_CTRL_03        mnr_ctrl_03;		// 0x2594 : ''
	PE_L9B0_P0R_MNR_CTRL_04        mnr_ctrl_04;		// 0x2598 : ''
	PE_L9B0_P0R_MNR_CTRL_05        mnr_ctrl_05;		// 0x259c : ''
	PE_L9B0_P0R_MNR_CTRL_06        mnr_ctrl_06;		// 0x25a0 : ''
	UINT32                         reserved15;			// 0x25a4
	PE_L9B0_P0R_VFILTER_01         vfilter_01;			// 0x25a8 : ''
	PE_L9B0_P0R_BNR_DC_CTRL_00     bnr_dc_ctrl_00;		// 0x25ac : ''
	PE_L9B0_P0R_BNR_DC_CTRL_01     bnr_dc_ctrl_01;		// 0x25b0 : ''
	PE_L9B0_P0R_BNR_DC_CTRL_02     bnr_dc_ctrl_02;		// 0x25b4 : ''
	PE_L9B0_P0R_BNR_DC_CTRL_03     bnr_dc_ctrl_03;		// 0x25b8 : ''
	PE_L9B0_P0R_BNR_AC_CTRL_06     bnr_ac_ctrl_06;		// 0x25bc : ''
	PE_L9B0_P0R_BNR_AC_CTRL_00     bnr_ac_ctrl_00;		// 0x25c0 : ''
	PE_L9B0_P0R_BNR_AC_CTRL_01     bnr_ac_ctrl_01;		// 0x25c4 : ''
	PE_L9B0_P0R_BNR_AC_CTRL_02     bnr_ac_ctrl_02;		// 0x25c8 : ''
	PE_L9B0_P0R_BNR_AC_CTRL_03     bnr_ac_ctrl_03;		// 0x25cc : ''
	PE_L9B0_P0R_BNR_AC_CTRL_04     bnr_ac_ctrl_04;		// 0x25d0 : ''
	PE_L9B0_P0R_BNR_AC_CTRL_05     bnr_ac_ctrl_05;		// 0x25d4 : ''
	PE_L9B0_P0R_DNR_MAX_CTRL       dnr_max_ctrl;		// 0x25d8 : ''
	PE_L9B0_P0R_DNR_DBAR_CTRL      dnr_dbar_ctrl;		// 0x25dc : ''
	PE_L9B0_P0R_BNR_STAT_0         bnr_stat_0;			// 0x25e0 : ''
	PE_L9B0_P0R_DER_CTRL_0         der_ctrl_0;			// 0x25e4 : ''
	PE_L9B0_P0R_DER_CTRL_1         der_ctrl_1;			// 0x25e8 : ''
	UINT32                         reserved16;			// 0x25ec
	PE_L9B0_P0R_IPC_CTRL_20        ipc_ctrl_20;		// 0x25f0 : ''
	PE_L9B0_P0R_IPC_CTRL_21        ipc_ctrl_21;		// 0x25f4 : ''
	UINT32                         ipc_ctrl_22;		// 0x25f8 : ''
	PE_L9B0_P0R_IPC_CTRL_23        ipc_ctrl_23;		// 0x25fc : ''
	PE_L9B0_P0R_IPC_CTRL_24        ipc_ctrl_24;		// 0x2600 : ''
	PE_L9B0_P0R_IPC_CTRL_25        ipc_ctrl_25;		// 0x2604 : ''
	PE_L9B0_P0R_IPC_CTRL_26        ipc_ctrl_26;		// 0x2608 : ''
	PE_L9B0_P0R_IPC_CTRL_27        ipc_ctrl_27;		// 0x260c : ''
	UINT32                         reserved17[12];		// 0x2610 ~ 0x263c
	PE_L9B0_P0R_TPD_CTRL_00        tpd_ctrl_00;		// 0x2640 : ''
	UINT32                         reserved18[11];		// 0x2644 ~ 0x266c
	PE_L9B0_P0R_BBD_CTRL_00        bbd_ctrl_00;		// 0x2670 : ''
	PE_L9B0_P0R_BBD_CTRL_01        bbd_ctrl_01;		// 0x2674 : ''
	PE_L9B0_P0R_BBD_CTRL_02        bbd_ctrl_02;		// 0x2678 : ''
	PE_L9B0_P0R_BBD_STAT_00        bbd_stat_00;		// 0x267c : ''
	PE_L9B0_P0R_BBD_STAT_01        bbd_stat_01;		// 0x2680 : ''
	PE_L9B0_P0R_APL_STAT_00        apl_stat_00;		// 0x2684 : ''
	UINT32                         reserved19[2];		// 0x2688 ~ 0x268c
	PE_L9B0_P0R_CTI_CTRL_00        cti_ctrl_00;		// 0x2690 : ''
} PE_P0R_REG_L9B0_T;

#endif	//_PE_PE0_REG_L9B0_H_
