...
#ifndef _PE_SSC_REG_L9A0_H_
#define _PE_SSC_REG_L9A0_H_
...
} PE_L9A0_SSC_MANUAL_LOAD_T;

typedef struct { // 0x2170
	UINT32 h_offset                    : 8;   //  7: 0
	UINT32                             : 8;   // 15: 8
	UINT32 v_offset                    : 11;  // 26:16
} PE_L9A0_SSC_CANVAS_MODE_T;

typedef struct {
	PE_L9A0_SSC_CTRL_T                 ssc_ctrl;                        // 0x2100
	PE_L9A0_SSC_FIELD_T                ssc_field;                       // 0x2104
	PE_L9A0_SSC_Y_INIT_POS_H_T         ssc_y_init_pos_h;                // 0x2108
	PE_L9A0_SSC_Y_INIT_POS_V_T         ssc_y_init_pos_v;                // 0x210c
	PE_L9A0_SSC_C_INIT_POS_H_T         ssc_c_init_pos_h;                // 0x2110
	PE_L9A0_SSC_C_INIT_POS_V_T         ssc_c_init_pos_v;                // 0x2114
	PE_L9A0_SSC_SCR_SIZE_T             ssc_scr_size;                    // 0x2118
	PE_L9A0_SSC_WIN_OUT_SIZE_T         ssc_win_out_size;                // 0x211c
	PE_L9A0_SSC_WIN_IN_OFFSET_T        ssc_win_in_offset;               // 0x2120
	PE_L9A0_SSC_WIN_IN_SIZE_T          ssc_win_in_size;                 // 0x2124
	PE_L9A0_SSC_C_FORMAT_T             ssc_c_format;                    // 0x2128
	UINT32                             reserved0;                       // 0x212c
	PE_L9A0_SSC_H_FIR_COEF_DATA0_T     ssc_h_fir_coef_data0;            // 0x2130
	PE_L9A0_SSC_H_FIR_COEF_DATA1_T     ssc_h_fir_coef_data1;            // 0x2134
	PE_L9A0_SSC_H_FIR_COEF_DATA2_T     ssc_h_fir_coef_data2;            // 0x2138
	PE_L9A0_SSC_H_FIR_COEF_DATA3_T     ssc_h_fir_coef_data3;            // 0x213c
	PE_L9A0_SSC_H_FIR_COEF_CTRL_T      ssc_h_fir_coef_ctrl;             // 0x2140
	UINT32                             reserved1[7];                    // 0x2144~0x215c
	PE_L9A0_SSC_UPDATE_FROM_DDR_T      ssc_update_from_ddr;             // 0x2160
	UINT32                             reserved2;                       // 0x2164
	PE_L9A0_SSC_STATUS_REV_T           ssc_status_rev;                  // 0x2168
	PE_L9A0_SSC_MANUAL_LOAD_T          ssc_manual_load;                 // 0x216c
	PE_L9A0_SSC_CANVAS_MODE_T          ssc_canvas_mode;                 // 0x2170
} PE_SSC_REG_L9A0_T;
