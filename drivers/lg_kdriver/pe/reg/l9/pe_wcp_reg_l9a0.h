...
#ifndef _PE_WCP_REG_L9A0_H_
#define _PE_WCP_REG_L9A0_H_
...
typedef struct { // 0x3200
	...
	UINT32                         : 3;   //  5: 3
	UINT32 main_cflt_mode          : 2;   //  7: 6
} PE_L9A0_OVR_OV_CTRL0_T;

typedef struct { // 0x3210
	UINT32 m_hoffset               : 12;  // 11: 0
	UINT32                         : 4;   // 15:12
	UINT32 m_voffset               : 12;  // 27:16
} PE_L9A0_OVR_OV_MOFFSET_T;

typedef struct { // 0x3214
	UINT32 m_hsize                 : 12;  // 11: 0
	UINT32                         : 4;   // 15:12
	UINT32 m_vsize                 : 12;  // 27:16
} PE_L9A0_OVR_OV_MSIZE_T;
...
typedef struct { // 0x3220
	...
	UINT32 m_down_wid              : 4;   // 27:24
	UINT32 m_up_wid                : 4;   // 31:28
} PE_L9A0_OVR_OV_BORDER_WIDTH_T;

typedef struct { // 0x3224
	UINT32 cflt_coef_1             : 12;  // 11: 0
	UINT32                         : 4;   // 15:12
	UINT32 cflt_coef_0             : 12;  // 27:16
} PE_L9A0_OVR_CFLT_COEF0_T;

typedef struct { // 0x3228
	UINT32 cflt_coef_3             : 12;  // 11: 0
	UINT32                         : 4;   // 15:12
	UINT32 cflt_coef_2             : 12;  // 27:16
} PE_L9A0_OVR_CFLT_COEF1_T;
...
typedef struct { // 0x3244
	...
	UINT32                         : 12;  // 15: 4
	UINT32 line_cnt                : 11;  // 26:16
} PE_L9A0_OVR_OV_INTR_STATUS_T;

typedef struct {
	PE_L9A0_OVL_OV_CTRL0_T         ovl_ov_ctrl0;                // 0x1200
	PE_L9A0_OV_CTRL1_T             ov_ctrl1;                    // 0x1204
	PE_L9A0_OV_CTRL2_T             ov_ctrl2;                    // 0x1208
	PE_L9A0_OV_CTRL3_T             ov_ctrl3;                    // 0x120c
	PE_L9A0_OVL_OV_MOFFSET_T       ovl_ov_moffset;              // 0x1210
	PE_L9A0_OVL_OV_MSIZE_T         ovl_ov_msize;                // 0x1214
	PE_L9A0_OV_SOFFSET_T           ov_soffset;                  // 0x1218
	PE_L9A0_OV_SSIZE_T             ov_ssize;                    // 0x121c
	PE_L9A0_OVL_OV_BORDER_WIDTH_T  ovl_ov_border_width;         // 0x1220
	PE_L9A0_OVL_CFLT_COEF0_T       ovl_cflt_coef0;              // 0x1224
	PE_L9A0_OVL_CFLT_COEF1_T       ovl_cflt_coef1;              // 0x1228
	UINT32                         reserved0;                   // 0x122c
	PE_L9A0_OVL_OV_PARAM_BY_DDR_T  ovl_ov_param_by_ddr;         // 0x1230
	UINT32                         reserved1[3];                // 0x1234~0x123c
	PE_L9A0_OVL_OV_INTR_CTRL_T     ovl_ov_intr_ctrl;            // 0x1240
	PE_L9A0_OVL_OV_INTR_STATUS_T   ovl_ov_intr_status;          // 0x1244
	PE_L9A0_OV_CTRL4_T             ov_ctrl4;                    // 0x1248
	PE_L9A0_OV_CTRL5_T             ov_ctrl5;                    // 0x124c
	PE_L9A0_OV_CTRL6_T             ov_ctrl6;                    // 0x1250
} PE_OVL_REG_L9A0_T;

typedef struct {
	PE_L9A0_OVR_OV_CTRL0_T         ovr_ov_ctrl0;                // 0x3200
	UINT32                         reserved2[3];                // 0x3204~0x320c
	PE_L9A0_OVR_OV_MOFFSET_T       ovr_ov_moffset;              // 0x3210
	PE_L9A0_OVR_OV_MSIZE_T         ovr_ov_msize;                // 0x3214
	UINT32                         reserved3[2];                // 0x3218~0x321c
	PE_L9A0_OVR_OV_BORDER_WIDTH_T  ovr_ov_border_width;         // 0x3220
	PE_L9A0_OVR_CFLT_COEF0_T       ovr_cflt_coef0;              // 0x3224
	PE_L9A0_OVR_CFLT_COEF1_T       ovr_cflt_coef1;              // 0x3228
	UINT32                         reserved4;                   // 0x322c
	PE_L9A0_OVR_OV_PARAM_BY_DDR_T  ovr_ov_param_by_ddr;         // 0x3230
	UINT32                         reserved5[3];                // 0x3234~0x323c
	PE_L9A0_OVR_OV_INTR_CTRL_T     ovr_ov_intr_ctrl;            // 0x3240
	PE_L9A0_OVR_OV_INTR_STATUS_T   ovr_ov_intr_status;          // 0x3244
} PE_OVR_REG_L9A0_T;
