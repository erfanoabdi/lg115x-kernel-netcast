...
#ifndef _PE_WCP_REG_L9B0_H_
#define _PE_WCP_REG_L9B0_H_
...
typedef struct {
	...
	UINT32 main_y_mif_line_inc         : 2;   // 29:30
	UINT32 main_y_manual_mif_ctrl_en   : 1;   //    31
} PE_L9B0_OV_MIF_CTRL_T;

typedef struct {
	PE_L9B0_OVL_OV_CTRL0_T         ovl_ov_ctrl0;                // 0x1200
	PE_L9B0_OV_CTRL1_T             ov_ctrl1;                    // 0x1204
	PE_L9B0_OV_CTRL2_T             ov_ctrl2;                    // 0x1208
	PE_L9B0_OV_CTRL3_T             ov_ctrl3;                    // 0x120c
	PE_L9B0_OVL_OV_MOFFSET_T       ovl_ov_moffset;              // 0x1210
	PE_L9B0_OVL_OV_MSIZE_T         ovl_ov_msize;                // 0x1214
	PE_L9B0_OV_SOFFSET_T           ov_soffset;                  // 0x1218
	PE_L9B0_OV_SSIZE_T             ov_ssize;                    // 0x121c
	PE_L9B0_OVL_OV_BORDER_WIDTH_T  ovl_ov_border_width;         // 0x1220
	PE_L9B0_OVL_CFLT_COEF0_T       ovl_cflt_coef0;              // 0x1224
	PE_L9B0_OVL_CFLT_COEF1_T       ovl_cflt_coef1;              // 0x1228
	UINT32                         reserved0;                   // 0x122c
	PE_L9B0_OVL_OV_PARAM_BY_DDR_T  ovl_ov_param_by_ddr;         // 0x1230
	UINT32                         reserved1[3];                // 0x1234~0x123c
	PE_L9B0_OVL_OV_INTR_CTRL_T     ovl_ov_intr_ctrl;            // 0x1240
	PE_L9B0_OVL_OV_INTR_STATUS_T   ovl_ov_intr_status;          // 0x1244
	PE_L9B0_OV_CTRL4_T             ov_ctrl4;                    // 0x1248
	PE_L9B0_OV_CTRL5_T             ov_ctrl5;                    // 0x124c
	PE_L9B0_OV_CTRL6_T             ov_ctrl6;                    // 0x1250
	PE_L9B0_OV_CTRL7_T             ov_ctrl7;                    // 0x1254
	PE_L9B0_OVL_OV_YC_DELAY_T      ovl_ov_yc_delay;             // 0x1258
	PE_L9B0_OV_MIF_CTRL0_T         ov_mif_ctrl0;                // 0x125c
	PE_L9B0_OV_MIF_CTRL1_T         ov_mif_ctrl1;                // 0x1260
} PE_OVL_REG_L9B0_T;

typedef struct {
	PE_L9B0_OVR_OV_CTRL0_T         ovr_ov_ctrl0;                // 0x3200
	UINT32                         reserved2[3];                // 0x3204~0x320c
	PE_L9B0_OVR_OV_MOFFSET_T       ovr_ov_moffset;              // 0x3210
	PE_L9B0_OVR_OV_MSIZE_T         ovr_ov_msize;                // 0x3214
	UINT32                         reserved3[2];                // 0x3218~0x321c
	PE_L9B0_OVR_OV_BORDER_WIDTH_T  ovr_ov_border_width;         // 0x3220
	PE_L9B0_OVR_CFLT_COEF0_T       ovr_cflt_coef0;              // 0x3224
	PE_L9B0_OVR_CFLT_COEF1_T       ovr_cflt_coef1;              // 0x3228
	UINT32                         reserved4;                   // 0x322c
	PE_L9B0_OVR_OV_PARAM_BY_DDR_T  ovr_ov_param_by_ddr;         // 0x3230
	UINT32                         reserved5[3];                // 0x3234~0x323c
	PE_L9B0_OVR_OV_INTR_CTRL_T     ovr_ov_intr_ctrl;            // 0x3240
	PE_L9B0_OVR_OV_INTR_STATUS_T   ovr_ov_intr_status;          // 0x3244
	UINT32                         reserved6[4];                // 0x3248~0x3254
	PE_L9B0_OVR_OV_YC_DELAY_T      ovr_ov_yc_delay;             // 0x3258
	PE_L9B0_OV_MIF_CTRL_T          ov_mif_ctrl;                 // 0x325c
} PE_OVR_REG_L9B0_T;
