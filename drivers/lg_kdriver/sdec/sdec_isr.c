...
void SDEC_PollThread(void *param)
{
	...
	/* jinhwan.bae - 2013. 02. 16 ATSC Channel Change DTV Nosignal Issue Work Around.
	    make do reset many time instead of one time at the time of CDIF_FULL and MWF_OVF */
	if(0) //(SDEC_HAL_ChanStatGetMWFOverFlow(ui8Ch))
	{
