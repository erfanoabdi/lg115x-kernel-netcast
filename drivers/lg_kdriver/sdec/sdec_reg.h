 ...
 * _r : register name
 */
#define SD_RdFL_A0(_m, _r)			((gpReg##_m##_A0->_r)=(gpRealReg##_m##_A0->_r))
#define SD_RdFL_B0(_m, _r)			((gpReg##_m##_B0->_r)=(gpRealReg##_m##_B0->_r))
#define SD_RdFL_H13A0(_m, _r)		((gpReg##_m##_H13A0->_r)=(gpRealReg##_m##_H13A0->_r))

#define SD_WrFL_A0(_m, _r)			((gpRealReg##_m##_A0->_r)=(gpReg##_m##_A0->_r))
#define SD_WrFL_B0(_m, _r)			((gpRealReg##_m##_B0->_r)=(gpReg##_m##_B0->_r))
#define SD_WrFL_H13A0(_m, _r)			((gpRealReg##_m##_H13A0->_r)=(gpReg##_m##_H13A0->_r))


#define SD_Rd_A0(_m, _r, _v)				(_v = *((UINT32*)(&(gpReg##_m##_A0->_r))))
#define SD_Rd_B0(_m, _r, _v)				(_v = *((UINT32*)(&(gpReg##_m##_B0->_r))))
#define SD_Rd_H13A0(_m, _r, _v)				(_v = *((UINT32*)(&(gpReg##_m##_H13A0->_r))))

#define SD_Wr_A0(_m, _r, _v)				(*((UINT32*)(&(gpReg##_m##_B0->_r))) =	_v)
#define SD_Wr_B0(_m, _r, _v)				(*((UINT32*)(&(gpReg##_m##_B0->_r))) =	_v)
#define SD_Wr_H13A0(_m, _r, _v)				(*((UINT32*)(&(gpReg##_m##_H13A0->_r))) =	_v)

#define SD_Rd01_A0(_m, _r, _f01, _v01)			(_v01 = (gpReg##_m##_A0->_r._f01))
#define SD_Rd01_B0(_m, _r, _f01, _v01)			(_v01 = (gpReg##_m##_B0->_r._f01))
#define SD_Rd01_H13A0(_m, _r, _f01, _v01)		(_v01 = (gpReg##_m##_H13A0->_r._f01))

#define SD_Wr01_A0(_m, _r, _f01, _v01)		((gpReg##_m##_A0->_r._f01) = _v01)
#define SD_Wr01_B0(_m, _r, _f01, _v01)		((gpReg##_m##_B0->_r._f01) = _v01)
...
#define SD_Rd01(_m, _r, _f01, _v01)														\
								do {														\
									if(lx_chip_rev() >= LX_CHIP_REV(H13, A0))			\
										...
										SD_Rd01_A0(_m, _r, _f01, _v01);					\
									else if(lx_chip_rev() <= LX_CHIP_REV(L9, B2))		\
										SD_Rd01_B0(_m, _r, _f01, _v01);					\
								} while(0)
...
#define SD_Wr01(_m, _r, _f01, _v01)														\
								do {														\
									if(lx_chip_rev() >= LX_CHIP_REV(H13, A0))			\
										...
										SD_Wr01_A0(_m, _r, _f01, _v01);					\
									else if(lx_chip_rev() <= LX_CHIP_REV(L9, B2))		\
										SD_Wr01_B0(_m, _r, _f01, _v01);					\
								} while(0)

// Indexed Register Access
#define SD_RdFL_IDX_A0(_m, _i, _r)			((gpReg##_m##_A0[_i]->_r)=(gpRealReg##_m##_A0[_i]->_r))
#define SD_RdFL_IDX_B0(_m, _i, _r)			((gpReg##_m##_B0[_i]->_r)=(gpRealReg##_m##_B0[_i]->_r))
#define SD_RdFL_IDX_H13A0(_m, _i, _r)		((gpReg##_m##_H13A0[_i]->_r)=(gpRealReg##_m##_H13A0[_i]->_r))

#define SD_WrFL_IDX_A0(_m, _i, _r)			((gpRealReg##_m##_A0[_i]->_r)=(gpReg##_m##_A0[_i]->_r))
#define SD_WrFL_IDX_B0(_m, _i, _r)			((gpRealReg##_m##_B0[_i]->_r)=(gpReg##_m##_B0[_i]->_r))
#define SD_WrFL_IDX_H13A0(_m, _i, _r)		((gpRealReg##_m##_H13A0[_i]->_r)=(gpReg##_m##_H13A0[_i]->_r))

#define SD_Rd_IDX_A0(_m, _i, _r, _v)				(_v = *((UINT32*)(&(gpReg##_m##_A0[_i]->_r))))
#define SD_Rd_IDX_B0(_m, _i, _r, _v)				(_v = *((UINT32*)(&(gpReg##_m##_B0[_i]->_r))))
#define SD_Rd_IDX_H13A0(_m, _i, _r, _v)				(_v = *((UINT32*)(&(gpReg##_m##_H13A0[_i]->_r))))

#define SD_Wr_IDX_A0(_m, _i, _r, _v)				(*((UINT32*)(&(gpReg##_m##_B0[_i]->_r))) =	_v)
#define SD_Wr_IDX_B0(_m, _i, _r, _v)				(*((UINT32*)(&(gpReg##_m##_B0[_i]->_r))) =	_v)
#define SD_Wr_IDX_H13A0(_m, _i, _r, _v)				(*((UINT32*)(&(gpReg##_m##_H13A0[_i]->_r))) =	_v)

#define SD_Rd01_IDX_A0(_m, _i, _r, _f01, _v01)		(_v01 = (gpReg##_m##_A0[_i]->_r._f01))
#define SD_Rd01_IDX_B0(_m, _i, _r, _f01, _v01)		(_v01 = (gpReg##_m##_B0[_i]->_r._f01))
#define SD_Rd01_IDX_H13A0(_m, _i, _r, _f01, _v01)	(_v01 = (gpReg##_m##_H13A0[_i]->_r._f01))

#define SD_Wr01_IDX_A0(_m, _i, _r, _f01, _v01)		((gpReg##_m##_A0[_i]->_r._f01) = _v01)
#define SD_Wr01_IDX_B0(_m, _i, _r, _f01, _v01)		((gpReg##_m##_B0[_i]->_r._f01) = _v01)
...
#define SD_RdFL_IDX(_m, _i, _r)															\
								do {														\
									if(lx_chip_rev() >= LX_CHIP_REV(H13, A0))			\
										...
										SD_RdFL_IDX_A0(_m, _i, _r); 						\
									else if(lx_chip_rev() <= LX_CHIP_REV(L9, B2))		\
										SD_RdFL_IDX_B0(_m, _i, _r); 						\
								} while(0)
...
#define SD_WrFL_IDX(_m, _i, _r)															\
								do {														\
									if(lx_chip_rev() >= LX_CHIP_REV(H13, A0))			\
										...
										SD_WrFL_IDX_A0(_m, _i, _r); 						\
									else if(lx_chip_rev() <= LX_CHIP_REV(L9, B2))		\
										SD_WrFL_IDX_B0(_m, _i, _r); 						\
								} while(0)
...
#define SD_Rd_IDX(_m, _i, _r, _v)															\
								do {														\
									if(lx_chip_rev() >= LX_CHIP_REV(H13, A0))			\
										...
										SD_Rd_IDX_A0(_m, _i, _r, _v);						\
									else if(lx_chip_rev() <= LX_CHIP_REV(L9, B2))		\
										SD_Rd_IDX_B0(_m, _i, _r, _v);						\
								} while(0)
...
#define SD_Wr_IDX(_m, _i, _r, _v)															\
								do {														\
									if(lx_chip_rev() >= LX_CHIP_REV(H13, A0))			\
										...
										SD_Wr_IDX_A0(_m, _i, _r, _v);						\
									else if(lx_chip_rev() <= LX_CHIP_REV(L9, B2))		\
										SD_Wr_IDX_B0(_m, _i, _r, _v);						\
								} while(0)
...
#define SD_Rd01_IDX(_m, _i, _r, _f01, _v01)												\
								do {														\
									if(lx_chip_rev() >= LX_CHIP_REV(H13, A0))			\
										...
										SD_Rd01_IDX_A0(_m, _i, _r, _f01, _v01); 		\
									else if(lx_chip_rev() <= LX_CHIP_REV(L9, B2))		\
										SD_Rd01_IDX_B0(_m, _i, _r, _f01, _v01); 		\
								} while(0)
...
#define SD_Wr01_IDX(_m, _i, _r, _f01, _v01)												\
								do {														\
									if(lx_chip_rev() >= LX_CHIP_REV(H13, A0))			\
										...
										SD_Wr01_IDX_A0(_m, _i, _r, _f01, _v01); 		\
									else if(lx_chip_rev() <= LX_CHIP_REV(L9, B2))		\
										SD_Wr01_IDX_B0(_m, _i, _r, _f01, _v01); 		\
								} while(0)
...
#define gpRegSDTOP_A0			stSDEC_TOP_RegA0
#define gpRealRegSDTOP_A0		stSDEC_TOP_RegShadowA0
#define gpRegSDTOP_B0			stSDEC_TOP_RegB0
#define gpRealRegSDTOP_B0		stSDEC_TOP_RegShadowB0
#define gpRegSDTOP_H13A0		stSDEC_TOP_RegH13A0
#define gpRealRegSDTOP_H13A0	stSDEC_TOP_RegShadowH13A0

#define gpRegSDIO_A0			stSDEC_IO_RegShadowA0
#define gpRealRegSDIO_A0		stSDEC_IO_RegA0
#define gpRegSDIO_B0			stSDEC_IO_RegShadowB0
#define gpRealRegSDIO_B0		stSDEC_IO_RegB0
#define gpRegSDIO_H13A0			stSDEC_IO_RegShadowH13A0
#define gpRealRegSDIO_H13A0		stSDEC_IO_RegH13A0

#define gpRegSDMPG_A0			stpSDEC_MPG_RegShadowA0
#define gpRealRegSDMPG_A0		stSDEC_MPG_RegA0
#define gpRegSDMPG_B0			stpSDEC_MPG_RegShadowB0
#define gpRealRegSDMPG_B0		stSDEC_MPG_RegB0
