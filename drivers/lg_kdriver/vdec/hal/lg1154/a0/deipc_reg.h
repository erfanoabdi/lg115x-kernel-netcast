 ...
 *
 *  DE IPC Register Map.
 *  register details. ( used only within kdriver )
 *
...
#define gpRealRegDEIPC		stpDEIPC_Reg
#define gpRegDEIPC			stpDEIPC_RegShadow
...
/* from 'VDEC_DEIPC.csv' 20110322 14:05:35   대한민국 표준시 by getregs v2.7 */
/* vim: set ts=4 sw=4: */
