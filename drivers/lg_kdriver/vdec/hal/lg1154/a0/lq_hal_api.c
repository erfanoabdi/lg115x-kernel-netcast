...
void LQ_HAL_SetSTCUpperLevel(UINT8 ui8ch, UINT32 ui8STCLvl)
{
	...
	LQC_RdFL(lqc_stc_upper);
	LQC_Wr01(lqc_stc_upper, reg_lqc_stc_ignore_upper, (ui8STCLvl&0x0FFFFFFF));
	LQC_WrFL(lqc_stc_upper);
}
