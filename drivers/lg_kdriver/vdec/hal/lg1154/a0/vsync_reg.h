...
typedef struct {
	...
	reg_vsync0_first_pull_en	: 1,	//     8
	reg_vsync1_first_pull_en	: 1,	//     9
	reg_vsync2_first_pull_en	: 1,	//    10
	reg_vsync3_first_pull_en	: 1,	//    11
