 ...
 *---------------------------------------------------------------------------------------*/
#define 		H13_VDEC_DE_IF_BASE(ch)				(H13_VDEC_BASE + 0x1E00 + (ch * 0x40))
...
inline BOOLEAN DE_IPC_HAL_SetNewFrame(UINT8 ui8DeIpcCh, S_DE_IPC_T *psDeIpc)
{
	...
	stpDE_IPC_Reg[ui8DeIpcCh]->y_frame_offset = 0;//psDeIpc->ui32Y_FrameOffset;
	stpDE_IPC_Reg[ui8DeIpcCh]->c_frame_offset = 0;//psDeIpc->ui32C_FrameOffset;
