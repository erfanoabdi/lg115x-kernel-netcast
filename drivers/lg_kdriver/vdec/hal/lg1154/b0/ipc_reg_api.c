...
typedef struct {
   ...
   buf_index_t			dispq[LIPSYNC_NUM_OF_CHANNEL];			// 30
   buf_index_t			dispclearq[LIPSYNC_NUM_OF_CHANNEL];		// 48
   buf_index_t			auib[AUIB_NUM_OF_CHANNEL];		// 60
   buf_index_t			cpb[CPB_NUM_OF_CHANNEL];		// 78
