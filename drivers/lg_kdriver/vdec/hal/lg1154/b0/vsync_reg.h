...
#if 0
	VSYNC0_FIELD0_NUM    	vsync0_field0_num ; // 0x010
	VSYNC0_FIELD1_NUM    	vsync0_field1_num ; // 0x014
	VSYNC1_FIELD0_NUM    	vsync1_field0_num ; // 0x018
	VSYNC1_FIELD1_NUM    	vsync1_field1_num ; // 0x01c
	VSYNC2_FIELD0_NUM    	vsync2_field0_num ; // 0x020
	VSYNC2_FIELD1_NUM    	vsync2_field1_num ; // 0x024
	VSYNC3_FIELD0_NUM    	vsync3_field0_num ; // 0x028
	VSYNC3_FIELD1_NUM    	vsync3_field1_num ; // 0x02c
#else
	VSYNC_FIELD_NUM     	vsync_field_num[4];	// 0x0010 ~ 0x002c
#endif
#if 0
	VSYNC0_INT_FIELD    	vsync0_int_field  ; // 0x030
	VSYNC1_INT_FIELD    	vsync1_int_field  ; // 0x034
	VSYNC2_INT_FIELD    	vsync2_int_field  ; // 0x038
	VSYNC3_INT_FIELD    	vsync3_int_field  ; // 0x03c
#else
	VSYNC_INT_FIELD			vsync_int_field[4]  ; // 0x030~0x03c
#endif
#if 0
	VSYNC0_EXT_FIELD    	vsync0_ext_field  ; // 0x040
	VSYNC1_EXT_FIELD    	vsync1_ext_field  ; // 0x044
	VSYNC2_EXT_FIELD    	vsync2_ext_field  ; // 0x048
	VSYNC3_EXT_FIELD    	vsync3_ext_field  ; // 0x04c
#else
