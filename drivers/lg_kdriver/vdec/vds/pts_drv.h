...
extern char azMatchModeName[STC_PTS_MAX][STC_PTS_MAX_STR_LEN];
/*
struct _SYNC_T;
typedef struct _SYNC_T SYNC_T;
*/
...
PTS_MATCH_E PTS_GetNewFrame(UINT8 ui8SyncCh, UINT32 ui32STC, S_DISPQ_BUF_T *psPopDisBuf, UINT32 ui32GSTC, BOOLEAN *pbInterlaced);
