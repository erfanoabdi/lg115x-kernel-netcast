...
//#define DH1ENCODE_DEBUG_MEM_LEAK
...
//#define H1ENCODE_HW_CLOCK			320000000	// 320Hhz
#define H1ENCODE_HW_CLOCK			300000000	// 300Hhz (H13B0)
...
// BEGIN of control apis
	...
	int (* SetBitrate) ( H1ENCODE_API_T *, u32 );		// set target bitrate
...
s32 H1EncodeSetBitrate( u32 bitrate );
