...
#ifndef _REG_VENC_H13_IPC_h
 #define _REG_VENC_H13_IPC_h
...
#ifndef VENC_FPGA_VSYNC
		UINT32		reserved4                       : 8;	//  7: 0
#else
		UINT32		reserved4						: 7;	//  7: 1
		UINT32		de_vsync						: 1;	//     0
#endif
	}be;
	struct {
 ...
 * Exported variables
 ******************************************************************************/
extern volatile VENC_H13_REG_IPC_T *gpVencH13IpcReg;


#endif	/* !_REG_VENC_H13_IPC_h */
