...
static inline void FD_SET(unsigned long __fd, __kernel_fd_set *__fdsetp)
{
...
static inline void FD_ZERO(__kernel_fd_set *__p)
{
       unsigned long *__tmp = __p->fds_bits;
       int __i;
       int __fdset_longs = __FD_SETSIZE / (8 * sizeof(long));
